...
</code><button type="button" class="doc-copy-btn" title="复制"/></pre>`,At=l("colgroup",null,[l("col",{width:"160"}),l("col",{width:"150"})],-1),Dt=l("thead",null,[l("tr",null,[l("th",null,"事件"),l("th",null,"默认行为"),l("th",null,"说明")])],-1),qt={__name:"Events",setup(a){const s=[{type:"created",desc:"窗口组件创建时触发"},{type:"beforeShow",prevent:"可阻止窗口显示",desc:"窗口显示前触发"},{type:"show",desc:"窗口显示后触发"},{type:"beforeClose",prevent:"可阻止窗口关闭",desc:"窗口关闭前触发"},{type:"close",desc:"窗口关闭时触发"},{type:"beforeDestroy",desc:"窗口销毁前触发"},{type:"dragStart",prevent:"可阻止窗口拖动",desc:"窗口开始拖动时触发"},{type:"dragging",desc:"窗口拖动时触发"},{type:"dragEnd",desc:"窗口拖动结束时触发"},{type:"resizeStart",prevent:"可阻止窗口调整尺寸",desc:"窗口开始调整尺寸时触发"},{type:"resizing",desc:"窗口调整尺寸时触发"},{type:"resizeEnd",desc:"窗口结束调整尺寸时触发"},{type:"maximizeChange",desc:"窗口最大化状态改变时触发"},{type:"confirm",desc:"调用窗口的confirm方法后触发，可通过此事件返回窗体的内容"},{type:"cancel",desc:"调用窗口的cancel方法后触发"}];return(n,t)=>(k(),I("table",null,[At,Dt,l("tbody",null,[(k(),I($,null,rs(s,e=>l("tr",{key:e.prop},[l("td",null,P(e.type),1),l("td",null,P(e.prevent??"--"),1),l("td",null,P(e.desc),1)])),64))])]))}};function Ht(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!ns(a)}function Ks(a,s,n={}){n.height=n.height??"320px";const t={default(e){return typeof s=="function"?s(e.abstractWindow):s},menus(e){return e.abstractWindow.useMenus().value.map(c=>Zs.renderMenu(e.abstractWindow,c))}};return Us(a,r(Js,null,Ht(t)?t:{default:()=>[t]}),n)}function Ft(){return new Promise((a,s)=>{const n={mask:!0,resizeMode:L.DISABLED},t=Ks("请输入审批意见",r(Ys,null,null),n);t.once("confirm",e=>a(e.detail)),t.once("cancel",e=>s(e.detail))})}const Vt={class:"approval-output"},$t=l("strong",null,"操作结果：",-1),Xt=S({__name:"UseExample",setup(a){const s=K("");async function n(){const t=await Ft().catch(e=>(console.log(e),null));if(t==null){s.value="取消操作";return}s.value=t}return(t,e)=>(k(),I($,null,[l("button",{type:"button",class:"btn btn-small",onClick:n},"审批"),l("div",Vt,[s.value?(k(),I($,{key:0},[$t,l("pre",null,P(s.value),1)],64)):ws("",!0)])],64))}}),Gt=S({__name:"UseModal",setup(a){function s(){Ks("窗口1",r("div",null,[y("内容")]))}return(n,t)=>(k(),I("button",{type:"button",class:"btn btn-small",onClick:s},"打开模态框"))}}),Ut=Object.freeze(Object.defineProperty({__proto__:null,Events:qt,UseExample:Xt,UseModal:Gt},Symbol.toStringTag,{value:"Module"})),Zt=[{name:"简介",content:Rt},{name:"快速开始",content:Lt},{name:"进阶应用",content:Pt},{name:"API",content:Bt},{name:"示例",content:Nt}],Os=Zt.map((a,s)=>({id:s,...a})),Yt=["innerHTML"],Jt=l("span",null,"xWindow",-1),Kt=["onClick"],Qt=l("span",null,"Copyright © 2023-present dongls",-1),se=[Qt],ne=S({__name:"docs",setup(a){const s=zs("classes"),n="06272135",t="0.1.0",e=0,o=ds(),c=Kn(),g=K(Os[e]),m=K();function x(j){j.stopPropagation()}function O(){var C;if(o==null)return null;const j=o.useMenus(),z=((C=o.component)==null?void 0:C.useCssClass())??{};return r("div",{class:s.menus,onMousedown:x},[r(zt,{menuClass:z.menu},null),r("button",{title:"GitHub",class:z.menu,onClick:M,innerHTML:qa},null),j==null?void 0:j.value.map(N=>Zs.renderMenu(o,N))])}function M(){window.open("https://github.com/dongls/xWindow")}function i(){const j=g.value.content,z={...Et,...Ut};return X("article",{class:"article",key:g.value.id},X({template:j,components:z}))}async function h(j){g.value=j,await gs(),m.value&&(m.value.scrollTop=0)}function v(j){const z=j.target.closest("pre.hljs");if(z==null)return;const C=z.querySelector(":scope > code.hljs-code");if(C==null)return;const N=C.textContent;N!=null&&navigator.clipboard.writeText(N)}return(j,z)=>(k(),I("div",{class:_(j.classes.app)},[l("aside",{class:_(j.classes.aside)},[l("div",{class:_(j.classes.leftHeader)},[l("i",{class:_(j.classes.logo),innerHTML:T(c).IconWindow},null,10,Yt),l("h3",{class:_(j.classes.title)},[Jt,l("small",null,"v"+P(T(t))+"_"+P(T(n)),1)],2)],2),l("nav",{class:_([j.classes.navs,"is-scroll"])},[(k(!0),I($,null,rs(T(Os),C=>(k(),I("div",{onClick:N=>h(C),class:_([j.classes.nav,C.id==g.value.id?j.classes.activeNav:null])},P(C.name),11,Kt))),256))],2),l("div",{class:_(j.classes.copyright)},se,2)],2),l("main",{class:_(j.classes.main)},[l("div",{class:_(j.classes.rightHeader)},[r(O)],2),l("div",{class:_(j.classes.scroll),ref_key:"scroll",ref:m,onClick:cn(v,["stop"])},[r(i,{class:_(j.classes.content)},null,8,["class"]),ms(j.$slots,"default",{ref:"tref"})],2)],2)],2))}}),ae="Cs1eNLRW",te="mkQVrkEV",ee="fxJePVAw mkQVrkEV",le="gW5FCXxJ mkQVrkEV",oe="UCU4MEPE",ce="wascU8g5",ie="QVKApkXV",pe="xQ7Xh7bM",re="LhDQ3ctB",ue="_7RZWnCfQ",de="_95hpDEbG",he="cXaxwh5B",je="_2dkZEz4e",ge="_6qjvpjzC",me="qSce7387",fe={app:ae,header:te,leftHeader:ee,rightHeader:le,menus:oe,aside:ce,navs:ie,nav:pe,activeNav:re,main:ue,content:de,scroll:he,copyright:je,logo:ge,title:me},we={classes:fe},be=xs(ne,[["__cssModules",we]]),ye=S({__name:"App",setup(a){let s=null;function n(){s&&s.close(),s=null}return Cs(n),pn(()=>{s=Us({closeable:!1,zIndex:999,width:"1280px",height:"900px",minHeight:640,body:r(be,null,null),title:"",className:"xwindow-doc"})}),(t,e)=>{const o=un("WindowManager");return k(),rn(o)}}}),Qs=dn(ye);Qs.use(Aa);Qs.mount("#app");
