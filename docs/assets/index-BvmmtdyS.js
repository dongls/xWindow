...
</svg>`,Ha=`<svg viewBox="0 0 1024 1024" version="1.1"
...
</svg>`,Fa=I({__name:"HelloWorld",setup(a){function s(){G("示例窗口",r("div",{class:"example-body"},[y("Hello, xWindow!")]))}return(n,t)=>(W(),M("button",{type:"button",onClick:s,class:"btn btn-small"},"尝试一下"))}}),Va={class:"example-body"},$a=I({__name:"WinBody",props:{text:String},setup(a){return(s,n)=>(W(),M("div",Va,z(a.text),1))}}),Xa=I({__name:"FunctionBased",setup(a){function s(){G("窗口1",r("div",{class:"example-body"},[y("这段文本是使用JSX创建的。")]))}function n(){G("窗口2","这段本文可以直接展示。")}function t(){G("窗口3",$("div",{className:"example-body"},"这段文本是通过Vue提供的渲染函数创建的。"))}function l(){G("窗口4",()=>r("div",{class:"example-body"},[y("这段文本是通过返回VNode节点的函数创建的。")]))}function o(){G("窗口5",r($a,{text:"这段文本通过组件创建的。"},null))}return(c,h)=>(W(),M(F,null,[e("button",{class:"btn",type:"button",onClick:s},"JSX"),e("button",{class:"btn",type:"button",onClick:n},"文本"),e("button",{class:"btn",type:"button",onClick:t},"渲染函数"),e("button",{class:"btn",type:"button",onClick:l},"函数"),e("button",{class:"btn",type:"button",onClick:o},"组件")],64))}}),Ga=e("header",null,"窗口尺寸：",-1),Ua=e("header",null,"窗口位置：",-1),Za=e("header",null,"窗口特性：",-1),Ya=["onUpdate:modelValue"],Ja=e("header",null,"调整模式：",-1),Ka=["value"],Qa=e("span",null,"允许调整窗口大小，允许最大化（默认）",-1),st=["value"],nt=e("span",null,"只允许调整窗口大小",-1),at=["value"],tt=e("span",null,"禁止",-1),Is="__WIN_EVENTS__",lt=I({__name:"Example",setup(a){const s=zs("classes"),n=ba(),t=[{label:"可拖拽",prop:"draggable",value:!0},{label:"可关闭",prop:"closeable",value:!0},{label:"可置顶",prop:"pinnable",value:!0},{label:"最大化",prop:"maximize",value:!1},{label:"遮罩层",prop:"mask",value:!1},{label:"按ESC键关闭",prop:"closeOnPressEsc",value:!0}],l={width:"800px",height:"600px",left:"calc(50vw - 400px)",top:"12vh",resizeMode:S.RESIZE},o=t.reduce((T,i)=>(T[i.prop]=i.value,T),{...l}),c=ps(o),h=I({props:{params:{type:Object,required:!0}},setup(T){const i=hs(),j=Reflect.get(i,Is);function v(){i==null||i.close(!0)}return function(){var R,ns,as,ts,ls,d;const g=c.closeable?null:r("button",{type:"button",class:"btn btn-small",onClick:v},[y("关闭窗口")]),O=t.map(f=>r("p",null,[f.label,y(": "),JSON.stringify(T.params[f.prop])])),C=j.value.map(f=>r("p",null,[f]));return r("div",{class:s.exampleBody},[r("div",{class:s.params},[r("div",{class:s.panel},[r("h4",null,[y("初始参数：")]),O]),r("div",{class:s.panel},[r("h4",null,[y("窗口状态：")]),r("div",{class:s.infos},[r("p",null,[y("id: "),i==null?void 0:i.wid]),r("p",null,[y("focused: "),JSON.stringify((R=i==null?void 0:i.state)==null?void 0:R.focused)]),r("p",null,[y("left: "),(ns=i==null?void 0:i.state)==null?void 0:ns.offsetLeft,y("px")]),r("p",null,[y("top: "),(as=i==null?void 0:i.state)==null?void 0:as.offsetTop,y("px")]),r("p",null,[y("width: "),(ts=i==null?void 0:i.state)==null?void 0:ts.offsetWidth,y("px")]),r("p",null,[y("height: "),(ls=i==null?void 0:i.state)==null?void 0:ls.offsetHeight,y("px")]),r("p",null,[y("z-index: "),JSON.stringify((d=i==null?void 0:i.state)==null?void 0:d.zIndex)])])])]),r("div",{class:s.eventHeader},[r("strong",null,[y("窗口事件")]),g]),r("div",{class:s.events},[C])])}}});function b(){const T=new Date,i=T.getMinutes().toString().padStart(2,"0"),j=T.getSeconds().toString().padStart(2,"0"),v=T.getMilliseconds().toString().padStart(4,"0");return`${i}:${j}.${v}`}function V(){const T=n.getWindowCount(),i={...c},j=K([]),v=Na("窗口"+T,r(h,{params:i},null),i);v.on("created",()=>{j.value.unshift(`[${b()}]: call created event.`)}),v.on("beforeShow",g=>{j.value.unshift(`[${b()}]: call beforeShow event.`)}),v.on("show",g=>{j.value.unshift(`[${b()}]: call show event.`)}),v.on("close",()=>{j.value.unshift(`[${b()}]: call close event.`)}),v.on("beforeDestroy",()=>{j.value.unshift(`[${b()}]: call beforeDestroy event.`)}),v.on("dragStart",g=>{j.value.unshift(`[${b()}]: call dragStart event.`)}),v.on("dragEnd",g=>{j.value.unshift(`[${b()}]: call dragEnd event.`)}),v.on("resizeStart",g=>{j.value.unshift(`[${b()}]: call resizeStart event.`)}),v.on("resizeEnd",g=>{j.value.unshift(`[${b()}]: call resizeEnd event. `)}),v.on("maximizeChange",g=>{j.value.unshift(`[${b()}]: call maximizeChange event. isMaximize: ${v.isMaximize}`)}),Reflect.set(v,Is,j)}function N(T,i){c.width=T+"px",c.height=i+"px"}return(T,i)=>(W(),M(F,null,[e("section",{class:_(E(s).row)},[Ga,e("div",{class:_(E(s).content)},[e("label",null,[y("宽度："),A(e("input",{type:"text","onUpdate:modelValue":i[0]||(i[0]=j=>c.width=j),placeholder:"参照CSS的width属性"},null,512),[[ss,c.width]])]),e("label",null,[y("高度："),A(e("input",{type:"text","onUpdate:modelValue":i[1]||(i[1]=j=>c.height=j),placeholder:"参照CSS的height属性"},null,512),[[ss,c.height]])]),e("button",{type:"button",class:"btn btn-mini",onClick:i[2]||(i[2]=j=>N(800,600))},"800px*600px"),e("button",{type:"button",class:"btn btn-mini",onClick:i[3]||(i[3]=j=>N(390,840))},"390px*840px")],2)],2),e("section",{class:_(E(s).row)},[Ua,e("div",{class:_(E(s).content)},[e("label",null,[y("左侧："),A(e("input",{type:"text","onUpdate:modelValue":i[4]||(i[4]=j=>c.left=j),placeholder:"参照CSS中left属性"},null,512),[[ss,c.left]])]),e("label",null,[y("上侧："),A(e("input",{type:"text","onUpdate:modelValue":i[5]||(i[5]=j=>c.top=j),placeholder:"参照CSS中top属性"},null,512),[[ss,c.top]])])],2)],2),e("section",{class:_(E(s).row)},[Za,e("div",{class:_(E(s).content)},[(W(),M(F,null,us(t,j=>e("label",{key:j.prop},[A(e("input",{type:"checkbox","onUpdate:modelValue":v=>c[j.prop]=v},null,8,Ya),[[rn,c[j.prop]]]),e("span",null,z(j.label),1)])),64))],2)],2),e("section",{class:_(E(s).row)},[Ja,e("div",{class:_(E(s).content)},[e("label",null,[A(e("input",{type:"radio",name:"resizeMode",value:E(S).RESIZE,"onUpdate:modelValue":i[6]||(i[6]=j=>c.resizeMode=j)},null,8,Ka),[[js,c.resizeMode]]),Qa]),e("label",null,[A(e("input",{type:"radio",name:"resizeMode",value:E(S).RESIZE_ONLY,"onUpdate:modelValue":i[7]||(i[7]=j=>c.resizeMode=j)},null,8,st),[[js,c.resizeMode]]),nt]),e("label",null,[A(e("input",{type:"radio",name:"resizeMode",value:E(S).DISABLED,"onUpdate:modelValue":i[8]||(i[8]=j=>c.resizeMode=j)},null,8,at),[[js,c.resizeMode]]),tt])],2)],2),e("button",{onClick:V,class:"btn"},"创建窗口")],64))}}),et="Zj7DQ8mX",ot="hZ15PjHU",ct="tbtACTrZ",it="_3N6wV7j6",pt="oTAjhRfW",rt="CFWamGXp",ut="cqiqLgbF",dt="T9Y6Pp6o",ht="TUAWahwn",jt={winBody:et,exampleBody:ot,row:ct,content:it,events:pt,params:rt,panel:ut,infos:dt,eventHeader:ht},xs=(a,s)=>{const n=a.__vccOpts||a;for(const[t,l]of s)n[t]=l;return n},gt={classes:jt},mt=xs(lt,[["__cssModules",gt]]),ft={class:"approval-form"},wt={key:0,class:"approval-form-message"},Ks=I({__name:"UseApproval",setup(a){const s=hs(),n=ps({value:"",fail:!1});return s==null||s.useHandle("confirm",()=>n.value?n.value:(n.fail=!0,Promise.reject("验证未通过"))),(t,l)=>(W(),M("div",ft,[A(e("textarea",{type:"text","onUpdate:modelValue":l[0]||(l[0]=o=>n.value=o),placeholder:"请输入",ref:"inputRef",autofocus:""},null,512),[[ss,n.value]]),n.fail?(W(),M("div",wt,"请输入审批意见")):ws("",!0)]))}}),bt={key:0,class:"example-modal"},yt={class:"example-modal-header"},_t={class:"example-modal-title"},vt={class:"example-modal-menus"},xt={class:"example-modal-body"},Et={class:"example-modal-footer"},Qs=I({__name:"Modal",setup(a){const s=hs();function n(){s==null||s.onCancel().catch(l=>console.error(l))}function t(){s==null||s.onConfirm().catch(l=>console.error(l))}return(l,o)=>E(s)?(W(),M("div",bt,[e("div",yt,[e("div",_t,z(E(s).options.title),1),e("div",vt,[ms(l.$slots,"menus",{abstractWindow:E(s)})])]),e("div",xt,[ms(l.$slots,"default",{abstractWindow:E(s)})]),e("div",Et,[e("button",{type:"button",class:"btn btn-small",onClick:o[0]||(o[0]=c=>n())},"取消"),e("button",{type:"button",class:"btn btn-small",onClick:o[1]||(o[1]=c=>t())},"确定")])])):ws("",!0)}}),Tt=Object.freeze(Object.defineProperty({__proto__:null,Example:mt,FunctionBased:Xa,HelloWorld:Fa,Modal:Qs,UseApproval:Ks},Symbol.toStringTag,{value:"Module"})),Wt=["innerHTML"],Mt=["onClick"],kt=I({__name:"index",props:{menuClass:{type:String,default:null}},setup(a){const s=[{name:"皓白",primaryColor:"#ebeef0",textColor:"#000"},{name:"天缥",primaryColor:"#d5ebe1",textColor:"#000",navTextSecondaryColor:"#333"},{name:"海天霞",primaryColor:"#f3a694",textColor:"#000",navTextSecondaryColor:"#333"},{name:"暮山紫",primaryColor:"#a4abd6",textColor:"#000",navTextSecondaryColor:"#333"}].map(l=>({...l,background:l.primaryColor}));function n(l){return{"--xwindow-color-primary":l.primaryColor,"--xwindow-header-color":l.textColor,"--nav-text-secondary-color":l.navTextSecondaryColor}}function t(l){const o=document.documentElement,c=n(l);for(const h in c){const b=c[h];b==null?o.style.removeProperty(h):o.style.setProperty(h,b)}}return(l,o)=>(W(),M("div",{class:_(l.classes.picker)},[e("button",{type:"button",class:_(a.menuClass),innerHTML:E(qa),title:"主题"},null,10,Wt),e("ul",{class:_(l.classes.panel)},[(W(!0),M(F,null,us(E(s),c=>(W(),M("li",{key:c.id,onClick:h=>t(c),style:Ts({"--theme-primary-color":c.primaryColor})},[e("span",{class:_(l.classes.badge),style:Ts({background:c.background})},null,6),e("strong",null,z(c.name),1)],12,Mt))),128))],2)],2))}}),It="JJwYh7Hb",Ct="nGuXZaqY",Ot="WnLJWuwF",St={picker:It,panel:Ct,badge:Ot},zt={classes:St},Rt=xs(kt,[["__cssModules",zt]]),Lt=`<p>xWindow是仿Windows窗口的组件库，目标是提供一套快捷的API来创建和使用窗口。本文档的就是基于xWindow创建了一个窗口，你可以拖动文档查看效果。</p>
...
<p>xWindow不需要事先在业务组件中声明，你可以在任何需要的地方直接创建一个窗口。 <HelloWorld/></p>`,Pt=`<h2 class="head-anchor article-sticky-heading" id="安装">安装</h2>
...
<p>最终效果如下：
<span class="quickstart-function-based"><FunctionBased/></span></p>`,Nt=`<h2 class="head-anchor article-sticky-heading" id="模态框">模态框</h2>
...
<p>效果如下：<UseExample/></p>`,Bt="<Example/>",At=`<h2 class="head-anchor article-sticky-heading" id="函数式API">函数式API</h2>
<hr>
...
</code><button type="button" class="doc-copy-btn" title="复制"/></pre>`,Dt=e("colgroup",null,[e("col",{width:"160"}),e("col",{width:"150"})],-1),qt=e("thead",null,[e("tr",null,[e("th",null,"事件"),e("th",null,"默认行为"),e("th",null,"说明")])],-1),Ht={__name:"Events",setup(a){const s=[{type:"created",desc:"窗口组件创建时触发"},{type:"beforeShow",prevent:"可阻止窗口显示",desc:"窗口显示前触发"},{type:"show",desc:"窗口显示后触发"},{type:"beforeClose",prevent:"可阻止窗口关闭",desc:"窗口关闭前触发"},{type:"close",desc:"窗口关闭时触发"},{type:"beforeDestroy",desc:"窗口销毁前触发"},{type:"dragStart",prevent:"可阻止窗口拖动",desc:"窗口开始拖动时触发"},{type:"dragging",desc:"窗口拖动时触发"},{type:"dragEnd",desc:"窗口拖动结束时触发"},{type:"resizeStart",prevent:"可阻止窗口调整尺寸",desc:"窗口开始调整尺寸时触发"},{type:"resizing",desc:"窗口调整尺寸时触发"},{type:"resizeEnd",desc:"窗口结束调整尺寸时触发"},{type:"maximizeChange",desc:"窗口最大化状态改变时触发"},{type:"confirm",desc:"调用窗口的confirm方法后触发，可通过此事件返回窗体的内容"},{type:"cancel",desc:"调用窗口的cancel方法后触发"}];return(n,t)=>(W(),M("table",null,[Dt,qt,e("tbody",null,[(W(),M(F,null,us(s,l=>e("tr",{key:l.prop},[e("td",null,z(l.type),1),e("td",null,z(l.prevent??"--"),1),e("td",null,z(l.desc),1)])),64))])]))}};function Ft(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!rs(a)}function sn(a,s,n={}){n.height=n.height??"320px";const t={default(l){return typeof s=="function"?s(l.abstractWindow):s},menus(l){return l.abstractWindow.useMenus().value.map(c=>Js.renderMenu(l.abstractWindow,c))}};return Ys(a,r(Qs,null,Ft(t)?t:{default:()=>[t]}),n)}function Vt(){const a={mask:!0,resizeMode:S.DISABLED};return sn("请输入审批意见",r(Ks,null,null),a).promise()}const $t={class:"approval-output"},Xt=e("strong",null,"操作结果：",-1),Gt=I({__name:"UseExample",setup(a){const s=K("");async function n(){const t=await Vt().catch(l=>(console.log(l),null));if(t==null){s.value="取消操作";return}s.value=t}return(t,l)=>(W(),M(F,null,[e("button",{type:"button",class:"btn btn-small",onClick:n},"审批"),e("div",$t,[s.value?(W(),M(F,{key:0},[Xt,e("pre",null,z(s.value),1)],64)):ws("",!0)])],64))}}),Ut=I({__name:"UseModal",setup(a){function s(){sn("窗口1",r("div",null,[y("内容")]))}return(n,t)=>(W(),M("button",{type:"button",class:"btn btn-small",onClick:s},"打开模态框"))}}),Zt=Object.freeze(Object.defineProperty({__proto__:null,Events:Ht,UseExample:Gt,UseModal:Ut},Symbol.toStringTag,{value:"Module"})),Yt=[{name:"简介",content:Lt},{name:"快速开始",content:Pt},{name:"进阶应用",content:Nt},{name:"API",content:At},{name:"示例",content:Bt}],Cs=Yt.map((a,s)=>({id:s,...a})),Jt=["innerHTML"],Kt=e("span",null,"xWindow",-1),Qt=["onClick"],sl=e("span",null,"Copyright © 2023-present dongls",-1),nl=[sl],al=I({__name:"docs",setup(a){const s=zs("classes"),n="10102131",t="0.2.1",l=0,o=hs(),c=sa(),h=K(Cs[l]),b=K();function V(g){g.stopPropagation()}function N(){var C;if(o==null)return null;const g=o.useMenus(),O=((C=o.component)==null?void 0:C.useCssClass())??{};return r("div",{class:s.menus,onMousedown:V},[r(Rt,{menuClass:O.menu},null),r("button",{title:"GitHub",class:O.menu,onClick:T,innerHTML:Ha},null),g==null?void 0:g.value.map(R=>Js.renderMenu(o,R))])}function T(){window.open("https://github.com/dongls/xWindow")}function i(){const g=h.value.content,O={...Tt,...Zt};return $("article",{class:"article",key:h.value.id},$({template:g,components:O}))}async function j(g){h.value=g,await gs(),b.value&&(b.value.scrollTop=0)}function v(g){const O=g.target.closest("pre.hljs");if(O==null)return;const C=O.querySelector(":scope > code.hljs-code");if(C==null)return;const R=C.textContent;R!=null&&navigator.clipboard.writeText(R)}return(g,O)=>(W(),M("div",{class:_(g.classes.app)},[e("aside",{class:_(g.classes.aside)},[e("div",{class:_(g.classes.leftHeader)},[e("i",{class:_(g.classes.logo),innerHTML:E(c).IconWindow},null,10,Jt),e("h3",{class:_(g.classes.title)},[Kt,e("small",null,"v"+z(E(t))+"_"+z(E(n)),1)],2)],2),e("nav",{class:_([g.classes.navs,"is-scroll"])},[(W(!0),M(F,null,us(E(Cs),C=>(W(),M("div",{onClick:R=>j(C),class:_([g.classes.nav,C.id==h.value.id?g.classes.activeNav:null])},z(C.name),11,Qt))),256))],2),e("div",{class:_(g.classes.copyright)},nl,2)],2),e("main",{class:_(g.classes.main)},[e("div",{class:_(g.classes.rightHeader)},[r(N)],2),e("div",{class:_(g.classes.scroll),ref_key:"scroll",ref:b,onClick:un(v,["stop"])},[r(i,{class:_(g.classes.content)},null,8,["class"]),ms(g.$slots,"default",{ref:"tref"})],2)],2)],2))}}),tl="Cs1eNLRW",ll="mkQVrkEV",el="fxJePVAw mkQVrkEV",ol="gW5FCXxJ mkQVrkEV",cl="UCU4MEPE",il="wascU8g5",pl="QVKApkXV",rl="xQ7Xh7bM",ul="LhDQ3ctB",dl="_7RZWnCfQ",hl="_95hpDEbG",jl="cXaxwh5B",gl="_2dkZEz4e",ml="_6qjvpjzC",fl="qSce7387",wl={app:tl,header:ll,leftHeader:el,rightHeader:ol,menus:cl,aside:il,navs:pl,nav:rl,activeNav:ul,main:dl,content:hl,scroll:jl,copyright:gl,logo:ml,title:fl},bl={classes:wl},yl=xs(al,[["__cssModules",bl]]),_l=I({__name:"App",setup(a){let s=null;function n(){s&&s.close(),s=null}return Ss(n),dn(()=>{s=Ys({closeable:!1,zIndex:999,width:"1280px",height:"900px",minWidth:1102,minHeight:480,body:r(yl,null,null),title:"",className:"xwindow-doc"})}),(t,l)=>{const o=jn("WindowManager");return W(),hn(o)}}}),nn=gn(_l);nn.use(Da);nn.mount("#app");
