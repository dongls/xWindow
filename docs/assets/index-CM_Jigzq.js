var nn=Object.defineProperty;var an=(a,s,n)=>s in a?nn(a,s,{enumerable:!0,configurable:!0,writable:!0,value:n}):a[s]=n;var u=(a,s,n)=>(an(a,typeof s!="symbol"?s+"":s,n),n);import{d as S,c as U,h as X,s as tn,r as ps,a as K,p as en,b as r,T as Ss,i as ns,n as gs,e as Es,f as ln,o as Cs,g as on,j as k,k as I,l as y,t as P,m as l,F as $,u as zs,q as _,v as T,w as D,x as ss,y as rs,z as cn,A as js,B as ws,C as ms,D as Ts,E as pn,G as rn,H as un,I as dn,J as hn}from"./vendor-79HxGn9k.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))t(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&t(c)}).observe(document,{childList:!0,subtree:!0});function n(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(e){if(e.ep)return;e.ep=!0;const o=n(e);fetch(e.href,o)}})();const jn="0.1.3",Rs=Symbol(),q=Object.freeze({WINDOW:"x-window",SIMPLE_WINDOW:"x-simple-window",TRANSITION:"x-window-is-transition",MENU:"x-window-is-menu",FOCUSED:"x-window-is-focused",MAXIMIZE:"x-window-is-maximize",HEADER:"x-window-header",BODY:"x-window-body"}),b=Object.freeze({NONE:0,TOP:1,BOTTOM:2,LEFT:4,RIGHT:8}),F=Object.freeze({TOP:b.TOP,BOTTOM:b.BOTTOM,LEFT:b.LEFT,RIGHT:b.RIGHT,TOP_LEFT:b.TOP|b.LEFT,TOP_RIGHT:b.TOP|b.RIGHT,BOTTOM_LEFT:b.BOTTOM|b.LEFT,BOTTOM_RIGHT:b.BOTTOM|b.RIGHT}),p=Object.freeze({NONE:b.NONE,MAXIMIZE:b.TOP,LEFT:b.LEFT,RIGHT:b.RIGHT,TOP_LEFT:b.TOP|b.LEFT,TOP_RIGHT:b.TOP|b.RIGHT,BOTTOM_LEFT:b.BOTTOM|b.LEFT,BOTTOM_RIGHT:b.BOTTOM|b.RIGHT}),L=Object.freeze({DISABLED:0,RESIZE:1,RESIZE_ONLY:2}),Z=Object.freeze({INIT:0,MOUNTED:1,UNMOUNTED:2}),Ls=Object.freeze({SIMPLE_WINDOW:"SimpleWindow",BLANK_WINDOW:"BlankWindow"}),B=Object.freeze({CLOSE:0,MAXIMIZE:1,RESTORE:2,PIN:3,UNPIN:4});class bs{constructor(s,n,t){u(this,"type");u(this,"stopped",!1);u(this,"defaultPrevented",!1);u(this,"instance");u(this,"detail");this.type=s,this.instance=n,this.detail=t}stop(){this.stopped=!0}preventDefault(){this.defaultPrevented=!0}}class cs{constructor(){u(this,"ALL_EVENTS",new Map)}static NOOP(){}on(s,n){const t=this.ALL_EVENTS.get(s);return t==null?(this.ALL_EVENTS.set(s,[n]),this):t.includes(n)?this:(t.push(n),this)}once(s,n){const t=e=>{n(e),this.off(s,t,!0)};return this.on(s,t),this}off(s,n,t=!1){const e=this.ALL_EVENTS.get(s);if(e==null)return this;const o=e.indexOf(n);return o<0?this:(t?e.splice(o,1,cs.NOOP):e.splice(o,1),this)}dispatch(s){const n=this.ALL_EVENTS.get(s.type);if(n==null)return s;for(const e of n)if(typeof e=="function"&&e(s),s.stopped)break;const t=n.filter(e=>e!=cs.NOOP);return this.ALL_EVENTS.set(s.type,t),s}cleanup(){this.ALL_EVENTS.clear()}}function R(a,s,n){return s!=null&&Number.isFinite(s)&&a<s?s:n!=null&&Number.isFinite(n)&&a>n?n:a}function Ws(a){return a==null||typeof a!="string"?!0:a.length==0}function gn(a){return a==null||typeof a!="string"?!1:a.length!=0}function mn(a){a.stopPropagation()}const fn={top:"offsetTop",left:"offsetLeft",width:"offsetWidth",height:"offsetHeight"};class wn{constructor(s){u(this,"init",!1);u(this,"defaultPrevented",!1);u(this,"originalEvent");u(this,"target");u(this,"direction");this.originalEvent=s,this.target=s.target,this.direction=Reflect.get(this.target,us.PROP)}createEvent(s,n){return new bs(s,n,this)}}class us{constructor(s){u(this,"context");u(this,"window");u(this,"onResizing");u(this,"onResizeend");this.window=s}resizestart(s){s.stopPropagation(),s.preventDefault();const n=new wn(s);this.context=n,this.onResizing=this.resizing.bind(this),this.onResizeend=this.resizeend.bind(this),window.addEventListener("pointermove",this.onResizing),window.addEventListener("pointerup",this.onResizeend)}resizing(s){if(this.context==null)return;s.stopPropagation(),s.preventDefault();const n=this.context;if(!n.init){if(this.window.dispatch(this.context.createEvent("resizeStart",this.window)).defaultPrevented)return this.cleanup();n.target.setPointerCapture(s.pointerId),n.init=!0}const t=this.calcWindowState(s),e=this.window.getElement();for(const c in t){const g=Math.round(t[c]);Reflect.set(e.style,c,g+"px")}n.originalEvent=s;const o=this.context.createEvent("resizing",this.window);this.window.dispatch(o)}resizeend(s){if(this.context==null)return;s.stopPropagation(),s.preventDefault();const n=this.context;if(n.init){const t=n.createEvent("resizeEnd",this.window);this.window.dispatch(t),this.patchWindowState(this.calcWindowState(s)),n.target.releasePointerCapture(s.pointerId)}this.cleanup()}cleanup(){this.onResizing&&window.removeEventListener("pointermove",this.onResizing),this.onResizeend&&window.removeEventListener("pointerup",this.onResizeend),this.onResizing=void 0,this.onResizeend=void 0,this.context=void 0}calcWindowState(s){const n=this.context,t=this.window.options,e=typeof t.minWidth=="number"&&t.minWidth>=0?t.minWidth:360,o=typeof t.minHeight=="number"&&t.minHeight>=0?t.minHeight:32,c=this.window.getElement().getBoundingClientRect(),g=document.documentElement.getBoundingClientRect(),m={};if(n.direction&b.TOP){const x=R(c.bottom-R(s.clientY,0),o),O=R(s.clientY-g.top,0,window.innerHeight-x);m.height=x,m.top=O}if(n.direction&b.BOTTOM){const x=R(R(s.clientY,0,window.innerHeight)-c.top,o),O=R(s.clientY-x-g.top,0,window.innerHeight-x);m.height=x,m.top=O}if(n.direction&b.LEFT){const x=R(c.right-R(s.clientX,0),e,window.innerWidth),O=R(s.clientX-g.left,0,window.innerWidth-x);m.width=x,m.left=O}if(n.direction&b.RIGHT){const x=R(R(s.clientX,0)-c.left,e,window.innerWidth),O=R(s.clientX-x-g.left,0,window.innerWidth-x-0);m.width=x,m.left=O}return m}patchWindowState(s){const n=this.window.state;for(const t in s){const e=Math.round(s[t]),o=fn[t];o!=null&&Reflect.set(n,o,e)}}}u(us,"PROP","__xwindow_resize_prop__");const bn="_1T2rhwiL",yn="yi9w1sZD",_n="Ja2o9U31",vn="_1eMSsKoB",xn="_3czvPpS2",En="GiVk7T8N",Tn="VuG4WNig x-window-is-menu",Wn="yBPezU8e",Mn="xbuRK23n",kn="_9t1NJBZM",In="shyxrRzw",On="nkEGqTFw",Sn="pk12TusX",Cn="noixF94i",zn="ifXDegN1 VuG4WNig x-window-is-menu",Rn="X5A6roxN VuG4WNig x-window-is-menu",Ln="PPmfTMRL",Pn="v8UGXgKi PPmfTMRL",Nn="_74VJ9GNt PPmfTMRL",Bn="gg9Mcwey PPmfTMRL",An="Tw7sCaLt PPmfTMRL",Dn="CPuApFyD PPmfTMRL",qn="VBRi4FWg PPmfTMRL",Hn="gCRpuZdB PPmfTMRL",Fn="iRYpNoUT PPmfTMRL",Vn="xTcKGSVA",W={window:bn,dragging:yn,resizing:_n,maximize:vn,focused:xn,header:En,menu:Tn,logo:Wn,main:Mn,init:kn,title:In,menus:On,body:Sn,footer:Cn,closeMenu:zn,pinMenu:Rn,resizeBar:Ln,resizeTop:Pn,resizeBottom:Nn,resizeRight:Bn,resizeLeft:An,resizeTopLeft:Dn,resizeBottomLeft:qn,resizeTopRight:Hn,resizeBottomRight:Fn,mask:Vn},$n=S({name:"WindowBody",props:{wid:String,body:{type:[Object,Function,String,Number],default:null},abstractWindow:{type:Object,required:!0}},setup(a){return function(){const s=typeof a.body=="function"?a.body(a.abstractWindow):a.body;return s==null&&console.warn("[xWindow] 请指定窗体内容:",a.abstractWindow.options.title),s}}}),Xn=Math.floor(Number.MAX_SAFE_INTEGER/10)-1e4;function Gn(){return{visible:!1,offsetWidth:0,offsetHeight:0,offsetTop:0,offsetLeft:0,focused:!1,pinned:!1,zIndex:0,splitMode:p.NONE}}const Un=[[W.resizeTop,F.TOP],[W.resizeBottom,F.BOTTOM],[W.resizeLeft,F.LEFT],[W.resizeRight,F.RIGHT],[W.resizeTopLeft,F.TOP_LEFT],[W.resizeTopRight,F.TOP_RIGHT],[W.resizeBottomLeft,F.BOTTOM_LEFT],[W.resizeBottomRight,F.BOTTOM_RIGHT]];function Zn(a,s,n,t){return U(()=>{const e=a.options;if(s.value==Z.INIT)return{width:e.width,height:e.height,left:e.left,top:e.top};const o=e.mask?null:t.value;return{top:n.offsetTop+"px",left:n.offsetLeft+"px",width:n.offsetWidth+"px",height:s.value==Z.INIT?void 0:n.offsetHeight+"px",zIndex:o}})}function Yn(a,s){return a==L.DISABLED?null:Un.map(n=>X("div",{["."+us.PROP]:n[1],className:n[0],onPointerdown:s}))}function Jn(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!ns(a)}const Q=S({name:"BlankWindow",props:{abstractWindow:{type:Object,required:!0}},setup(a,{slots:s}){const n=tn(),t=ps(Gn()),e=K(Z.INIT),o=U(()=>{const d=a.abstractWindow.options;return typeof d.zIndex=="number"&&d.zIndex>0}),c=U(()=>{const d=a.abstractWindow.options;return o.value?d.zIndex:(t.pinned?Xn:0)+t.zIndex}),g=Zn(a.abstractWindow,e,t,c),m=U(()=>{const d=[q.WINDOW,W.window],w=a.abstractWindow;return w.type===Ls.SIMPLE_WINDOW&&d.push(q.SIMPLE_WINDOW),e.value==Z.INIT&&d.push(W.init),t.splitMode==p.MAXIMIZE&&d.push(W.maximize,q.MAXIMIZE),t.focused&&d.push(W.focused,q.FOCUSED),gn(w.options.className)&&d.push(w.options.className),d}),x=U(()=>{const d=[],E=a.abstractWindow.options;return E.pinnable&&E.mask!==!0&&o.value!==!0&&d.push(t.pinned?B.PIN:B.UNPIN),E.resizeMode==L.RESIZE&&d.push(t.splitMode==p.MAXIMIZE?B.RESTORE:B.MAXIMIZE),E.closeable&&d.push(B.CLOSE),d}),O={getElement:M,getRenderState:i,useCssClass:h,useMenus:z};function M(){return n.value}function i(){return e.value}function h(){return W}async function v(d){d==null||d.preventDefault(),a.abstractWindow.toggleMaximize()}function j(){JSON.parse(JSON.stringify(t))}function z(){return x}function C(d){const w=Array.from(d.querySelectorAll("[autofocus]"));for(const E of w)if(E instanceof HTMLElement&&E.autofocus)return E.focus()}async function N(d){await gs();const w=a.abstractWindow,E=w.options,ls=d.el,H=ls.getBoundingClientRect();if(e.value==Z.INIT){let os=Math.round(H.left),A=Math.round(H.top);Ws(E.left)&&(os=Math.floor((window.innerWidth-H.width)/2)),Ws(E.top)&&(A=Math.floor((window.innerHeight-H.height)/2)),t.offsetWidth=H.width,t.offsetHeight=H.height,t.offsetLeft=os,t.offsetTop=A,E.maximize&&v(),e.value=Z.MOUNTED,j(),gs(()=>{const hs=w.createEvent("show");w.dispatch(hs),C(ls)})}w.focus()}function as(d){const w=a.abstractWindow;w.focus(),!(!w.allowDrag||w.isMaximize)&&w.dragstart(d)}function ts(d){const w=M();if(w==null)return;const E=w.getBoundingClientRect();d.clientY-E.top>a.abstractWindow.allowDragArea||v(d)}function es(){const d=a.abstractWindow;d.component=O,d.state=t,ea(d.id,d);const w=d.createEvent("created");d.dispatch(w)}return en(Rs,a.abstractWindow),es(),function(){const d=a.abstractWindow,w=d.options;if(t.visible!==!0)return null;const E=typeof s.header=="function"?s.header(O):null,ls=r("div",{class:W.main,onDblclick:ts},[E,r("div",{class:[W.body,q.BODY,w.bodyClassName]},[r($n,{body:d.body,abstractWindow:a.abstractWindow,key:d.wid},null)])]),H={ref:n,id:d.wid,onVnodeMounted:N,onPointerdown:as,class:m.value,style:g.value},os=Yn(w.resizeMode,d.resizestart);let A=X("div",H,[ls,os]);if(w.mask===!0){const hs={zIndex:c.value};A=r("div",{class:W.mask,style:hs},[A])}return w.teleport===!1?A:r(Ss,{to:w.teleport},Jn(A)?A:{default:()=>[A]})}}}),Ps='<svg width="64" height="64" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M590.265 511.987l305.521-305.468c21.617-21.589 21.617-56.636.027-78.252-21.616-21.617-56.663-21.617-78.279 0L512.012 433.735 206.544 128.213c-21.617-21.617-56.635-21.617-78.252 0-21.616 21.589-21.616 56.635-.027 78.252L433.76 511.987 128.211 817.482c-21.617 21.59-21.617 56.635 0 78.251 10.808 10.81 24.967 16.213 39.125 16.213 14.159 0 28.318-5.403 39.126-16.213l305.522-305.468L817.48 895.788C828.289 906.597 842.447 912 856.606 912s28.317-5.403 39.125-16.212c21.618-21.59 21.618-56.636.028-78.252L590.265 511.987z"/></svg>',Ns='<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5228" width="64" height="64"><path d="M97.74775349 97.74775349h828.50449302v828.50449302H97.74775349V97.74775349z m103.56306133 103.56306133v621.37837036h621.37837036V201.31081482H201.31081482z" fill="currentColor"></path></svg>',Bs='<svg width="64" height="64" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path d="M38.794 124.791v778.495h946.412V124.791H38.794zm896.678 728.033H89.292v-460.9h846.18v460.9z"/></svg>',As='<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="64" height="64"><path d="M738.793 681.382v-48.331l88.242-88.243a298.676 298.676 0 00156.712-83.482 38.836 38.836 0 000-54.923l-366.15-366.15a38.836 38.836 0 00-54.923 0 298.52 298.52 0 00-83.519 156.749l-88.169 88.169h-48.332a411.145 411.145 0 00-292.59 121.232c-15.16 15.159-15.16 39.764 0 54.923L278.906 690.17 86.642 882.436a38.836 38.836 0 1054.922 54.922l192.23-192.229 228.844 228.845a38.836 38.836 0 0054.922 0 411.042 411.042 0 00121.233-292.592zM134.02 435.44a333.473 333.473 0 01208.56-72.571l64.406.037a38.836 38.836 0 0027.461-11.351L544.292 241.71a38.68 38.68 0 0011.351-27.462 180.096 180.096 0 0136.798-89.01L898.8 431.593a180.925 180.925 0 01-89.12 36.835 38.836 38.836 0 00-27.462 11.35L672.373 589.626c-7.287 7.286-11.387 17.173-11.35 27.461l.036 64.406a333.318 333.318 0 01-72.608 208.596L134.021 435.44z"/></svg>',Ds='<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="64" height="64"><path d="M845.40952426 212.52063539H65.21904746v702.17142826h780.1904768V212.52063539z m-702.17142933 624.1523808V290.53968285h624.1523808v546.13333334H143.23809493z" fill="currentColor"></path><path d="M981.53650809 76.3936505H201.34603129v78.01904746h702.17142933v624.15238187h78.01904747V76.3936505z" fill="currentColor"></path></svg>';function Kn(){return{IconClose:Ps,IconMax:Ns,IconPin:As,IconWindow:Bs,IconRestore:Ds}}function Qn(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!ns(a)}function sa(a){const s=a.options.icon;return typeof s=="string"?r("i",{class:[W.logo,"icon",s]},null):ns(s)?s:typeof s=="function"?s(a):r("i",{class:W.logo,innerHTML:Bs},null)}const is=S({name:"SimpleWindow",props:{abstractWindow:{type:Object,required:!0}},setup(a){const s=a.abstractWindow,n={header(){const t=s.useMenus();return r("div",{class:W.header},[sa(s),r("div",{class:W.title},[s.options.title??"新窗口"]),r("div",{class:W.menus,onMousedown:mn},[t.value.map(e=>Us(s,e))])])}};return function(){return r(Q,{abstractWindow:a.abstractWindow},Qn(n)?n:{default:()=>[n]})}}}),qs=Object.freeze({SIMPLE_WINDOW:is.name,BLANK_WINDOW:Q.name});function Hs(a){return a==Q.name?Q:is}function Fs(a){if(a.key=="Escape")return Gs({pressEsc:!0,forced:!1})}function na(){f.isMounted=!0}function Vs(){f.isMounted=!1,f.topWindow=null,f.ids.value=[],f.stack.clear()}function $s(){return f.zIndex}function Xs(){return f.zIndex+=1}function aa(){const a=f.topWindow;return a?a.state.zIndex:1}function ta(){return f.topWindow}function ea(a,s){f.stack.set(a,s)}function la(a){if(console.log("[xWindow]: remove window",a),!f.stack.has(a)||(f.stack.delete(a),!f.isMounted))return;const s=f.ids.value.indexOf(a);if(s<0)return;f.ids.value.splice(s,1)}function Gs(a){if(f.stack.size==0||f.topWindow==null)return;const s=f.topWindow;(a==null?void 0:a.pressEsc)===!0&&s.options.closeOnPressEsc!==!0||f.topWindow.cancel(a==null?void 0:a.forced)}function oa(a){const s=document.createDocumentFragment(),n=Hs(a.type),t=X(n,{abstractWindow:a});t.appContext=f.appContext,Es(t,s),document.body.appendChild(s),a.on("beforeDestroy",()=>{Es(null,s)})}function ca(a){const s=fs.create(a);return f.isMounted?(f.ids.value.push(s.id),f.stack.set(s.id,s),s):(oa(s),s)}function ia(a){return f.stack.get(a)}function pa(){return f.ids}function ys(a){if(f.topWindow=a,a!=null){for(const s of f.stack.values()){const n=s.state;n!=null&&(n.focused=s===a)}a.state!=null&&a.state.zIndex<$s()&&(a.state.zIndex=Xs())}}function ra(a){const s=f.stack.get(a);ys(s)}function ua(){const a=da();ys(a)}function da(){if(f.stack.size==0)return;let a;for(const s of f.stack.values())if(!(s.state==null||s.state.visible!==!0)){if(a==null){a=s;continue}a.state.zIndex<s.state.zIndex&&(a=s)}return a}function ha(){return f.previewState}function ja(){return f.stack.size}function ga(){window.addEventListener("keydown",Fs,!0)}function ma(a){f.appContext=a._context}function fa(){f.appContext=null,Vs(),window.removeEventListener("keydown",Fs,!0)}function wa(){return{closeTopWindow:Gs,getTopWindow:ta,getTopZIndex:Xs,getWindowCount:ja,getZIndex:$s,setFocusedWindow:ys,cleanup:fa}}class ba{constructor(s,n){u(this,"moved",!1);u(this,"originalEvent");u(this,"target");u(this,"deltaX");u(this,"deltaY");u(this,"initialX");u(this,"initialY");u(this,"left",0);u(this,"top",0);u(this,"prevClientX");u(this,"prevClientY");const t=s.getBoundingClientRect();this.originalEvent=n,this.target=s,this.deltaX=Math.round(t.left-n.clientX),this.deltaY=Math.round(t.top-n.clientY),this.initialX=n.clientX,this.initialY=n.clientY,this.prevClientX=n.clientX,this.prevClientY=n.clientY}preventDragEvent(s){return!(this.moved||Math.abs(s.clientX-this.initialX)>4||Math.abs(s.clientY-this.initialY)>4)}createEvent(s,n){return new bs(s,n,this)}}class ya{constructor(s){u(this,"window");u(this,"context");u(this,"onDragging");u(this,"onDragend");this.window=s}static isConflict(s,n){const t=s.getBoundingClientRect(),e=n.getBoundingClientRect();return!(t.top>e.bottom||t.right<e.left||t.bottom<e.top||t.left>e.right)}static findElementsFromPoint(s,n,t,e){return typeof document.elementsFromPoint!="function"?[]:document.elementsFromPoint(s,n).filter(c=>e!=null&&!e.contains(c)?!1:typeof t=="string"?c.matches(t):!1)}dragstart(s){if(s.button!==0)return;const n=s.target;if(n instanceof Element&&n.closest("."+q.MENU))return;const t=this.window.getElement();if(t==null)return;const e=t.getBoundingClientRect();s.clientY-e.top>this.window.allowDragArea||(s.preventDefault(),s.stopPropagation(),this.context=new ba(t,s),this.context.left=this.window.state.offsetLeft,this.context.top=this.window.state.offsetTop,this.onDragging=this.dragging.bind(this),this.onDragend=this.dragend.bind(this),window.addEventListener("pointermove",this.onDragging),window.addEventListener("pointerup",this.onDragend))}dragging(s){var o;if(this.context==null)return;const n=this.context;if(!n.moved){if(this.window.dispatch(this.context.createEvent("dragStart",this.window)).defaultPrevented)return this.cleanup();const g=(o=this.window.component)==null?void 0:o.useCssClass();g!=null&&g.dragging&&n.target.classList.add(g.dragging),n.target.setPointerCapture(s.pointerId),n.moved=!0}if(n.preventDragEvent(s))return;s.preventDefault(),s.stopPropagation(),n.originalEvent=s,n.left=s.clientX+n.deltaX,n.top=s.clientY+n.deltaY,n.prevClientX=s.clientX,n.prevClientY=s.clientY;const t=n.target;t.style.left=n.left+"px",t.style.top=n.top+"px";const e=this.context.createEvent("dragging",this.window);this.window.dispatch(e)}dragend(s){if(this.context==null||!this.context.moved)return this.cleanup();s.preventDefault(),s.stopPropagation();const n=this.context;n.originalEvent=s,n.target.releasePointerCapture(s.pointerId);const t=n.createEvent("dragEnd",this.window);this.window.dispatch(t),this.window.state.offsetTop=n.top,this.window.state.offsetLeft=n.left,this.cleanup()}cleanup(){var n,t;const s=(n=this.window.component)==null?void 0:n.useCssClass();s!=null&&s.dragging&&((t=this.context)==null||t.target.classList.remove(s.dragging)),this.onDragging&&window.removeEventListener("pointermove",this.onDragging),this.onDragend&&window.removeEventListener("pointerup",this.onDragend),this.onDragging=void 0,this.onDragend=void 0,this.context=void 0}}const J=class J extends cs{constructor(n){super();u(this,"CREATE_RESOLVE");u(this,"CREATE_REJECT");u(this,"id");u(this,"type");u(this,"options");u(this,"body");u(this,"state");u(this,"created",!1);u(this,"destroyed",!1);u(this,"component");u(this,"draggable");u(this,"resizable");u(this,"handles",{});u(this,"dragstart");u(this,"resizestart");this.type=n.type??Ls.SIMPLE_WINDOW,this.options=this.createOptions(n),this.body=n.body,Reflect.defineProperty(this,"id",{enumerable:!0,configurable:!1,writable:!1,value:J.seed++}),this.initDraggable(),this.initResizable(),this.initHooks()}static create(n){return n instanceof J?n:new J(n)}get wid(){return"window--"+this.id}get isReady(){return this.created===!0}get allowDrag(){const n=this.options.draggable;return n===!1?!1:typeof n=="number"?n>0:!0}get allowDragArea(){const n=this.options.draggable;return typeof n=="number"&&n>0?n:Y.draggaleHeight}get isMaximize(){var n;return((n=this.state)==null?void 0:n.splitMode)===p.MAXIMIZE}createOptions(n){return{title:n.title??"未命名的窗口",icon:n.icon,className:n.className,bodyClassName:n.bodyClassName,width:n.width??"640px",minWidth:n.minWidth??360,maxWidth:n.maxWidth,height:n.height,minHeight:n.minHeight??32,maxHeight:n.maxHeight,top:n.top,left:n.left,zIndex:n.zIndex,maximize:n.maximize===!0,teleport:n.teleport??"body",draggable:n.draggable==null?!0:n.draggable,resizeMode:n.resizeMode??L.RESIZE,closeable:n.closeable!==!1,mask:n.mask===!0,pinnable:n.pinnable!==!1,displayAfterCreate:n.displayAfterCreate!==!1,destroyAfterClose:n.destroyAfterClose!==!1,closeOnPressEsc:n.closeOnPressEsc!==!1}}createEvent(n,t){return new bs(n,this,t)}initDraggable(){this.draggable=new ya(this),this.dragstart=this.draggable.dragstart.bind(this.draggable)}initResizable(){this.resizable=new us(this),this.resizestart=this.resizable.resizestart.bind(this.resizable)}initHooks(){this.once("created",()=>{this.created=!0,typeof this.CREATE_RESOLVE=="function"&&this.CREATE_RESOLVE(),delete this.CREATE_REJECT,delete this.CREATE_RESOLVE})}ready(){return this.created===!0?Promise.resolve():new Promise((n,t)=>{this.CREATE_RESOLVE=n,this.CREATE_REJECT=t})}show(){this.state==null||this.dispatch(this.createEvent("beforeShow")).defaultPrevented||(this.state.visible=!0)}close(n=!1){if(this.state==null||this.options.closeable===!1&&n!==!0)return!1;const t=this.dispatch(this.createEvent("beforeClose"));return n!==!0&&t.defaultPrevented?!1:(this.state.visible=!1,this.dispatch(this.createEvent("close")),this.state.focused&&setTimeout(ua),!this.destroyed&&this.options.destroyAfterClose!==!1&&this.destroy(),!0)}cleanup(){super.cleanup(),this.dragstart=void 0,this.resizestart=void 0,this.component=void 0,this.state=void 0,this.handles={}}destroy(){var n;this.destroyed=!0,((n=this.state)==null?void 0:n.visible)===!0&&this.close(),this.dispatch(this.createEvent("beforeDestroy")),la(this.id),setTimeout(()=>this.cleanup(),100)}getElement(){var n;return(n=this.component)==null?void 0:n.getElement()}useMenus(){return this.component.useMenus()}focus(){this.state==null||this.state.focused||ra(this.id)}startTransition(){const n=document.documentElement,t=function(e){e.target.matches("."+q.WINDOW)&&(n.classList.remove(q.TRANSITION),n.removeEventListener("transitionend",t))};n.classList.add(q.TRANSITION),n.addEventListener("transitionend",t)}requestMaximize(){const n=this.state;n==null||this.options.resizeMode!==L.RESIZE||(n.splitMode=p.MAXIMIZE,this.startTransition(),this.dispatch(this.createEvent("maximizeChange")))}exitMaximize(){const n=this.state;n==null||this.options.resizeMode!==L.RESIZE||(n.splitMode=p.NONE,this.startTransition(),this.dispatch(this.createEvent("maximizeChange")))}toggleMaximize(){const n=this.state;n==null||this.options.resizeMode!==L.RESIZE||(n.splitMode===p.MAXIMIZE?this.exitMaximize():this.requestMaximize())}pin(){const n=this.state;n!=null&&(n.pinned=!0)}unpin(){const n=this.state;n!=null&&(n.pinned=!1)}togglePin(){const n=this.state;n!=null&&(n.pinned?this.unpin():this.pin())}useHandle(n,t){this.handles[n]=t}async callHandle(n){const t=this.handles[n];if(typeof t=="function")return await t()}confirm(){return this.callHandle("confirm").then(n=>{this.dispatch(this.createEvent("confirm",n)),this.close(!0)})}cancel(n=!0){return this.callHandle("cancel").then(t=>{const e=this.close(n);console.log(e),e&&this.dispatch(this.createEvent("cancel",t))})}};u(J,"seed",1e3);let fs=J;const Ms=1e3,Y={},f=xa();function _a(a){return typeof a!="number"||!Number.isFinite(a)?Ms:Math.floor(a)}function va(a){Y.zIndex=_a(a==null?void 0:a.zIndex),Y.draggaleHeight=(a==null?void 0:a.draggaleHeight)??32,Y.size=(a==null?void 0:a.size)??{},f.zIndex=Y.zIndex}function ds(){return ln(Rs)}function xa(){return{appContext:null,isMounted:!1,zIndex:1e3,stack:new Map,ids:K([]),topWindow:null,previewState:ps({mode:p.NONE,width:0,height:0})}}function Us(a,s){var g;const n=a.state,t=((g=a.component)==null?void 0:g.useCssClass())??{};function e(){a.cancel()}function o(){a.togglePin()}function c(m){m.preventDefault(),a.toggleMaximize()}switch(s){case B.CLOSE:return r("button",{onClick:e,type:"button",innerHTML:Ps,class:t.closeMenu,title:"关闭"},null);case B.PIN:case B.UNPIN:const m=n.pinned?"取消固定":"固定",x=n.pinned?t.pinMenu:t.menu;return r("button",{onClick:o,type:"button",innerHTML:As,class:x,title:m},null);case B.MAXIMIZE:case B.RESTORE:const O=n.splitMode==p.MAXIMIZE?Ds:Ns,M=n.splitMode==p.MAXIMIZE?"还原":"最大化";return r("button",{onClick:c,type:"button",innerHTML:O,class:t.menu,title:M},null)}return null}const Ea="Ycke6mYQ",Ta="esgrGyhH",Wa="UkryRM5g",Ma="U5LZXLJZ",ka="_2rffDKab",Ia="vcVMeNrL",Oa="koc15mYi",Sa="_4VxfFKcG",V={splitWindowMask:Ea,maximize:Ta,splitLeft:Wa,splitRight:Ma,splitTopLeft:ka,splitTopRight:Ia,splitBottomLeft:Oa,splitBottomRight:Sa};function Ca(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!ns(a)}const za={[p.MAXIMIZE]:V.maximize,[p.LEFT]:V.splitLeft,[p.RIGHT]:V.splitRight,[p.TOP_LEFT]:V.splitTopLeft,[p.TOP_RIGHT]:V.splitTopRight,[p.BOTTOM_LEFT]:V.splitBottomLeft,[p.BOTTOM_RIGHT]:V.splitBottomRight},Ra={ArrowUp:{[p.BOTTOM_LEFT]:p.LEFT,[p.BOTTOM_RIGHT]:p.RIGHT,[p.LEFT]:p.TOP_LEFT,[p.RIGHT]:p.TOP_RIGHT,fallback:p.MAXIMIZE},ArrowDown:{[p.TOP_LEFT]:p.LEFT,[p.TOP_RIGHT]:p.RIGHT,[p.LEFT]:p.BOTTOM_LEFT,[p.RIGHT]:p.BOTTOM_RIGHT,fallback:p.NONE},ArrowLeft:{[p.TOP_RIGHT]:p.TOP_LEFT,[p.TOP_LEFT]:p.TOP_RIGHT,[p.BOTTOM_RIGHT]:p.BOTTOM_LEFT,[p.BOTTOM_LEFT]:p.BOTTOM_RIGHT,fallback:p.LEFT},ArrowRight:{[p.TOP_LEFT]:p.TOP_RIGHT,[p.TOP_RIGHT]:p.TOP_LEFT,[p.BOTTOM_LEFT]:p.BOTTOM_RIGHT,[p.BOTTOM_RIGHT]:p.BOTTOM_LEFT,fallback:p.RIGHT}},ks=S({name:"WindowManager",setup(){const a=pa(),s=ha();function n(o){const c=o.key;o.ctrlKey&&c in Ra}na(),window.addEventListener("keydown",n,!0),Cs(()=>{Vs(),window.removeEventListener("keydown",n,!0)});const t=U(()=>{const o=[V.splitWindowMask],c=za[s.mode];return c!=null&&o.push(c),o});function e(){let o=null;if(s.mode!=p.NONE){const g={zIndex:aa()+1,width:s.width?s.width-20+"px":void 0};o=r("div",{class:t.value,style:g},null)}return r(Ss,{to:"body"},{default:()=>[r(on,{name:"fade"},Ca(o)?o:{default:()=>[o]})]})}return function(){return[...a.value.map(c=>{const g=ia(c);if(g==null)return null;const m=Hs(g.type);return X(m,{abstractWindow:g,key:g.wid})}),e()]}}});function La(a){if(a.length==1){const s=a[0];return s==null?null:typeof s=="object"?{...s}:null}if(a.length==2){const[s,n]=a;if(typeof s=="string"&&n!=null)return{title:s,body:n}}if(a.length==3){const[s,n,t]=a;if(typeof s=="string"&&n!=null)return{...t,title:s,body:n}}return null}function _s(a){const s=La(a)??{},n=typeof s.size=="string"?Reflect.get(Y.size,s.size):null;return n!=null&&(s.width=n.width,s.height=n.height,s.top=n.top,s.left=n.left),s}function G(...a){const s=_s(a)??{};return vs(s)}function Zs(...a){const s=_s(a)??{};return s.type=qs.BLANK_WINDOW,vs(s)}function Pa(...a){const s=_s(a)??{};return s.type=qs.SIMPLE_WINDOW,vs(s)}function vs(a){const s=ca(a);return s.ready().then(()=>{a.displayAfterCreate!==!1&&s.show()}),s}const Ys=Object.freeze({renderMenu:Us});function Na(a,s){a.component(is.name,is),a.component(Q.name,Q),a.component(ks.name,ks),va(s),ga(),ma(a)}const Ba=jn,Aa={install:Na,version:Ba},Da=`<svg viewBox="0 0 1024 1024" version="1.1"
...
</svg>`,Ha=S({__name:"HelloWorld",setup(a){function s(){G("示例窗口",r("div",{class:"example-body"},[y("Hello, xWindow!")]))}return(n,t)=>(k(),I("button",{type:"button",onClick:s,class:"btn btn-small"},"尝试一下"))}}),Fa={class:"example-body"},Va=S({__name:"WinBody",props:{text:String},setup(a){return(s,n)=>(k(),I("div",Fa,P(a.text),1))}}),$a=S({__name:"FunctionBased",setup(a){function s(){G("窗口1",r("div",{class:"example-body"},[y("这段文本是使用JSX创建的。")]))}function n(){G("窗口2","这段本文可以直接展示。")}function t(){G("窗口3",X("div",{className:"example-body"},"这段文本是通过Vue提供的渲染函数创建的。"))}function e(){G("窗口4",()=>r("div",{class:"example-body"},[y("这段文本是通过返回VNode节点的函数创建的。")]))}function o(){G("窗口5",r(Va,{text:"这段文本通过组件创建的。"},null))}return(c,g)=>(k(),I($,null,[l("button",{class:"btn",type:"button",onClick:s},"JSX"),l("button",{class:"btn",type:"button",onClick:n},"文本"),l("button",{class:"btn",type:"button",onClick:t},"渲染函数"),l("button",{class:"btn",type:"button",onClick:e},"函数"),l("button",{class:"btn",type:"button",onClick:o},"组件")],64))}}),Xa=l("header",null,"窗口尺寸：",-1),Ga=l("header",null,"窗口位置：",-1),Ua=l("header",null,"窗口特性：",-1),Za=["onUpdate:modelValue"],Ya=l("header",null,"调整模式：",-1),Ja=["value"],Ka=l("span",null,"允许调整窗口大小，允许最大化（默认）",-1),Qa=["value"],st=l("span",null,"只允许调整窗口大小",-1),nt=["value"],at=l("span",null,"禁止",-1),Is="__WIN_EVENTS__",tt=S({__name:"Example",setup(a){const s=zs("classes"),n=wa(),t=[{label:"可拖拽",prop:"draggable",value:!0},{label:"可关闭",prop:"closeable",value:!0},{label:"可置顶",prop:"pinnable",value:!0},{label:"最大化",prop:"maximize",value:!1},{label:"遮罩层",prop:"mask",value:!1},{label:"按ESC键关闭",prop:"closeOnPressEsc",value:!0}],e={width:"800px",height:"600px",left:"calc(50vw - 400px)",top:"12vh",resizeMode:L.RESIZE},o=t.reduce((M,i)=>(M[i.prop]=i.value,M),{...e}),c=ps(o),g=S({props:{params:{type:Object,required:!0}},setup(M){const i=ds(),h=Reflect.get(i,Is);function v(){i==null||i.close(!0)}return function(){var N,as,ts,es,d,w;const j=c.closeable?null:r("button",{type:"button",class:"btn btn-small",onClick:v},[y("关闭窗口")]),z=t.map(E=>r("p",null,[E.label,y(": "),JSON.stringify(M.params[E.prop])])),C=h.value.map(E=>r("p",null,[E]));return r("div",{class:s.exampleBody},[r("div",{class:s.params},[r("div",{class:s.panel},[r("h4",null,[y("初始参数：")]),z]),r("div",{class:s.panel},[r("h4",null,[y("窗口状态：")]),r("div",{class:s.infos},[r("p",null,[y("id: "),i==null?void 0:i.wid]),r("p",null,[y("focused: "),JSON.stringify((N=i==null?void 0:i.state)==null?void 0:N.focused)]),r("p",null,[y("left: "),(as=i==null?void 0:i.state)==null?void 0:as.offsetLeft,y("px")]),r("p",null,[y("top: "),(ts=i==null?void 0:i.state)==null?void 0:ts.offsetTop,y("px")]),r("p",null,[y("width: "),(es=i==null?void 0:i.state)==null?void 0:es.offsetWidth,y("px")]),r("p",null,[y("height: "),(d=i==null?void 0:i.state)==null?void 0:d.offsetHeight,y("px")]),r("p",null,[y("z-index: "),JSON.stringify((w=i==null?void 0:i.state)==null?void 0:w.zIndex)])])])]),r("div",{class:s.eventHeader},[r("strong",null,[y("窗口事件")]),j]),r("div",{class:s.events},[C])])}}});function m(){const M=new Date,i=M.getMinutes().toString().padStart(2,"0"),h=M.getSeconds().toString().padStart(2,"0"),v=M.getMilliseconds().toString().padStart(4,"0");return`${i}:${h}.${v}`}function x(){const M=n.getWindowCount(),i={...c,bodyClassName:s.winBody},h=K([]),v=Pa("窗口"+M,r(g,{params:i},null),i);v.on("created",()=>{h.value.unshift(`[${m()}]: call created event.`)}),v.on("beforeShow",j=>{h.value.unshift(`[${m()}]: call beforeShow event.`)}),v.on("show",j=>{h.value.unshift(`[${m()}]: call show event.`)}),v.on("close",()=>{h.value.unshift(`[${m()}]: call close event.`)}),v.on("beforeDestroy",()=>{h.value.unshift(`[${m()}]: call beforeDestroy event.`)}),v.on("dragStart",j=>{h.value.unshift(`[${m()}]: call dragStart event.`)}),v.on("dragEnd",j=>{h.value.unshift(`[${m()}]: call dragEnd event.`)}),v.on("resizeStart",j=>{h.value.unshift(`[${m()}]: call resizeStart event.`)}),v.on("resizeEnd",j=>{h.value.unshift(`[${m()}]: call resizeEnd event. `)}),v.on("maximizeChange",j=>{h.value.unshift(`[${m()}]: call maximizeChange event. isMaximize: ${v.isMaximize}`)}),Reflect.set(v,Is,h)}function O(M,i){c.width=M+"px",c.height=i+"px"}return(M,i)=>(k(),I($,null,[l("section",{class:_(T(s).row)},[Xa,l("div",{class:_(T(s).content)},[l("label",null,[y("宽度："),D(l("input",{type:"text","onUpdate:modelValue":i[0]||(i[0]=h=>c.width=h),placeholder:"参照CSS的width属性"},null,512),[[ss,c.width]])]),l("label",null,[y("高度："),D(l("input",{type:"text","onUpdate:modelValue":i[1]||(i[1]=h=>c.height=h),placeholder:"参照CSS的height属性"},null,512),[[ss,c.height]])]),l("button",{type:"button",class:"btn btn-mini",onClick:i[2]||(i[2]=h=>O(800,600))},"800px*600px"),l("button",{type:"button",class:"btn btn-mini",onClick:i[3]||(i[3]=h=>O(390,840))},"390px*840px")],2)],2),l("section",{class:_(T(s).row)},[Ga,l("div",{class:_(T(s).content)},[l("label",null,[y("左侧："),D(l("input",{type:"text","onUpdate:modelValue":i[4]||(i[4]=h=>c.left=h),placeholder:"参照CSS中left属性"},null,512),[[ss,c.left]])]),l("label",null,[y("上侧："),D(l("input",{type:"text","onUpdate:modelValue":i[5]||(i[5]=h=>c.top=h),placeholder:"参照CSS中top属性"},null,512),[[ss,c.top]])])],2)],2),l("section",{class:_(T(s).row)},[Ua,l("div",{class:_(T(s).content)},[(k(),I($,null,rs(t,h=>l("label",{key:h.prop},[D(l("input",{type:"checkbox","onUpdate:modelValue":v=>c[h.prop]=v},null,8,Za),[[cn,c[h.prop]]]),l("span",null,P(h.label),1)])),64))],2)],2),l("section",{class:_(T(s).row)},[Ya,l("div",{class:_(T(s).content)},[l("label",null,[D(l("input",{type:"radio",name:"resizeMode",value:T(L).RESIZE,"onUpdate:modelValue":i[6]||(i[6]=h=>c.resizeMode=h)},null,8,Ja),[[js,c.resizeMode]]),Ka]),l("label",null,[D(l("input",{type:"radio",name:"resizeMode",value:T(L).RESIZE_ONLY,"onUpdate:modelValue":i[7]||(i[7]=h=>c.resizeMode=h)},null,8,Qa),[[js,c.resizeMode]]),st]),l("label",null,[D(l("input",{type:"radio",name:"resizeMode",value:T(L).DISABLED,"onUpdate:modelValue":i[8]||(i[8]=h=>c.resizeMode=h)},null,8,nt),[[js,c.resizeMode]]),at])],2)],2),l("button",{onClick:x,class:"btn"},"创建窗口")],64))}}),et="Zj7DQ8mX",lt="hZ15PjHU",ot="tbtACTrZ",ct="_3N6wV7j6",it="oTAjhRfW",pt="CFWamGXp",rt="cqiqLgbF",ut="T9Y6Pp6o",dt="TUAWahwn",ht={winBody:et,exampleBody:lt,row:ot,content:ct,events:it,params:pt,panel:rt,infos:ut,eventHeader:dt},xs=(a,s)=>{const n=a.__vccOpts||a;for(const[t,e]of s)n[t]=e;return n},jt={classes:ht},gt=xs(tt,[["__cssModules",jt]]),mt={class:"approval-form"},ft={key:0,class:"approval-form-message"},Js=S({__name:"UseApproval",setup(a){const s=ds(),n=ps({value:"",fail:!1});return s==null||s.useHandle("confirm",()=>n.value?n.value:(n.fail=!0,Promise.reject("验证未通过"))),(t,e)=>(k(),I("div",mt,[D(l("textarea",{type:"text","onUpdate:modelValue":e[0]||(e[0]=o=>n.value=o),placeholder:"请输入",ref:"inputRef",autofocus:""},null,512),[[ss,n.value]]),n.fail?(k(),I("div",ft,"请输入审批意见")):ws("",!0)]))}}),wt={key:0,class:"example-modal"},bt={class:"example-modal-header"},yt={class:"example-modal-title"},_t={class:"example-modal-menus"},vt={class:"example-modal-body"},xt={class:"example-modal-footer"},Ks=S({__name:"Modal",setup(a){const s=ds(),n=()=>s==null?void 0:s.cancel().catch(e=>console.error(e)),t=()=>s==null?void 0:s.confirm().catch(e=>console.error(e));return(e,o)=>T(s)?(k(),I("div",wt,[l("div",bt,[l("div",yt,P(T(s).options.title),1),l("div",_t,[ms(e.$slots,"menus",{abstractWindow:T(s)})])]),l("div",vt,[ms(e.$slots,"default",{abstractWindow:T(s)})]),l("div",xt,[l("button",{type:"button",class:"btn btn-small",onClick:o[0]||(o[0]=c=>n())},"取消"),l("button",{type:"button",class:"btn btn-small",onClick:o[1]||(o[1]=c=>t())},"确定")])])):ws("",!0)}}),Et=Object.freeze(Object.defineProperty({__proto__:null,Example:gt,FunctionBased:$a,HelloWorld:Ha,Modal:Ks,UseApproval:Js},Symbol.toStringTag,{value:"Module"})),Tt=["innerHTML"],Wt=["onClick"],Mt=S({__name:"index",props:{menuClass:{type:String,default:null}},setup(a){const s=[{name:"皓白",primaryColor:"#ebeef0",textColor:"#000"},{name:"天缥",primaryColor:"#d5ebe1",textColor:"#000",navTextSecondaryColor:"#333"},{name:"海天霞",primaryColor:"#f3a694",textColor:"#000",navTextSecondaryColor:"#333"},{name:"暮山紫",primaryColor:"#a4abd6",textColor:"#000",navTextSecondaryColor:"#333"}].map(e=>({...e,background:e.primaryColor}));function n(e){return{"--xwindow-color-primary":e.primaryColor,"--xwindow-header-color":e.textColor,"--nav-text-secondary-color":e.navTextSecondaryColor}}function t(e){const o=document.documentElement,c=n(e);for(const g in c){const m=c[g];m==null?o.style.removeProperty(g):o.style.setProperty(g,m)}}return(e,o)=>(k(),I("div",{class:_(e.classes.picker)},[l("button",{type:"button",class:_(a.menuClass),innerHTML:T(Da),title:"主题"},null,10,Tt),l("ul",{class:_(e.classes.panel)},[(k(!0),I($,null,rs(T(s),c=>(k(),I("li",{key:c.id,onClick:g=>t(c),style:Ts({"--theme-primary-color":c.primaryColor})},[l("span",{class:_(e.classes.badge),style:Ts({background:c.background})},null,6),l("strong",null,P(c.name),1)],12,Wt))),128))],2)],2))}}),kt="JJwYh7Hb",It="nGuXZaqY",Ot="WnLJWuwF",St={picker:kt,panel:It,badge:Ot},Ct={classes:St},zt=xs(Mt,[["__cssModules",Ct]]),Rt=`<p>xWindow是仿Windows窗口的组件库，目标是提供一套快捷的API来创建和使用窗口。本文档的就是基于xWindow创建了一个窗口，你可以拖动文档查看效果。</p>
...
<p>xWindow不需要事先在业务组件中声明，你可以在任何需要的地方直接创建一个窗口。 <HelloWorld/></p>`,Lt=`<h2 class="head-anchor article-sticky-heading" id="安装">安装</h2>
...
<p>最终效果如下：
<span class="quickstart-function-based"><FunctionBased/></span></p>`,Pt=`<h2 class="head-anchor article-sticky-heading" id="模态框">模态框</h2>
...
<p>效果如下：<UseExample/></p>`,Nt="<Example/>",Bt=`<h2 class="head-anchor article-sticky-heading" id="函数式API">函数式API</h2>
<hr>
...
</code><button type="button" class="doc-copy-btn" title="复制"/></pre>`,At=l("colgroup",null,[l("col",{width:"160"}),l("col",{width:"150"})],-1),Dt=l("thead",null,[l("tr",null,[l("th",null,"事件"),l("th",null,"默认行为"),l("th",null,"说明")])],-1),qt={__name:"Events",setup(a){const s=[{type:"created",desc:"窗口组件创建时触发"},{type:"beforeShow",prevent:"可阻止窗口显示",desc:"窗口显示前触发"},{type:"show",desc:"窗口显示后触发"},{type:"beforeClose",prevent:"可阻止窗口关闭",desc:"窗口关闭前触发"},{type:"close",desc:"窗口关闭时触发"},{type:"beforeDestroy",desc:"窗口销毁前触发"},{type:"dragStart",prevent:"可阻止窗口拖动",desc:"窗口开始拖动时触发"},{type:"dragging",desc:"窗口拖动时触发"},{type:"dragEnd",desc:"窗口拖动结束时触发"},{type:"resizeStart",prevent:"可阻止窗口调整尺寸",desc:"窗口开始调整尺寸时触发"},{type:"resizing",desc:"窗口调整尺寸时触发"},{type:"resizeEnd",desc:"窗口结束调整尺寸时触发"},{type:"maximizeChange",desc:"窗口最大化状态改变时触发"},{type:"confirm",desc:"调用窗口的confirm方法后触发，可通过此事件返回窗体的内容"},{type:"cancel",desc:"调用窗口的cancel方法后触发"}];return(n,t)=>(k(),I("table",null,[At,Dt,l("tbody",null,[(k(),I($,null,rs(s,e=>l("tr",{key:e.prop},[l("td",null,P(e.type),1),l("td",null,P(e.prevent??"--"),1),l("td",null,P(e.desc),1)])),64))])]))}};function Ht(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!ns(a)}function Qs(a,s,n={}){n.height=n.height??"320px";const t={default(e){return typeof s=="function"?s(e.abstractWindow):s},menus(e){return e.abstractWindow.useMenus().value.map(c=>Ys.renderMenu(e.abstractWindow,c))}};return Zs(a,r(Ks,null,Ht(t)?t:{default:()=>[t]}),n)}function Ft(){return new Promise((a,s)=>{const n={mask:!0,resizeMode:L.DISABLED},t=Qs("请输入审批意见",r(Js,null,null),n);t.once("confirm",e=>a(e.detail)),t.once("cancel",e=>s(e.detail))})}const Vt={class:"approval-output"},$t=l("strong",null,"操作结果：",-1),Xt=S({__name:"UseExample",setup(a){const s=K("");async function n(){const t=await Ft().catch(e=>(console.log(e),null));if(t==null){s.value="取消操作";return}s.value=t}return(t,e)=>(k(),I($,null,[l("button",{type:"button",class:"btn btn-small",onClick:n},"审批"),l("div",Vt,[s.value?(k(),I($,{key:0},[$t,l("pre",null,P(s.value),1)],64)):ws("",!0)])],64))}}),Gt=S({__name:"UseModal",setup(a){function s(){Qs("窗口1",r("div",null,[y("内容")]))}return(n,t)=>(k(),I("button",{type:"button",class:"btn btn-small",onClick:s},"打开模态框"))}}),Ut=Object.freeze(Object.defineProperty({__proto__:null,Events:qt,UseExample:Xt,UseModal:Gt},Symbol.toStringTag,{value:"Module"})),Zt=[{name:"简介",content:Rt},{name:"快速开始",content:Lt},{name:"进阶应用",content:Pt},{name:"API",content:Bt},{name:"示例",content:Nt}],Os=Zt.map((a,s)=>({id:s,...a})),Yt=["innerHTML"],Jt=l("span",null,"xWindow",-1),Kt=["onClick"],Qt=l("span",null,"Copyright © 2023-present dongls",-1),se=[Qt],ne=S({__name:"docs",setup(a){const s=zs("classes"),n="09221956",t="0.1.3",e=0,o=ds(),c=Kn(),g=K(Os[e]),m=K();function x(j){j.stopPropagation()}function O(){var C;if(o==null)return null;const j=o.useMenus(),z=((C=o.component)==null?void 0:C.useCssClass())??{};return r("div",{class:s.menus,onMousedown:x},[r(zt,{menuClass:z.menu},null),r("button",{title:"GitHub",class:z.menu,onClick:M,innerHTML:qa},null),j==null?void 0:j.value.map(N=>Ys.renderMenu(o,N))])}function M(){window.open("https://github.com/dongls/xWindow")}function i(){const j=g.value.content,z={...Et,...Ut};return X("article",{class:"article",key:g.value.id},X({template:j,components:z}))}async function h(j){g.value=j,await gs(),m.value&&(m.value.scrollTop=0)}function v(j){const z=j.target.closest("pre.hljs");if(z==null)return;const C=z.querySelector(":scope > code.hljs-code");if(C==null)return;const N=C.textContent;N!=null&&navigator.clipboard.writeText(N)}return(j,z)=>(k(),I("div",{class:_(j.classes.app)},[l("aside",{class:_(j.classes.aside)},[l("div",{class:_(j.classes.leftHeader)},[l("i",{class:_(j.classes.logo),innerHTML:T(c).IconWindow},null,10,Yt),l("h3",{class:_(j.classes.title)},[Jt,l("small",null,"v"+P(T(t))+"_"+P(T(n)),1)],2)],2),l("nav",{class:_([j.classes.navs,"is-scroll"])},[(k(!0),I($,null,rs(T(Os),C=>(k(),I("div",{onClick:N=>h(C),class:_([j.classes.nav,C.id==g.value.id?j.classes.activeNav:null])},P(C.name),11,Kt))),256))],2),l("div",{class:_(j.classes.copyright)},se,2)],2),l("main",{class:_(j.classes.main)},[l("div",{class:_(j.classes.rightHeader)},[r(O)],2),l("div",{class:_(j.classes.scroll),ref_key:"scroll",ref:m,onClick:pn(v,["stop"])},[r(i,{class:_(j.classes.content)},null,8,["class"]),ms(j.$slots,"default",{ref:"tref"})],2)],2)],2))}}),ae="Cs1eNLRW",te="mkQVrkEV",ee="fxJePVAw mkQVrkEV",le="gW5FCXxJ mkQVrkEV",oe="UCU4MEPE",ce="wascU8g5",ie="QVKApkXV",pe="xQ7Xh7bM",re="LhDQ3ctB",ue="_7RZWnCfQ",de="_95hpDEbG",he="cXaxwh5B",je="_2dkZEz4e",ge="_6qjvpjzC",me="qSce7387",fe={app:ae,header:te,leftHeader:ee,rightHeader:le,menus:oe,aside:ce,navs:ie,nav:pe,activeNav:re,main:ue,content:de,scroll:he,copyright:je,logo:ge,title:me},we={classes:fe},be=xs(ne,[["__cssModules",we]]),ye=S({__name:"App",setup(a){let s=null;function n(){s&&s.close(),s=null}return Cs(n),rn(()=>{s=Zs({closeable:!1,zIndex:999,width:"1280px",height:"900px",minHeight:640,body:r(be,null,null),title:"",className:"xwindow-doc"})}),(t,e)=>{const o=dn("WindowManager");return k(),un(o)}}}),sn=hn(ye);sn.use(Aa);sn.mount("#app");
