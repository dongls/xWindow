...
</code><button type="button" class="doc-copy-btn" title="复制"/></pre>`,Mt=e("colgroup",null,[e("col",{width:"160"}),e("col",{width:"150"})],-1),kt=e("thead",null,[e("tr",null,[e("th",null,"事件"),e("th",null,"默认行为"),e("th",null,"说明")])],-1),It={__name:"Events",setup(a){const s=[{type:"created",desc:"窗口组件创建时触发"},{type:"beforeShow",prevent:"可阻止窗口显示",desc:"窗口显示前触发"},{type:"show",desc:"窗口显示后触发"},{type:"beforeClose",prevent:"可阻止窗口关闭",desc:"窗口关闭前触发"},{type:"close",desc:"窗口关闭时触发"},{type:"beforeDestroy",desc:"窗口销毁前触发"},{type:"dragStart",prevent:"可阻止窗口拖动",desc:"窗口开始拖动时触发"},{type:"dragging",desc:"窗口拖动时触发"},{type:"dragEnd",desc:"窗口拖动结束时触发"},{type:"resizeStart",prevent:"可阻止窗口调整尺寸",desc:"窗口开始调整尺寸时触发"},{type:"resizing",desc:"窗口调整尺寸时触发"},{type:"resizeEnd",desc:"窗口结束调整尺寸时触发"},{type:"maximizeChange",desc:"窗口最大化状态改变时触发"},{type:"confirm",desc:"调用窗口的confirm方法后触发，可通过此事件返回窗体的内容"},{type:"cancel",desc:"调用窗口的cancel方法后触发"}];return(n,t)=>(W(),M("table",null,[Mt,kt,e("tbody",null,[(W(),M(D,null,rs(s,l=>e("tr",{key:l.prop},[e("td",null,z(l.type),1),e("td",null,z(l.prevent??"--"),1),e("td",null,z(l.desc),1)])),64))])]))}};function Ct(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!ms(a)}function sn(a,s,n={}){n.height=n.height??"320px";const t={default(l){return typeof s=="function"?s(l.abstractWindow):s},menus(l){return l.abstractWindow.useMenus().value.map(c=>Js.renderMenu(l.abstractWindow,c))}};return Gs(a,p(Qs,null,Ct(t)?t:{default:()=>[t]}),n)}function Ot(){const a={mask:!0,resizeMode:S.DISABLED};return sn("请输入审批意见",p(Ks,null,null),a).promisify()}const St={class:"approval-output"},zt=e("strong",null,"操作结果：",-1),Rt=I({__name:"UseExample",setup(a){const s=Y("");async function n(){const t=await Ot().catch(l=>(console.log(l),null));if(t==null){s.value="取消操作";return}s.value=t}return(t,l)=>(W(),M(D,null,[e("button",{type:"button",class:"btn btn-small",onClick:n},"审批"),e("div",St,[s.value?(W(),M(D,{key:0},[zt,e("pre",null,z(s.value),1)],64)):fs("",!0)])],64))}}),Pt=I({__name:"UseModal",setup(a){function s(){sn("窗口1",p("div",null,[b("内容")]))}return(n,t)=>(W(),M("button",{type:"button",class:"btn btn-small",onClick:s},"打开模态框"))}}),Lt=Object.freeze(Object.defineProperty({__proto__:null,Events:It,UseExample:Rt,UseModal:Pt},Symbol.toStringTag,{value:"Module"})),Nt=[{name:"简介",content:vt},{name:"快速开始",content:xt},{name:"进阶应用",content:Et},{name:"API",content:Wt},{name:"示例",content:Tt}],ks=Nt.map((a,s)=>({id:s,...a})),Bt=["innerHTML"],At=e("span",null,"xWindow",-1),Dt=["onClick"],qt=e("span",null,"Copyright © 2023-present dongls",-1),Ht=[qt],Ft=I({__name:"docs",setup(a){const s=Cs("classes"),n="11252131",t="0.2.8",l=0,o=ds(),c=sa(),j=Y(ks[l]),_=Y();function F(g){g.stopPropagation()}function N(){var C;if(o==null)return null;const g=o.useMenus(),O=((C=o.component)==null?void 0:C.useCssClass())??{};return p("div",{class:s.menus,onMousedown:F},[p(_t,{menuClass:O.menu},null),p("button",{title:"GitHub",class:O.menu,onClick:T,innerHTML:Ia},null),g==null?void 0:g.value.map(R=>Js.renderMenu(o,R))])}function T(){window.open("https://github.com/dongls/xWindow")}function i(){const g=j.value.content,O={...dt,...Lt};return V("article",{class:"article",key:j.value.id},V({template:g,components:O}))}async function h(g){j.value=g,await js(),_.value&&(_.value.scrollTop=0)}function v(g){const O=g.target.closest("pre.hljs");if(O==null)return;const C=O.querySelector(":scope > code.hljs-code");if(C==null)return;const R=C.textContent;R!=null&&navigator.clipboard.writeText(R)}return(g,O)=>(W(),M("div",{class:y(g.classes.app)},[e("aside",{class:y(g.classes.aside)},[e("div",{class:y(g.classes.leftHeader)},[e("i",{class:y(g.classes.logo),innerHTML:E(c).IconWindow},null,10,Bt),e("h3",{class:y(g.classes.title)},[At,e("small",null,"v"+z(E(t))+"_"+z(E(n)),1)],2)],2),e("nav",{class:y([g.classes.navs,"is-scroll"])},[(W(!0),M(D,null,rs(E(ks),C=>(W(),M("div",{onClick:R=>h(C),class:y([g.classes.nav,C.id==j.value.id?g.classes.activeNav:null])},z(C.name),11,Dt))),256))],2),e("div",{class:y(g.classes.copyright)},Ht,2)],2),e("main",{class:y(g.classes.main)},[e("div",{class:y(g.classes.rightHeader)},[p(N)],2),e("div",{class:y(g.classes.scroll),ref_key:"scroll",ref:_,onClick:un(v,["stop"])},[p(i,{class:y(g.classes.content)},null,8,["class"]),gs(g.$slots,"default",{ref:"tref"})],2)],2)],2))}}),Vt="Cs1eNLRW",$t="mkQVrkEV",Xt="fxJePVAw mkQVrkEV",Ut="gW5FCXxJ mkQVrkEV",Gt="UCU4MEPE",Zt="wascU8g5",Yt="QVKApkXV",Jt="xQ7Xh7bM",Kt="LhDQ3ctB",Qt="_7RZWnCfQ",sl="_95hpDEbG",nl="cXaxwh5B",al="_2dkZEz4e",tl="_6qjvpjzC",ll="qSce7387",el={app:Vt,header:$t,leftHeader:Xt,rightHeader:Ut,menus:Gt,aside:Zt,navs:Yt,nav:Jt,activeNav:Kt,main:Qt,content:sl,scroll:nl,copyright:al,logo:tl,title:ll},ol={classes:el},cl=_s(Ft,[["__cssModules",ol]]),il=I({__name:"App",setup(a){let s=null;function n(){s&&s.close(),s=null}return Is(n),dn(()=>{s=Gs({closeable:!1,zIndex:999,width:"1280px",height:"900px",minWidth:1102,minHeight:480,body:p(cl,null,null),title:"",className:"xwindow-doc"})}),(t,l)=>{const o=jn("WindowManager");return W(),hn(o)}}}),nn=gn(il);nn.use(Ma);nn.mount("#app");
