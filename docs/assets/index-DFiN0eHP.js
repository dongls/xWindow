var en=Object.defineProperty;var ln=(t,s,n)=>s in t?en(t,s,{enumerable:!0,configurable:!0,writable:!0,value:n}):t[s]=n;var u=(t,s,n)=>(ln(t,typeof s!="symbol"?s+"":s,n),n);import{d as S,c as U,h as X,s as on,r as us,a as K,p as cn,b as r,T as Cs,i as ns,n as ms,e as Ts,f as pn,o as zs,g as rn,j as M,k,l as y,t as P,m as l,F as $,u as Rs,q as _,v as E,w as A,x as ss,y as ds,z as un,A as gs,B as bs,C as fs,D as Ws,E as dn,G as hn,H as jn,I as gn,J as mn}from"./vendor-79HxGn9k.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const e of document.querySelectorAll('link[rel="modulepreload"]'))a(e);new MutationObserver(e=>{for(const o of e)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&a(c)}).observe(document,{childList:!0,subtree:!0});function n(e){const o={};return e.integrity&&(o.integrity=e.integrity),e.referrerPolicy&&(o.referrerPolicy=e.referrerPolicy),e.crossOrigin==="use-credentials"?o.credentials="include":e.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function a(e){if(e.ep)return;e.ep=!0;const o=n(e);fetch(e.href,o)}})();const fn="0.1.4",Ls=Symbol(),D=Object.freeze({WINDOW:"x-window",SIMPLE_WINDOW:"x-simple-window",TRANSITION:"x-window-is-transition",MENU:"x-window-is-menu",FOCUSED:"x-window-is-focused",MAXIMIZE:"x-window-is-maximize",HEADER:"x-window-header",BODY:"x-window-body"}),b=Object.freeze({NONE:0,TOP:1,BOTTOM:2,LEFT:4,RIGHT:8}),F=Object.freeze({TOP:b.TOP,BOTTOM:b.BOTTOM,LEFT:b.LEFT,RIGHT:b.RIGHT,TOP_LEFT:b.TOP|b.LEFT,TOP_RIGHT:b.TOP|b.RIGHT,BOTTOM_LEFT:b.BOTTOM|b.LEFT,BOTTOM_RIGHT:b.BOTTOM|b.RIGHT}),p=Object.freeze({NONE:b.NONE,MAXIMIZE:b.TOP,LEFT:b.LEFT,RIGHT:b.RIGHT,TOP_LEFT:b.TOP|b.LEFT,TOP_RIGHT:b.TOP|b.RIGHT,BOTTOM_LEFT:b.BOTTOM|b.LEFT,BOTTOM_RIGHT:b.BOTTOM|b.RIGHT}),L=Object.freeze({DISABLED:0,RESIZE:1,RESIZE_ONLY:2}),Z=Object.freeze({INIT:0,MOUNTED:1,UNMOUNTED:2}),Ps=Object.freeze({SIMPLE_WINDOW:"SimpleWindow",BLANK_WINDOW:"BlankWindow"}),B=Object.freeze({CLOSE:0,MAXIMIZE:1,RESTORE:2,PIN:3,UNPIN:4});class ys{constructor(s,n,a){u(this,"type");u(this,"stopped",!1);u(this,"defaultPrevented",!1);u(this,"instance");u(this,"detail");this.type=s,this.instance=n,this.detail=a}stop(){this.stopped=!0}preventDefault(){this.defaultPrevented=!0}}class ps{constructor(){u(this,"ALL_EVENTS",new Map)}static NOOP(){}on(s,n){const a=this.ALL_EVENTS.get(s);return a==null?(this.ALL_EVENTS.set(s,[n]),this):a.includes(n)?this:(a.push(n),this)}once(s,n){const a=e=>{n(e),this.off(s,a,!0)};return this.on(s,a),this}off(s,n,a=!1){const e=this.ALL_EVENTS.get(s);if(e==null)return this;const o=e.indexOf(n);return o<0?this:(a?e.splice(o,1,ps.NOOP):e.splice(o,1),this)}dispatch(s){const n=this.ALL_EVENTS.get(s.type);if(n==null)return s;for(const e of n)if(typeof e=="function"&&e(s),s.stopped)break;const a=n.filter(e=>e!=ps.NOOP);return this.ALL_EVENTS.set(s.type,a),s}cleanup(){this.ALL_EVENTS.clear()}}function R(t,s,n){return s!=null&&Number.isFinite(s)&&t<s?s:n!=null&&Number.isFinite(n)&&t>n?n:t}function Ms(t){return t==null||typeof t!="string"?!0:t.length==0}function wn(t){return t==null||typeof t!="string"?!1:t.length!=0}function bn(t){t.stopPropagation()}const yn={top:"offsetTop",left:"offsetLeft",width:"offsetWidth",height:"offsetHeight"};class _n{constructor(s){u(this,"init",!1);u(this,"defaultPrevented",!1);u(this,"originalEvent");u(this,"target");u(this,"direction");this.originalEvent=s,this.target=s.target,this.direction=Reflect.get(this.target,hs.PROP)}createEvent(s,n){return new ys(s,n,this)}}class hs{constructor(s){u(this,"context");u(this,"window");u(this,"onResizing");u(this,"onResizeend");this.window=s}resizestart(s){s.stopPropagation(),s.preventDefault();const n=new _n(s);this.context=n,this.onResizing=this.resizing.bind(this),this.onResizeend=this.resizeend.bind(this),window.addEventListener("pointermove",this.onResizing),window.addEventListener("pointerup",this.onResizeend)}resizing(s){if(this.context==null)return;s.stopPropagation(),s.preventDefault();const n=this.context;if(!n.init){if(this.window.dispatch(this.context.createEvent("resizeStart",this.window)).defaultPrevented)return this.cleanup();n.target.setPointerCapture(s.pointerId),n.init=!0}const a=this.calcWindowState(s),e=this.window.getElement();for(const c in a){const g=Math.round(a[c]);Reflect.set(e.style,c,g+"px")}n.originalEvent=s;const o=this.context.createEvent("resizing",this.window);this.window.dispatch(o)}resizeend(s){if(this.context==null)return;s.stopPropagation(),s.preventDefault();const n=this.context;if(n.init){const a=n.createEvent("resizeEnd",this.window);this.window.dispatch(a),this.patchWindowState(this.calcWindowState(s)),n.target.releasePointerCapture(s.pointerId)}this.cleanup()}cleanup(){this.onResizing&&window.removeEventListener("pointermove",this.onResizing),this.onResizeend&&window.removeEventListener("pointerup",this.onResizeend),this.onResizing=void 0,this.onResizeend=void 0,this.context=void 0}calcWindowState(s){const n=this.context,a=this.window.options,e=typeof a.minWidth=="number"&&a.minWidth>=0?a.minWidth:360,o=typeof a.minHeight=="number"&&a.minHeight>=0?a.minHeight:32,c=this.window.getElement().getBoundingClientRect(),g=document.documentElement.getBoundingClientRect(),m={};if(n.direction&b.TOP){const x=R(c.bottom-R(s.clientY,0),o),I=R(s.clientY-g.top,0,window.innerHeight-x);m.height=x,m.top=I}if(n.direction&b.BOTTOM){const x=R(R(s.clientY,0,window.innerHeight)-c.top,o),I=R(s.clientY-x-g.top,0,window.innerHeight-x);m.height=x,m.top=I}if(n.direction&b.LEFT){const x=R(c.right-R(s.clientX,0),e,window.innerWidth),I=R(s.clientX-g.left,0,window.innerWidth-x);m.width=x,m.left=I}if(n.direction&b.RIGHT){const x=R(R(s.clientX,0)-c.left,e,window.innerWidth),I=R(s.clientX-x-g.left,0,window.innerWidth-x-0);m.width=x,m.left=I}return m}patchWindowState(s){const n=this.window.state;for(const a in s){const e=Math.round(s[a]),o=yn[a];o!=null&&Reflect.set(n,o,e)}}}u(hs,"PROP","__xwindow_resize_prop__");const vn="_1T2rhwiL",xn="yi9w1sZD",En="Ja2o9U31",Tn="_1eMSsKoB",Wn="_3czvPpS2",Mn="GiVk7T8N",kn="VuG4WNig x-window-is-menu",In="yBPezU8e",On="xbuRK23n",Sn="_9t1NJBZM",Cn="shyxrRzw",zn="nkEGqTFw",Rn="pk12TusX",Ln="noixF94i",Pn="ifXDegN1 VuG4WNig x-window-is-menu",Nn="X5A6roxN VuG4WNig x-window-is-menu",Bn="PPmfTMRL",An="v8UGXgKi PPmfTMRL",Dn="_74VJ9GNt PPmfTMRL",qn="gg9Mcwey PPmfTMRL",Hn="Tw7sCaLt PPmfTMRL",Fn="CPuApFyD PPmfTMRL",Vn="VBRi4FWg PPmfTMRL",$n="gCRpuZdB PPmfTMRL",Xn="iRYpNoUT PPmfTMRL",Gn="xTcKGSVA",T={window:vn,dragging:xn,resizing:En,maximize:Tn,focused:Wn,header:Mn,menu:kn,logo:In,main:On,init:Sn,title:Cn,menus:zn,body:Rn,footer:Ln,closeMenu:Pn,pinMenu:Nn,resizeBar:Bn,resizeTop:An,resizeBottom:Dn,resizeRight:qn,resizeLeft:Hn,resizeTopLeft:Fn,resizeBottomLeft:Vn,resizeTopRight:$n,resizeBottomRight:Xn,mask:Gn},Ns=S({name:"WindowBody",props:{wid:String,body:{type:[Object,Function,String,Number],default:null},abstractWindow:{type:Object,required:!0}},setup(t){return function(){const s=typeof t.body=="function"?t.body(t.abstractWindow):t.body;return s==null&&console.warn("[xWindow] 请指定窗体内容:",t.abstractWindow.options.title),s}}}),Un=Math.floor(Number.MAX_SAFE_INTEGER/10)-1e4;function Zn(){return{visible:!1,offsetWidth:0,offsetHeight:0,offsetTop:0,offsetLeft:0,focused:!1,pinned:!1,zIndex:0,splitMode:p.NONE}}const Yn=[[T.resizeTop,F.TOP],[T.resizeBottom,F.BOTTOM],[T.resizeLeft,F.LEFT],[T.resizeRight,F.RIGHT],[T.resizeTopLeft,F.TOP_LEFT],[T.resizeTopRight,F.TOP_RIGHT],[T.resizeBottomLeft,F.BOTTOM_LEFT],[T.resizeBottomRight,F.BOTTOM_RIGHT]];function Jn(t,s,n,a){return U(()=>{const e=t.options;if(s.value==Z.INIT)return{width:e.width,height:e.height,left:e.left,top:e.top};const o=e.mask?null:a.value;return{top:n.offsetTop+"px",left:n.offsetLeft+"px",width:n.offsetWidth+"px",height:s.value==Z.INIT?void 0:n.offsetHeight+"px",zIndex:o}})}function Kn(t,s){return t==L.DISABLED?null:Yn.map(n=>X("div",{["."+hs.PROP]:n[1],className:n[0],onPointerdown:s}))}function Qn(t){return typeof t=="function"||Object.prototype.toString.call(t)==="[object Object]"&&!ns(t)}const Q=S({name:"BlankWindow",props:{abstractWindow:{type:Object,required:!0}},setup(t,{slots:s}){const n=on(),a=us(Zn()),e=K(Z.INIT),o=U(()=>{const d=t.abstractWindow.options;return typeof d.zIndex=="number"&&d.zIndex>0}),c=U(()=>{const d=t.abstractWindow.options;return o.value?d.zIndex:(a.pinned?Un:0)+a.zIndex}),g=Jn(t.abstractWindow,e,a,c),m=U(()=>{const d=[D.WINDOW,T.window],w=t.abstractWindow;return w.type===Ps.SIMPLE_WINDOW&&d.push(D.SIMPLE_WINDOW),e.value==Z.INIT&&d.push(T.init),a.splitMode==p.MAXIMIZE&&d.push(T.maximize,D.MAXIMIZE),a.focused&&d.push(T.focused,D.FOCUSED),wn(w.options.className)&&d.push(w.options.className),d}),x=U(()=>{const d=[],O=t.abstractWindow.options;return O.pinnable&&O.mask!==!0&&o.value!==!0&&d.push(a.pinned?B.PIN:B.UNPIN),O.resizeMode==L.RESIZE&&d.push(a.splitMode==p.MAXIMIZE?B.RESTORE:B.MAXIMIZE),O.closeable&&d.push(B.CLOSE),d}),I={getElement:W,getRenderState:i,useCssClass:h,useMenus:z};function W(){return n.value}function i(){return e.value}function h(){return T}async function v(d){d==null||d.preventDefault(),t.abstractWindow.toggleMaximize()}function j(){JSON.parse(JSON.stringify(a))}function z(){return x}function C(d){const w=Array.from(d.querySelectorAll("[autofocus]"));for(const O of w)if(O instanceof HTMLElement&&O.autofocus)return O.focus()}async function N(d){await ms();const w=t.abstractWindow,O=w.options,os=d.el,q=os.getBoundingClientRect();if(e.value==Z.INIT){let cs=Math.round(q.left),is=Math.round(q.top);Ms(O.left)&&(cs=Math.floor((window.innerWidth-q.width)/2)),Ms(O.top)&&(is=Math.floor((window.innerHeight-q.height)/2)),a.offsetWidth=q.width,a.offsetHeight=q.height,a.offsetLeft=cs,a.offsetTop=is,O.maximize&&v(),e.value=Z.MOUNTED,j(),ms(()=>{const H=w.createEvent("show");w.dispatch(H),C(os)})}w.focus()}function ts(d){const w=t.abstractWindow;w.focus(),!(!w.allowDrag||w.isMaximize)&&w.dragstart(d)}function as(d){const w=W();if(w==null)return;const O=w.getBoundingClientRect();d.clientY-O.top>t.abstractWindow.allowDragArea||v(d)}function es(){const d=t.abstractWindow;d.component=I,d.state=a,ot(d.id,d);const w=d.createEvent("created");d.dispatch(w)}function ls(){const d=t.abstractWindow,w=d.options;return r(Ns,{class:w.bodyClassName,body:d.body,abstractWindow:t.abstractWindow,key:d.wid},null)}return cn(Ls,t.abstractWindow),es(),function(){const d=t.abstractWindow,w=d.options;if(a.visible!==!0)return null;const O=typeof s.header=="function"?s.header(I):null,os=typeof s.body=="function"?s.body(I):ls(),q=r("div",{class:T.main,onDblclick:as},[O,os]),cs={ref:n,id:d.wid,onVnodeMounted:N,onPointerdown:ts,class:m.value,style:g.value},is=Kn(w.resizeMode,d.resizestart);let H=X("div",cs,[q,is]);if(w.mask===!0){const an={zIndex:c.value};H=r("div",{class:T.mask,style:an},[H])}return w.teleport===!1?H:r(Cs,{to:w.teleport},Qn(H)?H:{default:()=>[H]})}}}),Bs='<svg width="64" height="64" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M590.265 511.987l305.521-305.468c21.617-21.589 21.617-56.636.027-78.252-21.616-21.617-56.663-21.617-78.279 0L512.012 433.735 206.544 128.213c-21.617-21.617-56.635-21.617-78.252 0-21.616 21.589-21.616 56.635-.027 78.252L433.76 511.987 128.211 817.482c-21.617 21.59-21.617 56.635 0 78.251 10.808 10.81 24.967 16.213 39.125 16.213 14.159 0 28.318-5.403 39.126-16.213l305.522-305.468L817.48 895.788C828.289 906.597 842.447 912 856.606 912s28.317-5.403 39.125-16.212c21.618-21.59 21.618-56.636.028-78.252L590.265 511.987z"/></svg>',As='<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5228" width="64" height="64"><path d="M97.74775349 97.74775349h828.50449302v828.50449302H97.74775349V97.74775349z m103.56306133 103.56306133v621.37837036h621.37837036V201.31081482H201.31081482z" fill="currentColor"></path></svg>',Ds='<svg width="64" height="64" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path d="M38.794 124.791v778.495h946.412V124.791H38.794zm896.678 728.033H89.292v-460.9h846.18v460.9z"/></svg>',qs='<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="64" height="64"><path d="M738.793 681.382v-48.331l88.242-88.243a298.676 298.676 0 00156.712-83.482 38.836 38.836 0 000-54.923l-366.15-366.15a38.836 38.836 0 00-54.923 0 298.52 298.52 0 00-83.519 156.749l-88.169 88.169h-48.332a411.145 411.145 0 00-292.59 121.232c-15.16 15.159-15.16 39.764 0 54.923L278.906 690.17 86.642 882.436a38.836 38.836 0 1054.922 54.922l192.23-192.229 228.844 228.845a38.836 38.836 0 0054.922 0 411.042 411.042 0 00121.233-292.592zM134.02 435.44a333.473 333.473 0 01208.56-72.571l64.406.037a38.836 38.836 0 0027.461-11.351L544.292 241.71a38.68 38.68 0 0011.351-27.462 180.096 180.096 0 0136.798-89.01L898.8 431.593a180.925 180.925 0 01-89.12 36.835 38.836 38.836 0 00-27.462 11.35L672.373 589.626c-7.287 7.286-11.387 17.173-11.35 27.461l.036 64.406a333.318 333.318 0 01-72.608 208.596L134.021 435.44z"/></svg>',Hs='<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="64" height="64"><path d="M845.40952426 212.52063539H65.21904746v702.17142826h780.1904768V212.52063539z m-702.17142933 624.1523808V290.53968285h624.1523808v546.13333334H143.23809493z" fill="currentColor"></path><path d="M981.53650809 76.3936505H201.34603129v78.01904746h702.17142933v624.15238187h78.01904747V76.3936505z" fill="currentColor"></path></svg>';function st(){return{IconClose:Bs,IconMax:As,IconPin:qs,IconWindow:Ds,IconRestore:Hs}}function nt(t){return typeof t=="function"||Object.prototype.toString.call(t)==="[object Object]"&&!ns(t)}function tt(t){const s=t.options.icon;return typeof s=="string"?r("i",{class:[T.logo,"icon",s]},null):ns(s)?s:typeof s=="function"?s(t):r("i",{class:T.logo,innerHTML:Ds},null)}const rs=S({name:"SimpleWindow",props:{abstractWindow:{type:Object,required:!0}},setup(t){const s=t.abstractWindow,n={header(){const a=s.useMenus();return r("div",{class:T.header},[tt(s),r("div",{class:T.title},[s.options.title??"新窗口"]),r("div",{class:T.menus,onMousedown:bn},[a.value.map(e=>Ys(s,e))])])},body(){const a=s.options;return r("div",{class:[T.body,D.BODY,a.bodyClassName]},[r(Ns,{body:s.body,abstractWindow:t.abstractWindow,key:s.wid},null)])}};return function(){return r(Q,{abstractWindow:t.abstractWindow},nt(n)?n:{default:()=>[n]})}}}),Fs=Object.freeze({SIMPLE_WINDOW:rs.name,BLANK_WINDOW:Q.name});function Vs(t){return t==Q.name?Q:rs}function $s(t){if(t.key=="Escape")return Zs({pressEsc:!0,forced:!1})}function at(){f.isMounted=!0}function Xs(){f.isMounted=!1,f.topWindow=null,f.ids.value=[],f.stack.clear()}function Gs(){return f.zIndex}function Us(){return f.zIndex+=1}function et(){const t=f.topWindow;return t?t.state.zIndex:1}function lt(){return f.topWindow}function ot(t,s){f.stack.set(t,s)}function ct(t){if(console.log("[xWindow]: remove window",t),!f.stack.has(t)||(f.stack.delete(t),!f.isMounted))return;const s=f.ids.value.indexOf(t);if(s<0)return;f.ids.value.splice(s,1)}function Zs(t){if(f.stack.size==0||f.topWindow==null)return;const s=f.topWindow;(t==null?void 0:t.pressEsc)===!0&&s.options.closeOnPressEsc!==!0||f.topWindow.cancel(t==null?void 0:t.forced)}function it(t){const s=document.createDocumentFragment(),n=Vs(t.type),a=X(n,{abstractWindow:t});a.appContext=f.appContext,Ts(a,s),document.body.appendChild(s),t.on("beforeDestroy",()=>{Ts(null,s)})}function pt(t){const s=ws.create(t);return f.isMounted?(f.ids.value.push(s.id),f.stack.set(s.id,s),s):(it(s),s)}function rt(t){return f.stack.get(t)}function ut(){return f.ids}function _s(t){if(f.topWindow=t,t!=null){for(const s of f.stack.values()){const n=s.state;n!=null&&(n.focused=s===t)}t.state!=null&&t.state.zIndex<Gs()&&(t.state.zIndex=Us())}}function dt(t){const s=f.stack.get(t);_s(s)}function ht(){const t=jt();_s(t)}function jt(){if(f.stack.size==0)return;let t;for(const s of f.stack.values())if(!(s.state==null||s.state.visible!==!0)){if(t==null){t=s;continue}t.state.zIndex<s.state.zIndex&&(t=s)}return t}function gt(){return f.previewState}function mt(){return f.stack.size}function ft(){window.addEventListener("keydown",$s,!0)}function wt(t){f.appContext=t._context}function bt(){f.appContext=null,Xs(),window.removeEventListener("keydown",$s,!0)}function yt(){return{closeTopWindow:Zs,getTopWindow:lt,getTopZIndex:Us,getWindowCount:mt,getZIndex:Gs,setFocusedWindow:_s,cleanup:bt}}class _t{constructor(s,n){u(this,"moved",!1);u(this,"originalEvent");u(this,"target");u(this,"deltaX");u(this,"deltaY");u(this,"initialX");u(this,"initialY");u(this,"left",0);u(this,"top",0);u(this,"prevClientX");u(this,"prevClientY");const a=s.getBoundingClientRect();this.originalEvent=n,this.target=s,this.deltaX=Math.round(a.left-n.clientX),this.deltaY=Math.round(a.top-n.clientY),this.initialX=n.clientX,this.initialY=n.clientY,this.prevClientX=n.clientX,this.prevClientY=n.clientY}preventDragEvent(s){return!(this.moved||Math.abs(s.clientX-this.initialX)>4||Math.abs(s.clientY-this.initialY)>4)}createEvent(s,n){return new ys(s,n,this)}}class vt{constructor(s){u(this,"window");u(this,"context");u(this,"onDragging");u(this,"onDragend");this.window=s}static isConflict(s,n){const a=s.getBoundingClientRect(),e=n.getBoundingClientRect();return!(a.top>e.bottom||a.right<e.left||a.bottom<e.top||a.left>e.right)}static findElementsFromPoint(s,n,a,e){return typeof document.elementsFromPoint!="function"?[]:document.elementsFromPoint(s,n).filter(c=>e!=null&&!e.contains(c)?!1:typeof a=="string"?c.matches(a):!1)}dragstart(s){if(s.button!==0)return;const n=s.target;if(n instanceof Element&&n.closest("."+D.MENU))return;const a=this.window.getElement();if(a==null)return;const e=a.getBoundingClientRect();s.clientY-e.top>this.window.allowDragArea||(s.preventDefault(),s.stopPropagation(),this.context=new _t(a,s),this.context.left=this.window.state.offsetLeft,this.context.top=this.window.state.offsetTop,this.onDragging=this.dragging.bind(this),this.onDragend=this.dragend.bind(this),window.addEventListener("pointermove",this.onDragging),window.addEventListener("pointerup",this.onDragend))}dragging(s){var o;if(this.context==null)return;const n=this.context;if(!n.moved){if(this.window.dispatch(this.context.createEvent("dragStart",this.window)).defaultPrevented)return this.cleanup();const g=(o=this.window.component)==null?void 0:o.useCssClass();g!=null&&g.dragging&&n.target.classList.add(g.dragging),n.target.setPointerCapture(s.pointerId),n.moved=!0}if(n.preventDragEvent(s))return;s.preventDefault(),s.stopPropagation(),n.originalEvent=s,n.left=s.clientX+n.deltaX,n.top=s.clientY+n.deltaY,n.prevClientX=s.clientX,n.prevClientY=s.clientY;const a=n.target;a.style.left=n.left+"px",a.style.top=n.top+"px";const e=this.context.createEvent("dragging",this.window);this.window.dispatch(e)}dragend(s){if(this.context==null||!this.context.moved)return this.cleanup();s.preventDefault(),s.stopPropagation();const n=this.context;n.originalEvent=s,n.target.releasePointerCapture(s.pointerId);const a=n.createEvent("dragEnd",this.window);this.window.dispatch(a),this.window.state.offsetTop=n.top,this.window.state.offsetLeft=n.left,this.cleanup()}cleanup(){var n,a;const s=(n=this.window.component)==null?void 0:n.useCssClass();s!=null&&s.dragging&&((a=this.context)==null||a.target.classList.remove(s.dragging)),this.onDragging&&window.removeEventListener("pointermove",this.onDragging),this.onDragend&&window.removeEventListener("pointerup",this.onDragend),this.onDragging=void 0,this.onDragend=void 0,this.context=void 0}}const J=class J extends ps{constructor(n){super();u(this,"CREATE_RESOLVE");u(this,"CREATE_REJECT");u(this,"id");u(this,"type");u(this,"options");u(this,"body");u(this,"state");u(this,"created",!1);u(this,"destroyed",!1);u(this,"component");u(this,"draggable");u(this,"resizable");u(this,"handles",{});u(this,"dragstart");u(this,"resizestart");this.type=n.type??Ps.SIMPLE_WINDOW,this.options=this.createOptions(n),this.body=n.body,Reflect.defineProperty(this,"id",{enumerable:!0,configurable:!1,writable:!1,value:J.seed++}),this.initDraggable(),this.initResizable(),this.initHooks()}static create(n){return n instanceof J?n:new J(n)}get wid(){return"window--"+this.id}get isReady(){return this.created===!0}get allowDrag(){const n=this.options.draggable;return n===!1?!1:typeof n=="number"?n>0:!0}get allowDragArea(){const n=this.options.draggable;return typeof n=="number"&&n>0?n:Y.draggaleHeight}get isMaximize(){var n;return((n=this.state)==null?void 0:n.splitMode)===p.MAXIMIZE}createOptions(n){return{title:n.title??"未命名的窗口",icon:n.icon,className:n.className,bodyClassName:n.bodyClassName,width:n.width??"640px",minWidth:n.minWidth??360,maxWidth:n.maxWidth,height:n.height,minHeight:n.minHeight??32,maxHeight:n.maxHeight,top:n.top,left:n.left,zIndex:n.zIndex,maximize:n.maximize===!0,teleport:n.teleport??"body",draggable:n.draggable==null?!0:n.draggable,resizeMode:n.resizeMode??L.RESIZE,closeable:n.closeable!==!1,mask:n.mask===!0,pinnable:n.pinnable!==!1,displayAfterCreate:n.displayAfterCreate!==!1,destroyAfterClose:n.destroyAfterClose!==!1,closeOnPressEsc:n.closeOnPressEsc!==!1}}createEvent(n,a){return new ys(n,this,a)}initDraggable(){this.draggable=new vt(this),this.dragstart=this.draggable.dragstart.bind(this.draggable)}initResizable(){this.resizable=new hs(this),this.resizestart=this.resizable.resizestart.bind(this.resizable)}initHooks(){this.once("created",()=>{this.created=!0,typeof this.CREATE_RESOLVE=="function"&&this.CREATE_RESOLVE(),delete this.CREATE_REJECT,delete this.CREATE_RESOLVE})}ready(){return this.created===!0?Promise.resolve():new Promise((n,a)=>{this.CREATE_RESOLVE=n,this.CREATE_REJECT=a})}show(){this.state==null||this.dispatch(this.createEvent("beforeShow")).defaultPrevented||(this.state.visible=!0)}close(n=!1){if(this.state==null||this.options.closeable===!1&&n!==!0)return!1;const a=this.dispatch(this.createEvent("beforeClose"));return n!==!0&&a.defaultPrevented?!1:(this.state.visible=!1,this.dispatch(this.createEvent("close")),this.state.focused&&setTimeout(ht),!this.destroyed&&this.options.destroyAfterClose!==!1&&this.destroy(),!0)}cleanup(){super.cleanup(),this.dragstart=void 0,this.resizestart=void 0,this.component=void 0,this.state=void 0,this.handles={}}destroy(){var n;this.destroyed=!0,((n=this.state)==null?void 0:n.visible)===!0&&this.close(),this.dispatch(this.createEvent("beforeDestroy")),ct(this.id),setTimeout(()=>this.cleanup(),100)}getElement(){var n;return(n=this.component)==null?void 0:n.getElement()}useMenus(){return this.component.useMenus()}focus(){this.state==null||this.state.focused||dt(this.id)}startTransition(){const n=document.documentElement,a=function(e){e.target.matches("."+D.WINDOW)&&(n.classList.remove(D.TRANSITION),n.removeEventListener("transitionend",a))};n.classList.add(D.TRANSITION),n.addEventListener("transitionend",a)}requestMaximize(){const n=this.state;n==null||this.options.resizeMode!==L.RESIZE||(n.splitMode=p.MAXIMIZE,this.startTransition(),this.dispatch(this.createEvent("maximizeChange")))}exitMaximize(){const n=this.state;n==null||this.options.resizeMode!==L.RESIZE||(n.splitMode=p.NONE,this.startTransition(),this.dispatch(this.createEvent("maximizeChange")))}toggleMaximize(){const n=this.state;n==null||this.options.resizeMode!==L.RESIZE||(n.splitMode===p.MAXIMIZE?this.exitMaximize():this.requestMaximize())}pin(){const n=this.state;n!=null&&(n.pinned=!0)}unpin(){const n=this.state;n!=null&&(n.pinned=!1)}togglePin(){const n=this.state;n!=null&&(n.pinned?this.unpin():this.pin())}useHandle(n,a){this.handles[n]=a}async callHandle(n){const a=this.handles[n];if(typeof a=="function")return await a()}confirm(){return this.callHandle("confirm").then(n=>{this.dispatch(this.createEvent("confirm",n)),this.close(!0)})}cancel(n=!0){return this.callHandle("cancel").then(a=>{const e=this.close(n);console.log(e),e&&this.dispatch(this.createEvent("cancel",a))})}};u(J,"seed",1e3);let ws=J;const ks=1e3,Y={},f=Tt();function xt(t){return typeof t!="number"||!Number.isFinite(t)?ks:Math.floor(t)}function Et(t){Y.zIndex=xt(t==null?void 0:t.zIndex),Y.draggaleHeight=(t==null?void 0:t.draggaleHeight)??32,Y.size=(t==null?void 0:t.size)??{},f.zIndex=Y.zIndex}function js(){return pn(Ls)}function Tt(){return{appContext:null,isMounted:!1,zIndex:1e3,stack:new Map,ids:K([]),topWindow:null,previewState:us({mode:p.NONE,width:0,height:0})}}function Ys(t,s){var g;const n=t.state,a=((g=t.component)==null?void 0:g.useCssClass())??{};function e(){t.cancel()}function o(){t.togglePin()}function c(m){m.preventDefault(),t.toggleMaximize()}switch(s){case B.CLOSE:return r("button",{onClick:e,type:"button",innerHTML:Bs,class:a.closeMenu,title:"关闭"},null);case B.PIN:case B.UNPIN:const m=n.pinned?"取消固定":"固定",x=n.pinned?a.pinMenu:a.menu;return r("button",{onClick:o,type:"button",innerHTML:qs,class:x,title:m},null);case B.MAXIMIZE:case B.RESTORE:const I=n.splitMode==p.MAXIMIZE?Hs:As,W=n.splitMode==p.MAXIMIZE?"还原":"最大化";return r("button",{onClick:c,type:"button",innerHTML:I,class:a.menu,title:W},null)}return null}const Wt="Ycke6mYQ",Mt="esgrGyhH",kt="UkryRM5g",It="U5LZXLJZ",Ot="_2rffDKab",St="vcVMeNrL",Ct="koc15mYi",zt="_4VxfFKcG",V={splitWindowMask:Wt,maximize:Mt,splitLeft:kt,splitRight:It,splitTopLeft:Ot,splitTopRight:St,splitBottomLeft:Ct,splitBottomRight:zt};function Rt(t){return typeof t=="function"||Object.prototype.toString.call(t)==="[object Object]"&&!ns(t)}const Lt={[p.MAXIMIZE]:V.maximize,[p.LEFT]:V.splitLeft,[p.RIGHT]:V.splitRight,[p.TOP_LEFT]:V.splitTopLeft,[p.TOP_RIGHT]:V.splitTopRight,[p.BOTTOM_LEFT]:V.splitBottomLeft,[p.BOTTOM_RIGHT]:V.splitBottomRight},Pt={ArrowUp:{[p.BOTTOM_LEFT]:p.LEFT,[p.BOTTOM_RIGHT]:p.RIGHT,[p.LEFT]:p.TOP_LEFT,[p.RIGHT]:p.TOP_RIGHT,fallback:p.MAXIMIZE},ArrowDown:{[p.TOP_LEFT]:p.LEFT,[p.TOP_RIGHT]:p.RIGHT,[p.LEFT]:p.BOTTOM_LEFT,[p.RIGHT]:p.BOTTOM_RIGHT,fallback:p.NONE},ArrowLeft:{[p.TOP_RIGHT]:p.TOP_LEFT,[p.TOP_LEFT]:p.TOP_RIGHT,[p.BOTTOM_RIGHT]:p.BOTTOM_LEFT,[p.BOTTOM_LEFT]:p.BOTTOM_RIGHT,fallback:p.LEFT},ArrowRight:{[p.TOP_LEFT]:p.TOP_RIGHT,[p.TOP_RIGHT]:p.TOP_LEFT,[p.BOTTOM_LEFT]:p.BOTTOM_RIGHT,[p.BOTTOM_RIGHT]:p.BOTTOM_LEFT,fallback:p.RIGHT}},Is=S({name:"WindowManager",setup(){const t=ut(),s=gt();function n(o){const c=o.key;o.ctrlKey&&c in Pt}at(),window.addEventListener("keydown",n,!0),zs(()=>{Xs(),window.removeEventListener("keydown",n,!0)});const a=U(()=>{const o=[V.splitWindowMask],c=Lt[s.mode];return c!=null&&o.push(c),o});function e(){let o=null;if(s.mode!=p.NONE){const g={zIndex:et()+1,width:s.width?s.width-20+"px":void 0};o=r("div",{class:a.value,style:g},null)}return r(Cs,{to:"body"},{default:()=>[r(rn,{name:"fade"},Rt(o)?o:{default:()=>[o]})]})}return function(){return[...t.value.map(c=>{const g=rt(c);if(g==null)return null;const m=Vs(g.type);return X(m,{abstractWindow:g,key:g.wid})}),e()]}}});function Nt(t){if(t.length==1){const s=t[0];return s==null?null:typeof s=="object"?{...s}:null}if(t.length==2){const[s,n]=t;if(typeof s=="string"&&n!=null)return{title:s,body:n}}if(t.length==3){const[s,n,a]=t;if(typeof s=="string"&&n!=null)return{...a,title:s,body:n}}return null}function vs(t){const s=Nt(t)??{},n=typeof s.size=="string"?Reflect.get(Y.size,s.size):null;return n!=null&&(s.width=n.width,s.height=n.height,s.top=n.top,s.left=n.left),s}function G(...t){const s=vs(t)??{};return xs(s)}function Js(...t){const s=vs(t)??{};return s.type=Fs.BLANK_WINDOW,xs(s)}function Bt(...t){const s=vs(t)??{};return s.type=Fs.SIMPLE_WINDOW,xs(s)}function xs(t){const s=pt(t);return s.ready().then(()=>{t.displayAfterCreate!==!1&&s.show()}),s}const Ks=Object.freeze({renderMenu:Ys});function At(t,s){t.component(rs.name,rs),t.component(Q.name,Q),t.component(Is.name,Is),Et(s),ft(),wt(t)}const Dt=fn,qt={install:At,version:Dt},Ht=`<svg viewBox="0 0 1024 1024" version="1.1"
...
</svg>`,Ft=`<svg viewBox="0 0 1024 1024" version="1.1"
...
</svg>`,Vt=S({__name:"HelloWorld",setup(t){function s(){G("示例窗口",r("div",{class:"example-body"},[y("Hello, xWindow!")]))}return(n,a)=>(M(),k("button",{type:"button",onClick:s,class:"btn btn-small"},"尝试一下"))}}),$t={class:"example-body"},Xt=S({__name:"WinBody",props:{text:String},setup(t){return(s,n)=>(M(),k("div",$t,P(t.text),1))}}),Gt=S({__name:"FunctionBased",setup(t){function s(){G("窗口1",r("div",{class:"example-body"},[y("这段文本是使用JSX创建的。")]))}function n(){G("窗口2","这段本文可以直接展示。")}function a(){G("窗口3",X("div",{className:"example-body"},"这段文本是通过Vue提供的渲染函数创建的。"))}function e(){G("窗口4",()=>r("div",{class:"example-body"},[y("这段文本是通过返回VNode节点的函数创建的。")]))}function o(){G("窗口5",r(Xt,{text:"这段文本通过组件创建的。"},null))}return(c,g)=>(M(),k($,null,[l("button",{class:"btn",type:"button",onClick:s},"JSX"),l("button",{class:"btn",type:"button",onClick:n},"文本"),l("button",{class:"btn",type:"button",onClick:a},"渲染函数"),l("button",{class:"btn",type:"button",onClick:e},"函数"),l("button",{class:"btn",type:"button",onClick:o},"组件")],64))}}),Ut=l("header",null,"窗口尺寸：",-1),Zt=l("header",null,"窗口位置：",-1),Yt=l("header",null,"窗口特性：",-1),Jt=["onUpdate:modelValue"],Kt=l("header",null,"调整模式：",-1),Qt=["value"],sa=l("span",null,"允许调整窗口大小，允许最大化（默认）",-1),na=["value"],ta=l("span",null,"只允许调整窗口大小",-1),aa=["value"],ea=l("span",null,"禁止",-1),Os="__WIN_EVENTS__",la=S({__name:"Example",setup(t){const s=Rs("classes"),n=yt(),a=[{label:"可拖拽",prop:"draggable",value:!0},{label:"可关闭",prop:"closeable",value:!0},{label:"可置顶",prop:"pinnable",value:!0},{label:"最大化",prop:"maximize",value:!1},{label:"遮罩层",prop:"mask",value:!1},{label:"按ESC键关闭",prop:"closeOnPressEsc",value:!0}],e={width:"800px",height:"600px",left:"calc(50vw - 400px)",top:"12vh",resizeMode:L.RESIZE},o=a.reduce((W,i)=>(W[i.prop]=i.value,W),{...e}),c=us(o),g=S({props:{params:{type:Object,required:!0}},setup(W){const i=js(),h=Reflect.get(i,Os);function v(){i==null||i.close(!0)}return function(){var N,ts,as,es,ls,d;const j=c.closeable?null:r("button",{type:"button",class:"btn btn-small",onClick:v},[y("关闭窗口")]),z=a.map(w=>r("p",null,[w.label,y(": "),JSON.stringify(W.params[w.prop])])),C=h.value.map(w=>r("p",null,[w]));return r("div",{class:s.exampleBody},[r("div",{class:s.params},[r("div",{class:s.panel},[r("h4",null,[y("初始参数：")]),z]),r("div",{class:s.panel},[r("h4",null,[y("窗口状态：")]),r("div",{class:s.infos},[r("p",null,[y("id: "),i==null?void 0:i.wid]),r("p",null,[y("focused: "),JSON.stringify((N=i==null?void 0:i.state)==null?void 0:N.focused)]),r("p",null,[y("left: "),(ts=i==null?void 0:i.state)==null?void 0:ts.offsetLeft,y("px")]),r("p",null,[y("top: "),(as=i==null?void 0:i.state)==null?void 0:as.offsetTop,y("px")]),r("p",null,[y("width: "),(es=i==null?void 0:i.state)==null?void 0:es.offsetWidth,y("px")]),r("p",null,[y("height: "),(ls=i==null?void 0:i.state)==null?void 0:ls.offsetHeight,y("px")]),r("p",null,[y("z-index: "),JSON.stringify((d=i==null?void 0:i.state)==null?void 0:d.zIndex)])])])]),r("div",{class:s.eventHeader},[r("strong",null,[y("窗口事件")]),j]),r("div",{class:s.events},[C])])}}});function m(){const W=new Date,i=W.getMinutes().toString().padStart(2,"0"),h=W.getSeconds().toString().padStart(2,"0"),v=W.getMilliseconds().toString().padStart(4,"0");return`${i}:${h}.${v}`}function x(){const W=n.getWindowCount(),i={...c,bodyClassName:s.winBody},h=K([]),v=Bt("窗口"+W,r(g,{params:i},null),i);v.on("created",()=>{h.value.unshift(`[${m()}]: call created event.`)}),v.on("beforeShow",j=>{h.value.unshift(`[${m()}]: call beforeShow event.`)}),v.on("show",j=>{h.value.unshift(`[${m()}]: call show event.`)}),v.on("close",()=>{h.value.unshift(`[${m()}]: call close event.`)}),v.on("beforeDestroy",()=>{h.value.unshift(`[${m()}]: call beforeDestroy event.`)}),v.on("dragStart",j=>{h.value.unshift(`[${m()}]: call dragStart event.`)}),v.on("dragEnd",j=>{h.value.unshift(`[${m()}]: call dragEnd event.`)}),v.on("resizeStart",j=>{h.value.unshift(`[${m()}]: call resizeStart event.`)}),v.on("resizeEnd",j=>{h.value.unshift(`[${m()}]: call resizeEnd event. `)}),v.on("maximizeChange",j=>{h.value.unshift(`[${m()}]: call maximizeChange event. isMaximize: ${v.isMaximize}`)}),Reflect.set(v,Os,h)}function I(W,i){c.width=W+"px",c.height=i+"px"}return(W,i)=>(M(),k($,null,[l("section",{class:_(E(s).row)},[Ut,l("div",{class:_(E(s).content)},[l("label",null,[y("宽度："),A(l("input",{type:"text","onUpdate:modelValue":i[0]||(i[0]=h=>c.width=h),placeholder:"参照CSS的width属性"},null,512),[[ss,c.width]])]),l("label",null,[y("高度："),A(l("input",{type:"text","onUpdate:modelValue":i[1]||(i[1]=h=>c.height=h),placeholder:"参照CSS的height属性"},null,512),[[ss,c.height]])]),l("button",{type:"button",class:"btn btn-mini",onClick:i[2]||(i[2]=h=>I(800,600))},"800px*600px"),l("button",{type:"button",class:"btn btn-mini",onClick:i[3]||(i[3]=h=>I(390,840))},"390px*840px")],2)],2),l("section",{class:_(E(s).row)},[Zt,l("div",{class:_(E(s).content)},[l("label",null,[y("左侧："),A(l("input",{type:"text","onUpdate:modelValue":i[4]||(i[4]=h=>c.left=h),placeholder:"参照CSS中left属性"},null,512),[[ss,c.left]])]),l("label",null,[y("上侧："),A(l("input",{type:"text","onUpdate:modelValue":i[5]||(i[5]=h=>c.top=h),placeholder:"参照CSS中top属性"},null,512),[[ss,c.top]])])],2)],2),l("section",{class:_(E(s).row)},[Yt,l("div",{class:_(E(s).content)},[(M(),k($,null,ds(a,h=>l("label",{key:h.prop},[A(l("input",{type:"checkbox","onUpdate:modelValue":v=>c[h.prop]=v},null,8,Jt),[[un,c[h.prop]]]),l("span",null,P(h.label),1)])),64))],2)],2),l("section",{class:_(E(s).row)},[Kt,l("div",{class:_(E(s).content)},[l("label",null,[A(l("input",{type:"radio",name:"resizeMode",value:E(L).RESIZE,"onUpdate:modelValue":i[6]||(i[6]=h=>c.resizeMode=h)},null,8,Qt),[[gs,c.resizeMode]]),sa]),l("label",null,[A(l("input",{type:"radio",name:"resizeMode",value:E(L).RESIZE_ONLY,"onUpdate:modelValue":i[7]||(i[7]=h=>c.resizeMode=h)},null,8,na),[[gs,c.resizeMode]]),ta]),l("label",null,[A(l("input",{type:"radio",name:"resizeMode",value:E(L).DISABLED,"onUpdate:modelValue":i[8]||(i[8]=h=>c.resizeMode=h)},null,8,aa),[[gs,c.resizeMode]]),ea])],2)],2),l("button",{onClick:x,class:"btn"},"创建窗口")],64))}}),oa="Zj7DQ8mX",ca="hZ15PjHU",ia="tbtACTrZ",pa="_3N6wV7j6",ra="oTAjhRfW",ua="CFWamGXp",da="cqiqLgbF",ha="T9Y6Pp6o",ja="TUAWahwn",ga={winBody:oa,exampleBody:ca,row:ia,content:pa,events:ra,params:ua,panel:da,infos:ha,eventHeader:ja},Es=(t,s)=>{const n=t.__vccOpts||t;for(const[a,e]of s)n[a]=e;return n},ma={classes:ga},fa=Es(la,[["__cssModules",ma]]),wa={class:"approval-form"},ba={key:0,class:"approval-form-message"},Qs=S({__name:"UseApproval",setup(t){const s=js(),n=us({value:"",fail:!1});return s==null||s.useHandle("confirm",()=>n.value?n.value:(n.fail=!0,Promise.reject("验证未通过"))),(a,e)=>(M(),k("div",wa,[A(l("textarea",{type:"text","onUpdate:modelValue":e[0]||(e[0]=o=>n.value=o),placeholder:"请输入",ref:"inputRef",autofocus:""},null,512),[[ss,n.value]]),n.fail?(M(),k("div",ba,"请输入审批意见")):bs("",!0)]))}}),ya={key:0,class:"example-modal"},_a={class:"example-modal-header"},va={class:"example-modal-title"},xa={class:"example-modal-menus"},Ea={class:"example-modal-body"},Ta={class:"example-modal-footer"},sn=S({__name:"Modal",setup(t){const s=js(),n=()=>s==null?void 0:s.cancel().catch(e=>console.error(e)),a=()=>s==null?void 0:s.confirm().catch(e=>console.error(e));return(e,o)=>E(s)?(M(),k("div",ya,[l("div",_a,[l("div",va,P(E(s).options.title),1),l("div",xa,[fs(e.$slots,"menus",{abstractWindow:E(s)})])]),l("div",Ea,[fs(e.$slots,"default",{abstractWindow:E(s)})]),l("div",Ta,[l("button",{type:"button",class:"btn btn-small",onClick:o[0]||(o[0]=c=>n())},"取消"),l("button",{type:"button",class:"btn btn-small",onClick:o[1]||(o[1]=c=>a())},"确定")])])):bs("",!0)}}),Wa=Object.freeze(Object.defineProperty({__proto__:null,Example:fa,FunctionBased:Gt,HelloWorld:Vt,Modal:sn,UseApproval:Qs},Symbol.toStringTag,{value:"Module"})),Ma=["innerHTML"],ka=["onClick"],Ia=S({__name:"index",props:{menuClass:{type:String,default:null}},setup(t){const s=[{name:"皓白",primaryColor:"#ebeef0",textColor:"#000"},{name:"天缥",primaryColor:"#d5ebe1",textColor:"#000",navTextSecondaryColor:"#333"},{name:"海天霞",primaryColor:"#f3a694",textColor:"#000",navTextSecondaryColor:"#333"},{name:"暮山紫",primaryColor:"#a4abd6",textColor:"#000",navTextSecondaryColor:"#333"}].map(e=>({...e,background:e.primaryColor}));function n(e){return{"--xwindow-color-primary":e.primaryColor,"--xwindow-header-color":e.textColor,"--nav-text-secondary-color":e.navTextSecondaryColor}}function a(e){const o=document.documentElement,c=n(e);for(const g in c){const m=c[g];m==null?o.style.removeProperty(g):o.style.setProperty(g,m)}}return(e,o)=>(M(),k("div",{class:_(e.classes.picker)},[l("button",{type:"button",class:_(t.menuClass),innerHTML:E(Ht),title:"主题"},null,10,Ma),l("ul",{class:_(e.classes.panel)},[(M(!0),k($,null,ds(E(s),c=>(M(),k("li",{key:c.id,onClick:g=>a(c),style:Ws({"--theme-primary-color":c.primaryColor})},[l("span",{class:_(e.classes.badge),style:Ws({background:c.background})},null,6),l("strong",null,P(c.name),1)],12,ka))),128))],2)],2))}}),Oa="JJwYh7Hb",Sa="nGuXZaqY",Ca="WnLJWuwF",za={picker:Oa,panel:Sa,badge:Ca},Ra={classes:za},La=Es(Ia,[["__cssModules",Ra]]),Pa=`<p>xWindow是仿Windows窗口的组件库，目标是提供一套快捷的API来创建和使用窗口。本文档的就是基于xWindow创建了一个窗口，你可以拖动文档查看效果。</p>
...
<p>xWindow不需要事先在业务组件中声明，你可以在任何需要的地方直接创建一个窗口。 <HelloWorld/></p>`,Na=`<h2 class="head-anchor article-sticky-heading" id="安装">安装</h2>
...
<p>最终效果如下：
<span class="quickstart-function-based"><FunctionBased/></span></p>`,Ba=`<h2 class="head-anchor article-sticky-heading" id="模态框">模态框</h2>
...
<p>效果如下：<UseExample/></p>`,Aa="<Example/>",Da=`<h2 class="head-anchor article-sticky-heading" id="函数式API">函数式API</h2>
<hr>
...
</code><button type="button" class="doc-copy-btn" title="复制"/></pre>`,qa=l("colgroup",null,[l("col",{width:"160"}),l("col",{width:"150"})],-1),Ha=l("thead",null,[l("tr",null,[l("th",null,"事件"),l("th",null,"默认行为"),l("th",null,"说明")])],-1),Fa={__name:"Events",setup(t){const s=[{type:"created",desc:"窗口组件创建时触发"},{type:"beforeShow",prevent:"可阻止窗口显示",desc:"窗口显示前触发"},{type:"show",desc:"窗口显示后触发"},{type:"beforeClose",prevent:"可阻止窗口关闭",desc:"窗口关闭前触发"},{type:"close",desc:"窗口关闭时触发"},{type:"beforeDestroy",desc:"窗口销毁前触发"},{type:"dragStart",prevent:"可阻止窗口拖动",desc:"窗口开始拖动时触发"},{type:"dragging",desc:"窗口拖动时触发"},{type:"dragEnd",desc:"窗口拖动结束时触发"},{type:"resizeStart",prevent:"可阻止窗口调整尺寸",desc:"窗口开始调整尺寸时触发"},{type:"resizing",desc:"窗口调整尺寸时触发"},{type:"resizeEnd",desc:"窗口结束调整尺寸时触发"},{type:"maximizeChange",desc:"窗口最大化状态改变时触发"},{type:"confirm",desc:"调用窗口的confirm方法后触发，可通过此事件返回窗体的内容"},{type:"cancel",desc:"调用窗口的cancel方法后触发"}];return(n,a)=>(M(),k("table",null,[qa,Ha,l("tbody",null,[(M(),k($,null,ds(s,e=>l("tr",{key:e.prop},[l("td",null,P(e.type),1),l("td",null,P(e.prevent??"--"),1),l("td",null,P(e.desc),1)])),64))])]))}};function Va(t){return typeof t=="function"||Object.prototype.toString.call(t)==="[object Object]"&&!ns(t)}function nn(t,s,n={}){n.height=n.height??"320px";const a={default(e){return typeof s=="function"?s(e.abstractWindow):s},menus(e){return e.abstractWindow.useMenus().value.map(c=>Ks.renderMenu(e.abstractWindow,c))}};return Js(t,r(sn,null,Va(a)?a:{default:()=>[a]}),n)}function $a(){return new Promise((t,s)=>{const n={mask:!0,resizeMode:L.DISABLED},a=nn("请输入审批意见",r(Qs,null,null),n);a.once("confirm",e=>t(e.detail)),a.once("cancel",e=>s(e.detail))})}const Xa={class:"approval-output"},Ga=l("strong",null,"操作结果：",-1),Ua=S({__name:"UseExample",setup(t){const s=K("");async function n(){const a=await $a().catch(e=>(console.log(e),null));if(a==null){s.value="取消操作";return}s.value=a}return(a,e)=>(M(),k($,null,[l("button",{type:"button",class:"btn btn-small",onClick:n},"审批"),l("div",Xa,[s.value?(M(),k($,{key:0},[Ga,l("pre",null,P(s.value),1)],64)):bs("",!0)])],64))}}),Za=S({__name:"UseModal",setup(t){function s(){nn("窗口1",r("div",null,[y("内容")]))}return(n,a)=>(M(),k("button",{type:"button",class:"btn btn-small",onClick:s},"打开模态框"))}}),Ya=Object.freeze(Object.defineProperty({__proto__:null,Events:Fa,UseExample:Ua,UseModal:Za},Symbol.toStringTag,{value:"Module"})),Ja=[{name:"简介",content:Pa},{name:"快速开始",content:Na},{name:"进阶应用",content:Ba},{name:"API",content:Da},{name:"示例",content:Aa}],Ss=Ja.map((t,s)=>({id:s,...t})),Ka=["innerHTML"],Qa=l("span",null,"xWindow",-1),se=["onClick"],ne=l("span",null,"Copyright © 2023-present dongls",-1),te=[ne],ae=S({__name:"docs",setup(t){const s=Rs("classes"),n="09291232",a="0.1.4",e=0,o=js(),c=st(),g=K(Ss[e]),m=K();function x(j){j.stopPropagation()}function I(){var C;if(o==null)return null;const j=o.useMenus(),z=((C=o.component)==null?void 0:C.useCssClass())??{};return r("div",{class:s.menus,onMousedown:x},[r(La,{menuClass:z.menu},null),r("button",{title:"GitHub",class:z.menu,onClick:W,innerHTML:Ft},null),j==null?void 0:j.value.map(N=>Ks.renderMenu(o,N))])}function W(){window.open("https://github.com/dongls/xWindow")}function i(){const j=g.value.content,z={...Wa,...Ya};return X("article",{class:"article",key:g.value.id},X({template:j,components:z}))}async function h(j){g.value=j,await ms(),m.value&&(m.value.scrollTop=0)}function v(j){const z=j.target.closest("pre.hljs");if(z==null)return;const C=z.querySelector(":scope > code.hljs-code");if(C==null)return;const N=C.textContent;N!=null&&navigator.clipboard.writeText(N)}return(j,z)=>(M(),k("div",{class:_(j.classes.app)},[l("aside",{class:_(j.classes.aside)},[l("div",{class:_(j.classes.leftHeader)},[l("i",{class:_(j.classes.logo),innerHTML:E(c).IconWindow},null,10,Ka),l("h3",{class:_(j.classes.title)},[Qa,l("small",null,"v"+P(E(a))+"_"+P(E(n)),1)],2)],2),l("nav",{class:_([j.classes.navs,"is-scroll"])},[(M(!0),k($,null,ds(E(Ss),C=>(M(),k("div",{onClick:N=>h(C),class:_([j.classes.nav,C.id==g.value.id?j.classes.activeNav:null])},P(C.name),11,se))),256))],2),l("div",{class:_(j.classes.copyright)},te,2)],2),l("main",{class:_(j.classes.main)},[l("div",{class:_(j.classes.rightHeader)},[r(I)],2),l("div",{class:_(j.classes.scroll),ref_key:"scroll",ref:m,onClick:dn(v,["stop"])},[r(i,{class:_(j.classes.content)},null,8,["class"]),fs(j.$slots,"default",{ref:"tref"})],2)],2)],2))}}),ee="Cs1eNLRW",le="mkQVrkEV",oe="fxJePVAw mkQVrkEV",ce="gW5FCXxJ mkQVrkEV",ie="UCU4MEPE",pe="wascU8g5",re="QVKApkXV",ue="xQ7Xh7bM",de="LhDQ3ctB",he="_7RZWnCfQ",je="_95hpDEbG",ge="cXaxwh5B",me="_2dkZEz4e",fe="_6qjvpjzC",we="qSce7387",be={app:ee,header:le,leftHeader:oe,rightHeader:ce,menus:ie,aside:pe,navs:re,nav:ue,activeNav:de,main:he,content:je,scroll:ge,copyright:me,logo:fe,title:we},ye={classes:be},_e=Es(ae,[["__cssModules",ye]]),ve=S({__name:"App",setup(t){let s=null;function n(){s&&s.close(),s=null}return zs(n),hn(()=>{s=Js({closeable:!1,zIndex:999,width:"1280px",height:"900px",minHeight:640,body:r(_e,null,null),title:"",className:"xwindow-doc"})}),(a,e)=>{const o=gn("WindowManager");return M(),jn(o)}}}),tn=mn(ve);tn.use(qt);tn.mount("#app");
