var ln=Object.defineProperty;var en=(a,s,n)=>s in a?ln(a,s,{enumerable:!0,configurable:!0,writable:!0,value:n}):a[s]=n;var u=(a,s,n)=>(en(a,typeof s!="symbol"?s+"":s,n),n);import{d as O,c as U,h as X,s as on,r as us,a as K,p as cn,b as r,T as Ss,i as ns,n as ms,e as Ts,f as pn,o as zs,g as rn,j as M,k,l as y,t as P,m as e,F as $,u as Rs,q as _,v as E,w as A,x as ss,y as ds,z as un,A as gs,B as bs,C as fs,D as Ws,E as dn,G as hn,H as jn,I as gn,J as mn}from"./vendor-79HxGn9k.js";(function(){const s=document.createElement("link").relList;if(s&&s.supports&&s.supports("modulepreload"))return;for(const l of document.querySelectorAll('link[rel="modulepreload"]'))t(l);new MutationObserver(l=>{for(const o of l)if(o.type==="childList")for(const c of o.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&t(c)}).observe(document,{childList:!0,subtree:!0});function n(l){const o={};return l.integrity&&(o.integrity=l.integrity),l.referrerPolicy&&(o.referrerPolicy=l.referrerPolicy),l.crossOrigin==="use-credentials"?o.credentials="include":l.crossOrigin==="anonymous"?o.credentials="omit":o.credentials="same-origin",o}function t(l){if(l.ep)return;l.ep=!0;const o=n(l);fetch(l.href,o)}})();const fn="0.2.0",Ls=Symbol(),D=Object.freeze({WINDOW:"x-window",SIMPLE_WINDOW:"x-simple-window",TRANSITION:"x-window-is-transition",MENU:"x-window-is-menu",FOCUSED:"x-window-is-focused",MAXIMIZE:"x-window-is-maximize",HEADER:"x-window-header",BODY:"x-window-body"}),b=Object.freeze({NONE:0,TOP:1,BOTTOM:2,LEFT:4,RIGHT:8}),F=Object.freeze({TOP:b.TOP,BOTTOM:b.BOTTOM,LEFT:b.LEFT,RIGHT:b.RIGHT,TOP_LEFT:b.TOP|b.LEFT,TOP_RIGHT:b.TOP|b.RIGHT,BOTTOM_LEFT:b.BOTTOM|b.LEFT,BOTTOM_RIGHT:b.BOTTOM|b.RIGHT}),p=Object.freeze({NONE:b.NONE,MAXIMIZE:b.TOP,LEFT:b.LEFT,RIGHT:b.RIGHT,TOP_LEFT:b.TOP|b.LEFT,TOP_RIGHT:b.TOP|b.RIGHT,BOTTOM_LEFT:b.BOTTOM|b.LEFT,BOTTOM_RIGHT:b.BOTTOM|b.RIGHT}),L=Object.freeze({DISABLED:0,RESIZE:1,RESIZE_ONLY:2}),Z=Object.freeze({INIT:0,MOUNTED:1,UNMOUNTED:2}),Ps=Object.freeze({SIMPLE_WINDOW:"SimpleWindow",BLANK_WINDOW:"BlankWindow"}),B=Object.freeze({CLOSE:0,MAXIMIZE:1,RESTORE:2,PIN:3,UNPIN:4});class ys{constructor(s,n,t){u(this,"type");u(this,"stopped",!1);u(this,"defaultPrevented",!1);u(this,"instance");u(this,"detail");this.type=s,this.instance=n,this.detail=t}stop(){this.stopped=!0}preventDefault(){this.defaultPrevented=!0}}class ps{constructor(){u(this,"ALL_EVENTS",new Map)}static NOOP(){}on(s,n){const t=this.ALL_EVENTS.get(s);return t==null?(this.ALL_EVENTS.set(s,[n]),this):t.includes(n)?this:(t.push(n),this)}once(s,n){const t=l=>{n(l),this.off(s,t,!0)};return this.on(s,t),this}off(s,n,t=!1){const l=this.ALL_EVENTS.get(s);if(l==null)return this;const o=l.indexOf(n);return o<0?this:(t?l.splice(o,1,ps.NOOP):l.splice(o,1),this)}dispatch(s){const n=this.ALL_EVENTS.get(s.type);if(n==null)return s;for(const l of n)if(typeof l=="function"&&l(s),s.stopped)break;const t=n.filter(l=>l!=ps.NOOP);return this.ALL_EVENTS.set(s.type,t),s}cleanup(){this.ALL_EVENTS.clear()}}function R(a,s,n){return s!=null&&Number.isFinite(s)&&a<s?s:n!=null&&Number.isFinite(n)&&a>n?n:a}function Ms(a){return a==null||typeof a!="string"?!0:a.length==0}function wn(a){return a==null||typeof a!="string"?!1:a.length!=0}function bn(a){a.stopPropagation()}const yn={top:"offsetTop",left:"offsetLeft",width:"offsetWidth",height:"offsetHeight"};class _n{constructor(s){u(this,"init",!1);u(this,"defaultPrevented",!1);u(this,"originalEvent");u(this,"target");u(this,"direction");this.originalEvent=s,this.target=s.target,this.direction=Reflect.get(this.target,hs.PROP)}createEvent(s,n){return new ys(s,n,this)}}class hs{constructor(s){u(this,"context");u(this,"window");u(this,"onResizing");u(this,"onResizeend");this.window=s}resizestart(s){s.stopPropagation(),s.preventDefault();const n=new _n(s);this.context=n,this.onResizing=this.resizing.bind(this),this.onResizeend=this.resizeend.bind(this),window.addEventListener("pointermove",this.onResizing),window.addEventListener("pointerup",this.onResizeend)}resizing(s){if(this.context==null)return;s.stopPropagation(),s.preventDefault();const n=this.context;if(!n.init){if(this.window.dispatch(this.context.createEvent("resizeStart",this.window)).defaultPrevented)return this.cleanup();n.target.setPointerCapture(s.pointerId),n.init=!0}const t=this.calcWindowState(s),l=this.window.getElement();for(const c in t){const g=Math.round(t[c]);Reflect.set(l.style,c,g+"px")}n.originalEvent=s;const o=this.context.createEvent("resizing",this.window);this.window.dispatch(o)}resizeend(s){if(this.context==null)return;s.stopPropagation(),s.preventDefault();const n=this.context;if(n.init){const t=n.createEvent("resizeEnd",this.window);this.window.dispatch(t),this.patchWindowState(this.calcWindowState(s)),n.target.releasePointerCapture(s.pointerId)}this.cleanup()}cleanup(){this.onResizing&&window.removeEventListener("pointermove",this.onResizing),this.onResizeend&&window.removeEventListener("pointerup",this.onResizeend),this.onResizing=void 0,this.onResizeend=void 0,this.context=void 0}calcWindowState(s){const n=this.context,t=this.window.options,l=typeof t.minWidth=="number"&&t.minWidth>=0?t.minWidth:360,o=typeof t.minHeight=="number"&&t.minHeight>=0?t.minHeight:32,c=this.window.getElement().getBoundingClientRect(),g=document.documentElement.getBoundingClientRect(),m={};if(n.direction&b.TOP){const x=R(c.bottom-R(s.clientY,0),o),I=R(s.clientY-g.top,0,window.innerHeight-x);m.height=x,m.top=I}if(n.direction&b.BOTTOM){const x=R(R(s.clientY,0,window.innerHeight)-c.top,o),I=R(s.clientY-x-g.top,0,window.innerHeight-x);m.height=x,m.top=I}if(n.direction&b.LEFT){const x=R(c.right-R(s.clientX,0),l,window.innerWidth),I=R(s.clientX-g.left,0,window.innerWidth-x);m.width=x,m.left=I}if(n.direction&b.RIGHT){const x=R(R(s.clientX,0)-c.left,l,window.innerWidth),I=R(s.clientX-x-g.left,0,window.innerWidth-x-0);m.width=x,m.left=I}return m}patchWindowState(s){const n=this.window.state;for(const t in s){const l=Math.round(s[t]),o=yn[t];o!=null&&Reflect.set(n,o,l)}}}u(hs,"PROP","__xwindow_resize_prop__");const vn="_1T2rhwiL",xn="yi9w1sZD",En="Ja2o9U31",Tn="_1eMSsKoB",Wn="_3czvPpS2",Mn="GiVk7T8N",kn="VuG4WNig x-window-is-menu",In="yBPezU8e",Cn="xbuRK23n",On="_9t1NJBZM",Sn="shyxrRzw",zn="nkEGqTFw",Rn="pk12TusX",Ln="noixF94i",Pn="ifXDegN1 VuG4WNig x-window-is-menu",Nn="X5A6roxN VuG4WNig x-window-is-menu",Bn="PPmfTMRL",An="v8UGXgKi PPmfTMRL",Dn="_74VJ9GNt PPmfTMRL",qn="gg9Mcwey PPmfTMRL",Hn="Tw7sCaLt PPmfTMRL",Fn="CPuApFyD PPmfTMRL",Vn="VBRi4FWg PPmfTMRL",$n="gCRpuZdB PPmfTMRL",Xn="iRYpNoUT PPmfTMRL",Gn="xTcKGSVA",T={window:vn,dragging:xn,resizing:En,maximize:Tn,focused:Wn,header:Mn,menu:kn,logo:In,main:Cn,init:On,title:Sn,menus:zn,body:Rn,footer:Ln,closeMenu:Pn,pinMenu:Nn,resizeBar:Bn,resizeTop:An,resizeBottom:Dn,resizeRight:qn,resizeLeft:Hn,resizeTopLeft:Fn,resizeBottomLeft:Vn,resizeTopRight:$n,resizeBottomRight:Xn,mask:Gn},Ns=O({name:"WindowBody",props:{wid:String,body:{type:[Object,Function,String,Number],default:null},abstractWindow:{type:Object,required:!0}},setup(a){return function(){const s=typeof a.body=="function"?a.body(a.abstractWindow):a.body;return s==null&&console.warn("[xWindow] 请指定窗体内容:",a.abstractWindow.options.title),s}}}),Un=Math.floor(Number.MAX_SAFE_INTEGER/10)-1e4;function Zn(){return{visible:!1,offsetWidth:0,offsetHeight:0,offsetTop:0,offsetLeft:0,focused:!1,pinned:!1,zIndex:0,splitMode:p.NONE}}const Yn=[[T.resizeTop,F.TOP],[T.resizeBottom,F.BOTTOM],[T.resizeLeft,F.LEFT],[T.resizeRight,F.RIGHT],[T.resizeTopLeft,F.TOP_LEFT],[T.resizeTopRight,F.TOP_RIGHT],[T.resizeBottomLeft,F.BOTTOM_LEFT],[T.resizeBottomRight,F.BOTTOM_RIGHT]];function Jn(a,s,n,t){return U(()=>{const l=a.options;if(s.value==Z.INIT)return{width:l.width,height:l.height,left:l.left,top:l.top};const o=l.mask?null:t.value;return{top:n.offsetTop+"px",left:n.offsetLeft+"px",width:n.offsetWidth+"px",height:s.value==Z.INIT?void 0:n.offsetHeight+"px",zIndex:o}})}function Kn(a,s){return a==L.DISABLED?null:Yn.map(n=>X("div",{["."+hs.PROP]:n[1],className:n[0],onPointerdown:s}))}function Qn(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!ns(a)}const Q=O({name:"BlankWindow",props:{abstractWindow:{type:Object,required:!0}},setup(a,{slots:s}){const n=on(),t=us(Zn()),l=K(Z.INIT),o=U(()=>{const d=a.abstractWindow.options;return typeof d.zIndex=="number"&&d.zIndex>0}),c=U(()=>{const d=a.abstractWindow.options;return o.value?d.zIndex:(t.pinned?Un:0)+t.zIndex}),g=Jn(a.abstractWindow,l,t,c),m=U(()=>{const d=[D.WINDOW,T.window],w=a.abstractWindow;return w.type===Ps.SIMPLE_WINDOW&&d.push(D.SIMPLE_WINDOW),l.value==Z.INIT&&d.push(T.init),t.splitMode==p.MAXIMIZE&&d.push(T.maximize,D.MAXIMIZE),t.focused&&d.push(T.focused,D.FOCUSED),wn(w.options.className)&&d.push(w.options.className),d}),x=U(()=>{const d=[],C=a.abstractWindow.options;return C.pinnable&&C.mask!==!0&&o.value!==!0&&d.push(t.pinned?B.PIN:B.UNPIN),C.resizeMode==L.RESIZE&&d.push(t.splitMode==p.MAXIMIZE?B.RESTORE:B.MAXIMIZE),C.closeable&&d.push(B.CLOSE),d}),I={getElement:W,getRenderState:i,useCssClass:h,useMenus:z};function W(){return n.value}function i(){return l.value}function h(){return T}async function v(d){d==null||d.preventDefault(),a.abstractWindow.toggleMaximize()}function j(){JSON.parse(JSON.stringify(t))}function z(){return x}function S(d){const w=Array.from(d.querySelectorAll("[autofocus]"));for(const C of w)if(C instanceof HTMLElement&&C.autofocus)return C.focus()}async function N(d){await ms();const w=a.abstractWindow,C=w.options,os=d.el,q=os.getBoundingClientRect();if(l.value==Z.INIT){let cs=Math.round(q.left),is=Math.round(q.top);Ms(C.left)&&(cs=Math.floor((window.innerWidth-q.width)/2)),Ms(C.top)&&(is=Math.floor((window.innerHeight-q.height)/2)),t.offsetWidth=q.width,t.offsetHeight=q.height,t.offsetLeft=cs,t.offsetTop=is,C.maximize&&v(),l.value=Z.MOUNTED,j(),ms(()=>{const H=w.createEvent("show");w.dispatch(H),S(os)})}w.focus()}function as(d){const w=a.abstractWindow;w.focus(),!(!w.allowDrag||w.isMaximize)&&w.dragstart(d)}function ts(d){const w=W();if(w==null)return;const C=w.getBoundingClientRect();d.clientY-C.top>a.abstractWindow.allowDragArea||v(d)}function ls(){const d=a.abstractWindow;d.component=I,d.state=t,oa(d.id,d);const w=d.createEvent("created");d.dispatch(w)}function es(){const d=a.abstractWindow,w=d.options;return r(Ns,{class:w.bodyClassName,body:d.body,abstractWindow:a.abstractWindow,key:d.wid},null)}return cn(Ls,a.abstractWindow),ls(),function(){const d=a.abstractWindow,w=d.options;if(t.visible!==!0)return null;const C=typeof s.header=="function"?s.header(I):null,os=typeof s.body=="function"?s.body(I):es(),q=r("div",{class:T.main,onDblclick:ts},[C,os]),cs={ref:n,id:d.wid,onVnodeMounted:N,onPointerdown:as,class:m.value,style:g.value},is=Kn(w.resizeMode,d.resizestart);let H=X("div",cs,[q,is]);if(w.mask===!0){const tn={zIndex:c.value};H=r("div",{class:T.mask,style:tn},[H])}return w.teleport===!1?H:r(Ss,{to:w.teleport},Qn(H)?H:{default:()=>[H]})}}}),Bs='<svg width="64" height="64" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path fill="currentColor" d="M590.265 511.987l305.521-305.468c21.617-21.589 21.617-56.636.027-78.252-21.616-21.617-56.663-21.617-78.279 0L512.012 433.735 206.544 128.213c-21.617-21.617-56.635-21.617-78.252 0-21.616 21.589-21.616 56.635-.027 78.252L433.76 511.987 128.211 817.482c-21.617 21.59-21.617 56.635 0 78.251 10.808 10.81 24.967 16.213 39.125 16.213 14.159 0 28.318-5.403 39.126-16.213l305.522-305.468L817.48 895.788C828.289 906.597 842.447 912 856.606 912s28.317-5.403 39.125-16.212c21.618-21.59 21.618-56.636.028-78.252L590.265 511.987z"/></svg>',As='<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" p-id="5228" width="64" height="64"><path d="M97.74775349 97.74775349h828.50449302v828.50449302H97.74775349V97.74775349z m103.56306133 103.56306133v621.37837036h621.37837036V201.31081482H201.31081482z" fill="currentColor"></path></svg>',Ds='<svg width="64" height="64" viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg"><path d="M38.794 124.791v778.495h946.412V124.791H38.794zm896.678 728.033H89.292v-460.9h846.18v460.9z"/></svg>',qs='<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="64" height="64"><path d="M738.793 681.382v-48.331l88.242-88.243a298.676 298.676 0 00156.712-83.482 38.836 38.836 0 000-54.923l-366.15-366.15a38.836 38.836 0 00-54.923 0 298.52 298.52 0 00-83.519 156.749l-88.169 88.169h-48.332a411.145 411.145 0 00-292.59 121.232c-15.16 15.159-15.16 39.764 0 54.923L278.906 690.17 86.642 882.436a38.836 38.836 0 1054.922 54.922l192.23-192.229 228.844 228.845a38.836 38.836 0 0054.922 0 411.042 411.042 0 00121.233-292.592zM134.02 435.44a333.473 333.473 0 01208.56-72.571l64.406.037a38.836 38.836 0 0027.461-11.351L544.292 241.71a38.68 38.68 0 0011.351-27.462 180.096 180.096 0 0136.798-89.01L898.8 431.593a180.925 180.925 0 01-89.12 36.835 38.836 38.836 0 00-27.462 11.35L672.373 589.626c-7.287 7.286-11.387 17.173-11.35 27.461l.036 64.406a333.318 333.318 0 01-72.608 208.596L134.021 435.44z"/></svg>',Hs='<svg viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg" width="64" height="64"><path d="M845.40952426 212.52063539H65.21904746v702.17142826h780.1904768V212.52063539z m-702.17142933 624.1523808V290.53968285h624.1523808v546.13333334H143.23809493z" fill="currentColor"></path><path d="M981.53650809 76.3936505H201.34603129v78.01904746h702.17142933v624.15238187h78.01904747V76.3936505z" fill="currentColor"></path></svg>';function sa(){return{IconClose:Bs,IconMax:As,IconPin:qs,IconWindow:Ds,IconRestore:Hs}}function na(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!ns(a)}function aa(a){const s=a.options.icon;return typeof s=="string"?r("i",{class:[T.logo,"icon",s]},null):ns(s)?s:typeof s=="function"?s(a):r("i",{class:T.logo,innerHTML:Ds},null)}const rs=O({name:"SimpleWindow",props:{abstractWindow:{type:Object,required:!0}},setup(a){const s=a.abstractWindow,n={header(){const t=s.useMenus();return r("div",{class:T.header},[aa(s),r("div",{class:T.title},[s.options.title??"新窗口"]),r("div",{class:T.menus,onMousedown:bn},[t.value.map(l=>Ys(s,l))])])},body(){const t=s.options;return r("div",{class:[T.body,D.BODY,t.bodyClassName]},[r(Ns,{body:s.body,abstractWindow:a.abstractWindow,key:s.wid},null)])}};return function(){return r(Q,{abstractWindow:a.abstractWindow},na(n)?n:{default:()=>[n]})}}}),Fs=Object.freeze({SIMPLE_WINDOW:rs.name,BLANK_WINDOW:Q.name});function Vs(a){return a==Q.name?Q:rs}function $s(a){if(a.key=="Escape")return Zs({pressEsc:!0,forced:!1})}function ta(){f.isMounted=!0}function Xs(){f.isMounted=!1,f.topWindow=null,f.ids.value=[],f.stack.clear()}function Gs(){return f.zIndex}function Us(){return f.zIndex+=1}function la(){const a=f.topWindow;return a?a.state.zIndex:1}function ea(){return f.topWindow}function oa(a,s){f.stack.set(a,s)}function ca(a){if(console.log("[xWindow]: remove window",a),!f.stack.has(a)||(f.stack.delete(a),!f.isMounted))return;const s=f.ids.value.indexOf(a);if(s<0)return;f.ids.value.splice(s,1)}function Zs(a){if(f.stack.size==0||f.topWindow==null)return;const s=f.topWindow;(a==null?void 0:a.pressEsc)===!0&&s.options.closeOnPressEsc!==!0||f.topWindow.cancel(a==null?void 0:a.forced)}function ia(a){const s=document.createDocumentFragment(),n=Vs(a.type),t=X(n,{abstractWindow:a});t.appContext=f.appContext,Ts(t,s),document.body.appendChild(s),a.on("beforeDestroy",()=>{Ts(null,s)})}function pa(a){const s=ws.create(a);return f.isMounted?(f.ids.value.push(s.id),f.stack.set(s.id,s),s):(ia(s),s)}function ra(a){return f.stack.get(a)}function ua(){return f.ids}function _s(a){if(f.topWindow=a,a!=null){for(const s of f.stack.values()){const n=s.state;n!=null&&(n.focused=s===a)}a.state!=null&&a.state.zIndex<Gs()&&(a.state.zIndex=Us())}}function da(a){const s=f.stack.get(a);_s(s)}function ha(){const a=ja();_s(a)}function ja(){if(f.stack.size==0)return;let a;for(const s of f.stack.values())if(!(s.state==null||s.state.visible!==!0)){if(a==null){a=s;continue}a.state.zIndex<s.state.zIndex&&(a=s)}return a}function ga(){return f.previewState}function ma(){return f.stack.size}function fa(){window.addEventListener("keydown",$s,!0)}function wa(a){f.appContext=a._context}function ba(){f.appContext=null,Xs(),window.removeEventListener("keydown",$s,!0)}function ya(){return{closeTopWindow:Zs,getTopWindow:ea,getTopZIndex:Us,getWindowCount:ma,getZIndex:Gs,setFocusedWindow:_s,cleanup:ba}}class _a{constructor(s,n){u(this,"moved",!1);u(this,"originalEvent");u(this,"target");u(this,"deltaX");u(this,"deltaY");u(this,"initialX");u(this,"initialY");u(this,"left",0);u(this,"top",0);u(this,"prevClientX");u(this,"prevClientY");const t=s.getBoundingClientRect();this.originalEvent=n,this.target=s,this.deltaX=Math.round(t.left-n.clientX),this.deltaY=Math.round(t.top-n.clientY),this.initialX=n.clientX,this.initialY=n.clientY,this.prevClientX=n.clientX,this.prevClientY=n.clientY}preventDragEvent(s){return!(this.moved||Math.abs(s.clientX-this.initialX)>4||Math.abs(s.clientY-this.initialY)>4)}createEvent(s,n){return new ys(s,n,this)}}class va{constructor(s){u(this,"window");u(this,"context");u(this,"onDragging");u(this,"onDragend");this.window=s}static isConflict(s,n){const t=s.getBoundingClientRect(),l=n.getBoundingClientRect();return!(t.top>l.bottom||t.right<l.left||t.bottom<l.top||t.left>l.right)}static findElementsFromPoint(s,n,t,l){return typeof document.elementsFromPoint!="function"?[]:document.elementsFromPoint(s,n).filter(c=>l!=null&&!l.contains(c)?!1:typeof t=="string"?c.matches(t):!1)}dragstart(s){if(s.button!==0)return;const n=s.target;if(n instanceof Element&&n.closest("."+D.MENU))return;const t=this.window.getElement();if(t==null)return;const l=t.getBoundingClientRect();s.clientY-l.top>this.window.allowDragArea||(s.preventDefault(),s.stopPropagation(),this.context=new _a(t,s),this.context.left=this.window.state.offsetLeft,this.context.top=this.window.state.offsetTop,this.onDragging=this.dragging.bind(this),this.onDragend=this.dragend.bind(this),window.addEventListener("pointermove",this.onDragging),window.addEventListener("pointerup",this.onDragend))}dragging(s){var o;if(this.context==null)return;const n=this.context;if(!n.moved){if(this.window.dispatch(this.context.createEvent("dragStart",this.window)).defaultPrevented)return this.cleanup();const g=(o=this.window.component)==null?void 0:o.useCssClass();g!=null&&g.dragging&&n.target.classList.add(g.dragging),n.target.setPointerCapture(s.pointerId),n.moved=!0}if(n.preventDragEvent(s))return;s.preventDefault(),s.stopPropagation(),n.originalEvent=s,n.left=s.clientX+n.deltaX,n.top=s.clientY+n.deltaY,n.prevClientX=s.clientX,n.prevClientY=s.clientY;const t=n.target;t.style.left=n.left+"px",t.style.top=n.top+"px";const l=this.context.createEvent("dragging",this.window);this.window.dispatch(l)}dragend(s){if(this.context==null||!this.context.moved)return this.cleanup();s.preventDefault(),s.stopPropagation();const n=this.context;n.originalEvent=s,n.target.releasePointerCapture(s.pointerId);const t=n.createEvent("dragEnd",this.window);this.window.dispatch(t),this.window.state.offsetTop=n.top,this.window.state.offsetLeft=n.left,this.cleanup()}cleanup(){var n,t;const s=(n=this.window.component)==null?void 0:n.useCssClass();s!=null&&s.dragging&&((t=this.context)==null||t.target.classList.remove(s.dragging)),this.onDragging&&window.removeEventListener("pointermove",this.onDragging),this.onDragend&&window.removeEventListener("pointerup",this.onDragend),this.onDragging=void 0,this.onDragend=void 0,this.context=void 0}}const J=class J extends ps{constructor(n){super();u(this,"CREATE_RESOLVE");u(this,"CREATE_REJECT");u(this,"id");u(this,"type");u(this,"options");u(this,"body");u(this,"state");u(this,"created",!1);u(this,"destroyed",!1);u(this,"component");u(this,"draggable");u(this,"resizable");u(this,"handles",{});u(this,"dragstart");u(this,"resizestart");this.type=n.type??Ps.SIMPLE_WINDOW,this.options=this.createOptions(n),this.body=n.body,Reflect.defineProperty(this,"id",{enumerable:!0,configurable:!1,writable:!1,value:J.seed++}),this.initDraggable(),this.initResizable(),this.initHooks()}static create(n){return n instanceof J?n:new J(n)}get wid(){return"window--"+this.id}get isReady(){return this.created===!0}get allowDrag(){const n=this.options.draggable;return n===!1?!1:typeof n=="number"?n>0:!0}get allowDragArea(){const n=this.options.draggable;return typeof n=="number"&&n>0?n:Y.draggaleHeight}get isMaximize(){var n;return((n=this.state)==null?void 0:n.splitMode)===p.MAXIMIZE}createOptions(n){return{title:n.title??"未命名的窗口",icon:n.icon,className:n.className,bodyClassName:n.bodyClassName,width:n.width??"640px",minWidth:n.minWidth??360,maxWidth:n.maxWidth,height:n.height,minHeight:n.minHeight??32,maxHeight:n.maxHeight,top:n.top,left:n.left,zIndex:n.zIndex,maximize:n.maximize===!0,teleport:n.teleport??"body",draggable:n.draggable==null?!0:n.draggable,resizeMode:n.resizeMode??L.RESIZE,closeable:n.closeable!==!1,mask:n.mask===!0,pinnable:n.pinnable!==!1,displayAfterCreate:n.displayAfterCreate!==!1,destroyAfterClose:n.destroyAfterClose!==!1,closeOnPressEsc:n.closeOnPressEsc!==!1}}createEvent(n,t){return new ys(n,this,t)}initDraggable(){this.draggable=new va(this),this.dragstart=this.draggable.dragstart.bind(this.draggable)}initResizable(){this.resizable=new hs(this),this.resizestart=this.resizable.resizestart.bind(this.resizable)}initHooks(){this.once("created",()=>{this.created=!0,typeof this.CREATE_RESOLVE=="function"&&this.CREATE_RESOLVE(),delete this.CREATE_REJECT,delete this.CREATE_RESOLVE})}ready(){return this.created===!0?Promise.resolve():new Promise((n,t)=>{this.CREATE_RESOLVE=n,this.CREATE_REJECT=t})}show(){this.state==null||this.dispatch(this.createEvent("beforeShow")).defaultPrevented||(this.state.visible=!0)}close(n=!1){if(this.state==null||this.options.closeable===!1&&n!==!0)return!1;const t=this.dispatch(this.createEvent("beforeClose"));return n!==!0&&t.defaultPrevented?!1:(this.state.visible=!1,this.dispatch(this.createEvent("close")),this.state.focused&&setTimeout(ha),!this.destroyed&&this.options.destroyAfterClose!==!1&&this.destroy(),!0)}cleanup(){super.cleanup(),this.dragstart=void 0,this.resizestart=void 0,this.component=void 0,this.state=void 0,this.handles={}}destroy(){var n;this.destroyed=!0,((n=this.state)==null?void 0:n.visible)===!0&&this.close(),this.dispatch(this.createEvent("beforeDestroy")),ca(this.id),setTimeout(()=>this.cleanup(),100)}getElement(){var n;return(n=this.component)==null?void 0:n.getElement()}useMenus(){return this.component.useMenus()}focus(){this.state==null||this.state.focused||da(this.id)}startTransition(){const n=document.documentElement,t=function(l){l.target.matches("."+D.WINDOW)&&(n.classList.remove(D.TRANSITION),n.removeEventListener("transitionend",t))};n.classList.add(D.TRANSITION),n.addEventListener("transitionend",t)}requestMaximize(){const n=this.state;n==null||this.options.resizeMode!==L.RESIZE||(n.splitMode=p.MAXIMIZE,this.startTransition(),this.dispatch(this.createEvent("maximizeChange")))}exitMaximize(){const n=this.state;n==null||this.options.resizeMode!==L.RESIZE||(n.splitMode=p.NONE,this.startTransition(),this.dispatch(this.createEvent("maximizeChange")))}toggleMaximize(){const n=this.state;n==null||this.options.resizeMode!==L.RESIZE||(n.splitMode===p.MAXIMIZE?this.exitMaximize():this.requestMaximize())}pin(){const n=this.state;n!=null&&(n.pinned=!0)}unpin(){const n=this.state;n!=null&&(n.pinned=!1)}togglePin(){const n=this.state;n!=null&&(n.pinned?this.unpin():this.pin())}useHandle(n,t){this.handles[n]=t}async callHandle(n){const t=this.handles[n];if(typeof t=="function")return await t()}onConfirm(){return this.callHandle("confirm").then(n=>this.confirm(n))}confirm(n){this.dispatch(this.createEvent("confirm",n)),this.close(!0)}onCancel(){return this.callHandle("cancel").then(n=>this.cancel(!0,n))}cancel(n=!0,t){this.close(n)&&this.dispatch(this.createEvent("cancel",t))}promise(){return new Promise((n,t)=>{this.once("confirm",l=>n(l.detail)),this.once("cancel",l=>t(l.detail))})}};u(J,"seed",1e3);let ws=J;const ks=1e3,Y={},f=Ta();function xa(a){return typeof a!="number"||!Number.isFinite(a)?ks:Math.floor(a)}function Ea(a){Y.zIndex=xa(a==null?void 0:a.zIndex),Y.draggaleHeight=(a==null?void 0:a.draggaleHeight)??32,Y.size=(a==null?void 0:a.size)??{},f.zIndex=Y.zIndex}function js(){return pn(Ls)}function Ta(){return{appContext:null,isMounted:!1,zIndex:1e3,stack:new Map,ids:K([]),topWindow:null,previewState:us({mode:p.NONE,width:0,height:0})}}function Ys(a,s){var g;const n=a.state,t=((g=a.component)==null?void 0:g.useCssClass())??{};function l(){a.cancel()}function o(){a.togglePin()}function c(m){m.preventDefault(),a.toggleMaximize()}switch(s){case B.CLOSE:return r("button",{onClick:l,type:"button",innerHTML:Bs,class:t.closeMenu,title:"关闭"},null);case B.PIN:case B.UNPIN:const m=n.pinned?"取消固定":"固定",x=n.pinned?t.pinMenu:t.menu;return r("button",{onClick:o,type:"button",innerHTML:qs,class:x,title:m},null);case B.MAXIMIZE:case B.RESTORE:const I=n.splitMode==p.MAXIMIZE?Hs:As,W=n.splitMode==p.MAXIMIZE?"还原":"最大化";return r("button",{onClick:c,type:"button",innerHTML:I,class:t.menu,title:W},null)}return null}const Wa="Ycke6mYQ",Ma="esgrGyhH",ka="UkryRM5g",Ia="U5LZXLJZ",Ca="_2rffDKab",Oa="vcVMeNrL",Sa="koc15mYi",za="_4VxfFKcG",V={splitWindowMask:Wa,maximize:Ma,splitLeft:ka,splitRight:Ia,splitTopLeft:Ca,splitTopRight:Oa,splitBottomLeft:Sa,splitBottomRight:za};function Ra(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!ns(a)}const La={[p.MAXIMIZE]:V.maximize,[p.LEFT]:V.splitLeft,[p.RIGHT]:V.splitRight,[p.TOP_LEFT]:V.splitTopLeft,[p.TOP_RIGHT]:V.splitTopRight,[p.BOTTOM_LEFT]:V.splitBottomLeft,[p.BOTTOM_RIGHT]:V.splitBottomRight},Pa={ArrowUp:{[p.BOTTOM_LEFT]:p.LEFT,[p.BOTTOM_RIGHT]:p.RIGHT,[p.LEFT]:p.TOP_LEFT,[p.RIGHT]:p.TOP_RIGHT,fallback:p.MAXIMIZE},ArrowDown:{[p.TOP_LEFT]:p.LEFT,[p.TOP_RIGHT]:p.RIGHT,[p.LEFT]:p.BOTTOM_LEFT,[p.RIGHT]:p.BOTTOM_RIGHT,fallback:p.NONE},ArrowLeft:{[p.TOP_RIGHT]:p.TOP_LEFT,[p.TOP_LEFT]:p.TOP_RIGHT,[p.BOTTOM_RIGHT]:p.BOTTOM_LEFT,[p.BOTTOM_LEFT]:p.BOTTOM_RIGHT,fallback:p.LEFT},ArrowRight:{[p.TOP_LEFT]:p.TOP_RIGHT,[p.TOP_RIGHT]:p.TOP_LEFT,[p.BOTTOM_LEFT]:p.BOTTOM_RIGHT,[p.BOTTOM_RIGHT]:p.BOTTOM_LEFT,fallback:p.RIGHT}},Is=O({name:"WindowManager",setup(){const a=ua(),s=ga();function n(o){const c=o.key;o.ctrlKey&&c in Pa}ta(),window.addEventListener("keydown",n,!0),zs(()=>{Xs(),window.removeEventListener("keydown",n,!0)});const t=U(()=>{const o=[V.splitWindowMask],c=La[s.mode];return c!=null&&o.push(c),o});function l(){let o=null;if(s.mode!=p.NONE){const g={zIndex:la()+1,width:s.width?s.width-20+"px":void 0};o=r("div",{class:t.value,style:g},null)}return r(Ss,{to:"body"},{default:()=>[r(rn,{name:"fade"},Ra(o)?o:{default:()=>[o]})]})}return function(){return[...a.value.map(c=>{const g=ra(c);if(g==null)return null;const m=Vs(g.type);return X(m,{abstractWindow:g,key:g.wid})}),l()]}}});function Na(a){if(a.length==1){const s=a[0];return s==null?null:typeof s=="object"?{...s}:null}if(a.length==2){const[s,n]=a;if(typeof s=="string"&&n!=null)return{title:s,body:n}}if(a.length==3){const[s,n,t]=a;if(typeof s=="string"&&n!=null)return{...t,title:s,body:n}}return null}function vs(a){const s=Na(a)??{},n=typeof s.size=="string"?Reflect.get(Y.size,s.size):null;return n!=null&&(s.width=n.width,s.height=n.height,s.top=n.top,s.left=n.left),s}function G(...a){const s=vs(a)??{};return xs(s)}function Js(...a){const s=vs(a)??{};return s.type=Fs.BLANK_WINDOW,xs(s)}function Ba(...a){const s=vs(a)??{};return s.type=Fs.SIMPLE_WINDOW,xs(s)}function xs(a){const s=pa(a);return s.ready().then(()=>{a.displayAfterCreate!==!1&&s.show()}),s}const Ks=Object.freeze({renderMenu:Ys});function Aa(a,s){a.component(rs.name,rs),a.component(Q.name,Q),a.component(Is.name,Is),Ea(s),fa(),wa(a)}const Da=fn,qa={install:Aa,version:Da},Ha=`<svg viewBox="0 0 1024 1024" version="1.1"
...
</svg>`,Va=O({__name:"HelloWorld",setup(a){function s(){G("示例窗口",r("div",{class:"example-body"},[y("Hello, xWindow!")]))}return(n,t)=>(M(),k("button",{type:"button",onClick:s,class:"btn btn-small"},"尝试一下"))}}),$a={class:"example-body"},Xa=O({__name:"WinBody",props:{text:String},setup(a){return(s,n)=>(M(),k("div",$a,P(a.text),1))}}),Ga=O({__name:"FunctionBased",setup(a){function s(){G("窗口1",r("div",{class:"example-body"},[y("这段文本是使用JSX创建的。")]))}function n(){G("窗口2","这段本文可以直接展示。")}function t(){G("窗口3",X("div",{className:"example-body"},"这段文本是通过Vue提供的渲染函数创建的。"))}function l(){G("窗口4",()=>r("div",{class:"example-body"},[y("这段文本是通过返回VNode节点的函数创建的。")]))}function o(){G("窗口5",r(Xa,{text:"这段文本通过组件创建的。"},null))}return(c,g)=>(M(),k($,null,[e("button",{class:"btn",type:"button",onClick:s},"JSX"),e("button",{class:"btn",type:"button",onClick:n},"文本"),e("button",{class:"btn",type:"button",onClick:t},"渲染函数"),e("button",{class:"btn",type:"button",onClick:l},"函数"),e("button",{class:"btn",type:"button",onClick:o},"组件")],64))}}),Ua=e("header",null,"窗口尺寸：",-1),Za=e("header",null,"窗口位置：",-1),Ya=e("header",null,"窗口特性：",-1),Ja=["onUpdate:modelValue"],Ka=e("header",null,"调整模式：",-1),Qa=["value"],st=e("span",null,"允许调整窗口大小，允许最大化（默认）",-1),nt=["value"],at=e("span",null,"只允许调整窗口大小",-1),tt=["value"],lt=e("span",null,"禁止",-1),Cs="__WIN_EVENTS__",et=O({__name:"Example",setup(a){const s=Rs("classes"),n=ya(),t=[{label:"可拖拽",prop:"draggable",value:!0},{label:"可关闭",prop:"closeable",value:!0},{label:"可置顶",prop:"pinnable",value:!0},{label:"最大化",prop:"maximize",value:!1},{label:"遮罩层",prop:"mask",value:!1},{label:"按ESC键关闭",prop:"closeOnPressEsc",value:!0}],l={width:"800px",height:"600px",left:"calc(50vw - 400px)",top:"12vh",resizeMode:L.RESIZE},o=t.reduce((W,i)=>(W[i.prop]=i.value,W),{...l}),c=us(o),g=O({props:{params:{type:Object,required:!0}},setup(W){const i=js(),h=Reflect.get(i,Cs);function v(){i==null||i.close(!0)}return function(){var N,as,ts,ls,es,d;const j=c.closeable?null:r("button",{type:"button",class:"btn btn-small",onClick:v},[y("关闭窗口")]),z=t.map(w=>r("p",null,[w.label,y(": "),JSON.stringify(W.params[w.prop])])),S=h.value.map(w=>r("p",null,[w]));return r("div",{class:s.exampleBody},[r("div",{class:s.params},[r("div",{class:s.panel},[r("h4",null,[y("初始参数：")]),z]),r("div",{class:s.panel},[r("h4",null,[y("窗口状态：")]),r("div",{class:s.infos},[r("p",null,[y("id: "),i==null?void 0:i.wid]),r("p",null,[y("focused: "),JSON.stringify((N=i==null?void 0:i.state)==null?void 0:N.focused)]),r("p",null,[y("left: "),(as=i==null?void 0:i.state)==null?void 0:as.offsetLeft,y("px")]),r("p",null,[y("top: "),(ts=i==null?void 0:i.state)==null?void 0:ts.offsetTop,y("px")]),r("p",null,[y("width: "),(ls=i==null?void 0:i.state)==null?void 0:ls.offsetWidth,y("px")]),r("p",null,[y("height: "),(es=i==null?void 0:i.state)==null?void 0:es.offsetHeight,y("px")]),r("p",null,[y("z-index: "),JSON.stringify((d=i==null?void 0:i.state)==null?void 0:d.zIndex)])])])]),r("div",{class:s.eventHeader},[r("strong",null,[y("窗口事件")]),j]),r("div",{class:s.events},[S])])}}});function m(){const W=new Date,i=W.getMinutes().toString().padStart(2,"0"),h=W.getSeconds().toString().padStart(2,"0"),v=W.getMilliseconds().toString().padStart(4,"0");return`${i}:${h}.${v}`}function x(){const W=n.getWindowCount(),i={...c,bodyClassName:s.winBody},h=K([]),v=Ba("窗口"+W,r(g,{params:i},null),i);v.on("created",()=>{h.value.unshift(`[${m()}]: call created event.`)}),v.on("beforeShow",j=>{h.value.unshift(`[${m()}]: call beforeShow event.`)}),v.on("show",j=>{h.value.unshift(`[${m()}]: call show event.`)}),v.on("close",()=>{h.value.unshift(`[${m()}]: call close event.`)}),v.on("beforeDestroy",()=>{h.value.unshift(`[${m()}]: call beforeDestroy event.`)}),v.on("dragStart",j=>{h.value.unshift(`[${m()}]: call dragStart event.`)}),v.on("dragEnd",j=>{h.value.unshift(`[${m()}]: call dragEnd event.`)}),v.on("resizeStart",j=>{h.value.unshift(`[${m()}]: call resizeStart event.`)}),v.on("resizeEnd",j=>{h.value.unshift(`[${m()}]: call resizeEnd event. `)}),v.on("maximizeChange",j=>{h.value.unshift(`[${m()}]: call maximizeChange event. isMaximize: ${v.isMaximize}`)}),Reflect.set(v,Cs,h)}function I(W,i){c.width=W+"px",c.height=i+"px"}return(W,i)=>(M(),k($,null,[e("section",{class:_(E(s).row)},[Ua,e("div",{class:_(E(s).content)},[e("label",null,[y("宽度："),A(e("input",{type:"text","onUpdate:modelValue":i[0]||(i[0]=h=>c.width=h),placeholder:"参照CSS的width属性"},null,512),[[ss,c.width]])]),e("label",null,[y("高度："),A(e("input",{type:"text","onUpdate:modelValue":i[1]||(i[1]=h=>c.height=h),placeholder:"参照CSS的height属性"},null,512),[[ss,c.height]])]),e("button",{type:"button",class:"btn btn-mini",onClick:i[2]||(i[2]=h=>I(800,600))},"800px*600px"),e("button",{type:"button",class:"btn btn-mini",onClick:i[3]||(i[3]=h=>I(390,840))},"390px*840px")],2)],2),e("section",{class:_(E(s).row)},[Za,e("div",{class:_(E(s).content)},[e("label",null,[y("左侧："),A(e("input",{type:"text","onUpdate:modelValue":i[4]||(i[4]=h=>c.left=h),placeholder:"参照CSS中left属性"},null,512),[[ss,c.left]])]),e("label",null,[y("上侧："),A(e("input",{type:"text","onUpdate:modelValue":i[5]||(i[5]=h=>c.top=h),placeholder:"参照CSS中top属性"},null,512),[[ss,c.top]])])],2)],2),e("section",{class:_(E(s).row)},[Ya,e("div",{class:_(E(s).content)},[(M(),k($,null,ds(t,h=>e("label",{key:h.prop},[A(e("input",{type:"checkbox","onUpdate:modelValue":v=>c[h.prop]=v},null,8,Ja),[[un,c[h.prop]]]),e("span",null,P(h.label),1)])),64))],2)],2),e("section",{class:_(E(s).row)},[Ka,e("div",{class:_(E(s).content)},[e("label",null,[A(e("input",{type:"radio",name:"resizeMode",value:E(L).RESIZE,"onUpdate:modelValue":i[6]||(i[6]=h=>c.resizeMode=h)},null,8,Qa),[[gs,c.resizeMode]]),st]),e("label",null,[A(e("input",{type:"radio",name:"resizeMode",value:E(L).RESIZE_ONLY,"onUpdate:modelValue":i[7]||(i[7]=h=>c.resizeMode=h)},null,8,nt),[[gs,c.resizeMode]]),at]),e("label",null,[A(e("input",{type:"radio",name:"resizeMode",value:E(L).DISABLED,"onUpdate:modelValue":i[8]||(i[8]=h=>c.resizeMode=h)},null,8,tt),[[gs,c.resizeMode]]),lt])],2)],2),e("button",{onClick:x,class:"btn"},"创建窗口")],64))}}),ot="Zj7DQ8mX",ct="hZ15PjHU",it="tbtACTrZ",pt="_3N6wV7j6",rt="oTAjhRfW",ut="CFWamGXp",dt="cqiqLgbF",ht="T9Y6Pp6o",jt="TUAWahwn",gt={winBody:ot,exampleBody:ct,row:it,content:pt,events:rt,params:ut,panel:dt,infos:ht,eventHeader:jt},Es=(a,s)=>{const n=a.__vccOpts||a;for(const[t,l]of s)n[t]=l;return n},mt={classes:gt},ft=Es(et,[["__cssModules",mt]]),wt={class:"approval-form"},bt={key:0,class:"approval-form-message"},Qs=O({__name:"UseApproval",setup(a){const s=js(),n=us({value:"",fail:!1});return s==null||s.useHandle("confirm",()=>n.value?n.value:(n.fail=!0,Promise.reject("验证未通过"))),(t,l)=>(M(),k("div",wt,[A(e("textarea",{type:"text","onUpdate:modelValue":l[0]||(l[0]=o=>n.value=o),placeholder:"请输入",ref:"inputRef",autofocus:""},null,512),[[ss,n.value]]),n.fail?(M(),k("div",bt,"请输入审批意见")):bs("",!0)]))}}),yt={key:0,class:"example-modal"},_t={class:"example-modal-header"},vt={class:"example-modal-title"},xt={class:"example-modal-menus"},Et={class:"example-modal-body"},Tt={class:"example-modal-footer"},sn=O({__name:"Modal",setup(a){const s=js();function n(){s==null||s.onCancel().catch(l=>console.error(l))}function t(){s==null||s.onConfirm().catch(l=>console.error(l))}return(l,o)=>E(s)?(M(),k("div",yt,[e("div",_t,[e("div",vt,P(E(s).options.title),1),e("div",xt,[fs(l.$slots,"menus",{abstractWindow:E(s)})])]),e("div",Et,[fs(l.$slots,"default",{abstractWindow:E(s)})]),e("div",Tt,[e("button",{type:"button",class:"btn btn-small",onClick:o[0]||(o[0]=c=>n())},"取消"),e("button",{type:"button",class:"btn btn-small",onClick:o[1]||(o[1]=c=>t())},"确定")])])):bs("",!0)}}),Wt=Object.freeze(Object.defineProperty({__proto__:null,Example:ft,FunctionBased:Ga,HelloWorld:Va,Modal:sn,UseApproval:Qs},Symbol.toStringTag,{value:"Module"})),Mt=["innerHTML"],kt=["onClick"],It=O({__name:"index",props:{menuClass:{type:String,default:null}},setup(a){const s=[{name:"皓白",primaryColor:"#ebeef0",textColor:"#000"},{name:"天缥",primaryColor:"#d5ebe1",textColor:"#000",navTextSecondaryColor:"#333"},{name:"海天霞",primaryColor:"#f3a694",textColor:"#000",navTextSecondaryColor:"#333"},{name:"暮山紫",primaryColor:"#a4abd6",textColor:"#000",navTextSecondaryColor:"#333"}].map(l=>({...l,background:l.primaryColor}));function n(l){return{"--xwindow-color-primary":l.primaryColor,"--xwindow-header-color":l.textColor,"--nav-text-secondary-color":l.navTextSecondaryColor}}function t(l){const o=document.documentElement,c=n(l);for(const g in c){const m=c[g];m==null?o.style.removeProperty(g):o.style.setProperty(g,m)}}return(l,o)=>(M(),k("div",{class:_(l.classes.picker)},[e("button",{type:"button",class:_(a.menuClass),innerHTML:E(Ha),title:"主题"},null,10,Mt),e("ul",{class:_(l.classes.panel)},[(M(!0),k($,null,ds(E(s),c=>(M(),k("li",{key:c.id,onClick:g=>t(c),style:Ws({"--theme-primary-color":c.primaryColor})},[e("span",{class:_(l.classes.badge),style:Ws({background:c.background})},null,6),e("strong",null,P(c.name),1)],12,kt))),128))],2)],2))}}),Ct="JJwYh7Hb",Ot="nGuXZaqY",St="WnLJWuwF",zt={picker:Ct,panel:Ot,badge:St},Rt={classes:zt},Lt=Es(It,[["__cssModules",Rt]]),Pt=`<p>xWindow是仿Windows窗口的组件库，目标是提供一套快捷的API来创建和使用窗口。本文档的就是基于xWindow创建了一个窗口，你可以拖动文档查看效果。</p>
...
<span class="hljs-keyword">function</span> <span class="hljs-title function_">onCancel</span>(<span class="hljs-params"></span>) {
  win?.<span class="hljs-title function_">onCancel</span>().<span class="hljs-title function_">catch</span>(<span class="hljs-function"><span class="hljs-params">e</span> =&gt;</span> <span class="hljs-variable language_">console</span>.<span class="hljs-title function_">error</span>(e))
}

<span class="hljs-keyword">function</span> <span class="hljs-title function_">onConfirm</span>(<span class="hljs-params"></span>) {
  win?.<span class="hljs-title function_">onConfirm</span>().<span class="hljs-title function_">catch</span>(<span class="hljs-function"><span class="hljs-params">e</span> =&gt;</span> <span class="hljs-variable language_">console</span>.<span class="hljs-title function_">error</span>(e))
}
</span><span class="hljs-tag">&lt;/<span class="hljs-name">script</span>&gt;</span>
</code><button type="button" class="doc-copy-btn" title="复制"/></pre>
...
<span class="hljs-keyword">class</span> <span class="hljs-title class_">AbstractWindow</span> <span class="hljs-keyword">extends</span> <span class="hljs-title class_ inherited__">Emitter</span>&lt;<span class="hljs-title class_">AbstractWindow</span>&gt; {
  ...
  <span class="hljs-title function_">onConfirm</span>(): <span class="hljs-title class_">Promise</span>&lt;<span class="hljs-built_in">void</span>&gt;
  ...
  <span class="hljs-title function_">onCancel</span>(): <span class="hljs-title class_">Promise</span>&lt;<span class="hljs-built_in">void</span>&gt;
...
</code><button type="button" class="doc-copy-btn" title="复制"/></pre>`,qt=e("colgroup",null,[e("col",{width:"160"}),e("col",{width:"150"})],-1),Ht=e("thead",null,[e("tr",null,[e("th",null,"事件"),e("th",null,"默认行为"),e("th",null,"说明")])],-1),Ft={__name:"Events",setup(a){const s=[{type:"created",desc:"窗口组件创建时触发"},{type:"beforeShow",prevent:"可阻止窗口显示",desc:"窗口显示前触发"},{type:"show",desc:"窗口显示后触发"},{type:"beforeClose",prevent:"可阻止窗口关闭",desc:"窗口关闭前触发"},{type:"close",desc:"窗口关闭时触发"},{type:"beforeDestroy",desc:"窗口销毁前触发"},{type:"dragStart",prevent:"可阻止窗口拖动",desc:"窗口开始拖动时触发"},{type:"dragging",desc:"窗口拖动时触发"},{type:"dragEnd",desc:"窗口拖动结束时触发"},{type:"resizeStart",prevent:"可阻止窗口调整尺寸",desc:"窗口开始调整尺寸时触发"},{type:"resizing",desc:"窗口调整尺寸时触发"},{type:"resizeEnd",desc:"窗口结束调整尺寸时触发"},{type:"maximizeChange",desc:"窗口最大化状态改变时触发"},{type:"confirm",desc:"调用窗口的confirm方法后触发，可通过此事件返回窗体的内容"},{type:"cancel",desc:"调用窗口的cancel方法后触发"}];return(n,t)=>(M(),k("table",null,[qt,Ht,e("tbody",null,[(M(),k($,null,ds(s,l=>e("tr",{key:l.prop},[e("td",null,P(l.type),1),e("td",null,P(l.prevent??"--"),1),e("td",null,P(l.desc),1)])),64))])]))}};function Vt(a){return typeof a=="function"||Object.prototype.toString.call(a)==="[object Object]"&&!ns(a)}function nn(a,s,n={}){n.height=n.height??"320px";const t={default(l){return typeof s=="function"?s(l.abstractWindow):s},menus(l){return l.abstractWindow.useMenus().value.map(c=>Ks.renderMenu(l.abstractWindow,c))}};return Js(a,r(sn,null,Vt(t)?t:{default:()=>[t]}),n)}function $t(){const a={mask:!0,resizeMode:L.DISABLED};return nn("请输入审批意见",r(Qs,null,null),a).promise()}const Xt={class:"approval-output"},Gt=e("strong",null,"操作结果：",-1),Ut=O({__name:"UseExample",setup(a){const s=K("");async function n(){const t=await $t().catch(l=>(console.log(l),null));if(t==null){s.value="取消操作";return}s.value=t}return(t,l)=>(M(),k($,null,[e("button",{type:"button",class:"btn btn-small",onClick:n},"审批"),e("div",Xt,[s.value?(M(),k($,{key:0},[Gt,e("pre",null,P(s.value),1)],64)):bs("",!0)])],64))}}),Zt=O({__name:"UseModal",setup(a){function s(){nn("窗口1",r("div",null,[y("内容")]))}return(n,t)=>(M(),k("button",{type:"button",class:"btn btn-small",onClick:s},"打开模态框"))}}),Yt=Object.freeze(Object.defineProperty({__proto__:null,Events:Ft,UseExample:Ut,UseModal:Zt},Symbol.toStringTag,{value:"Module"})),Jt=[{name:"简介",content:Pt},{name:"快速开始",content:Nt},{name:"进阶应用",content:Bt},{name:"API",content:Dt},{name:"示例",content:At}],Os=Jt.map((a,s)=>({id:s,...a})),Kt=["innerHTML"],Qt=e("span",null,"xWindow",-1),sl=["onClick"],nl=e("span",null,"Copyright © 2023-present dongls",-1),al=[nl],tl=O({__name:"docs",setup(a){const s=Rs("classes"),n="10021122",t="0.2.0",l=0,o=js(),c=sa(),g=K(Os[l]),m=K();function x(j){j.stopPropagation()}function I(){var S;if(o==null)return null;const j=o.useMenus(),z=((S=o.component)==null?void 0:S.useCssClass())??{};return r("div",{class:s.menus,onMousedown:x},[r(Lt,{menuClass:z.menu},null),r("button",{title:"GitHub",class:z.menu,onClick:W,innerHTML:Fa},null),j==null?void 0:j.value.map(N=>Ks.renderMenu(o,N))])}function W(){window.open("https://github.com/dongls/xWindow")}function i(){const j=g.value.content,z={...Wt,...Yt};return X("article",{class:"article",key:g.value.id},X({template:j,components:z}))}async function h(j){g.value=j,await ms(),m.value&&(m.value.scrollTop=0)}function v(j){const z=j.target.closest("pre.hljs");if(z==null)return;const S=z.querySelector(":scope > code.hljs-code");if(S==null)return;const N=S.textContent;N!=null&&navigator.clipboard.writeText(N)}return(j,z)=>(M(),k("div",{class:_(j.classes.app)},[e("aside",{class:_(j.classes.aside)},[e("div",{class:_(j.classes.leftHeader)},[e("i",{class:_(j.classes.logo),innerHTML:E(c).IconWindow},null,10,Kt),e("h3",{class:_(j.classes.title)},[Qt,e("small",null,"v"+P(E(t))+"_"+P(E(n)),1)],2)],2),e("nav",{class:_([j.classes.navs,"is-scroll"])},[(M(!0),k($,null,ds(E(Os),S=>(M(),k("div",{onClick:N=>h(S),class:_([j.classes.nav,S.id==g.value.id?j.classes.activeNav:null])},P(S.name),11,sl))),256))],2),e("div",{class:_(j.classes.copyright)},al,2)],2),e("main",{class:_(j.classes.main)},[e("div",{class:_(j.classes.rightHeader)},[r(I)],2),e("div",{class:_(j.classes.scroll),ref_key:"scroll",ref:m,onClick:dn(v,["stop"])},[r(i,{class:_(j.classes.content)},null,8,["class"]),fs(j.$slots,"default",{ref:"tref"})],2)],2)],2))}}),ll="Cs1eNLRW",el="mkQVrkEV",ol="fxJePVAw mkQVrkEV",cl="gW5FCXxJ mkQVrkEV",il="UCU4MEPE",pl="wascU8g5",rl="QVKApkXV",ul="xQ7Xh7bM",dl="LhDQ3ctB",hl="_7RZWnCfQ",jl="_95hpDEbG",gl="cXaxwh5B",ml="_2dkZEz4e",fl="_6qjvpjzC",wl="qSce7387",bl={app:ll,header:el,leftHeader:ol,rightHeader:cl,menus:il,aside:pl,navs:rl,nav:ul,activeNav:dl,main:hl,content:jl,scroll:gl,copyright:ml,logo:fl,title:wl},yl={classes:bl},_l=Es(tl,[["__cssModules",yl]]),vl=O({__name:"App",setup(a){let s=null;function n(){s&&s.close(),s=null}return zs(n),hn(()=>{s=Js({closeable:!1,zIndex:999,width:"1280px",height:"900px",minHeight:640,body:r(_l,null,null),title:"",className:"xwindow-doc"})}),(t,l)=>{const o=gn("WindowManager");return M(),jn(o)}}}),an=mn(vl);an.use(qa);an.mount("#app");
