/*! @dongls/xWindow v0.1.3 https://github.com/dongls/xWindow
Copyright 2023-present dongls
Released under the MIT License */
var It = Object.defineProperty;
var bt = (i, e, t) => e in i ? It(i, e, { enumerable: !0, configurable: !0, writable: !0, value: t }) : i[e] = t;
var r = (i, e, t) => (bt(i, typeof e != "symbol" ? e + "" : e, t), t);
import { defineComponent as G, computed as P, h as D, shallowRef as Lt, reactive as nt, ref as it, provide as zt, createVNode as w, Teleport as st, isVNode as k, nextTick as q, render as Q, inject as Rt, onBeforeUnmount as xt, Transition as yt } from "vue";
const ot = Symbol(), I = Object.freeze({ WINDOW: "x-window", SIMPLE_WINDOW: "x-simple-window", TRANSITION: "x-window-is-transition", MENU: "x-window-is-menu", FOCUSED: "x-window-is-focused", MAXIMIZE: "x-window-is-maximize", HEADER: "x-window-header", BODY: "x-window-body" }), h = Object.freeze({ NONE: 0, TOP: 1, BOTTOM: 2, LEFT: 4, RIGHT: 8 }), x = Object.freeze({ TOP: h.TOP, BOTTOM: h.BOTTOM, LEFT: h.LEFT, RIGHT: h.RIGHT, TOP_LEFT: h.TOP | h.LEFT, TOP_RIGHT: h.TOP | h.RIGHT, BOTTOM_LEFT: h.BOTTOM | h.LEFT, BOTTOM_RIGHT: h.BOTTOM | h.RIGHT }), o = Object.freeze({ NONE: h.NONE, MAXIMIZE: h.TOP, LEFT: h.LEFT, RIGHT: h.RIGHT, TOP_LEFT: h.TOP | h.LEFT, TOP_RIGHT: h.TOP | h.RIGHT, BOTTOM_LEFT: h.BOTTOM | h.LEFT, BOTTOM_RIGHT: h.BOTTOM | h.RIGHT }), N = Object.freeze({ DISABLED: 0, RESIZE: 1, RESIZE_ONLY: 2 }), W = Object.freeze({ INIT: 0, MOUNTED: 1, UNMOUNTED: 2 }), rt = Object.freeze({ SIMPLE_WINDOW: "SimpleWindow", BLANK_WINDOW: "BlankWindow" }), M = Object.freeze({ CLOSE: 0, MAXIMIZE: 1, RESTORE: 2, PIN: 3, UNPIN: 4 });
class Z {
  constructor(e, t, n) {
    r(this, "type");
    r(this, "stopped", !1);
...
const Pt = { top: "offsetTop", left: "offsetLeft", width: "offsetWidth", height: "offsetHeight" };
class Nt {
  constructor(e) {
    r(this, "init", !1);
    r(this, "defaultPrevented", !1);
...
const p = { window: "_1T2rhwiL", dragging: "yi9w1sZD", resizing: "Ja2o9U31", maximize: "_1eMSsKoB", focused: "_3czvPpS2", header: "GiVk7T8N", menu: "VuG4WNig x-window-is-menu", logo: "yBPezU8e", main: "xbuRK23n", init: "_9t1NJBZM", title: "shyxrRzw", menus: "nkEGqTFw", body: "pk12TusX", footer: "noixF94i", closeMenu: "ifXDegN1 VuG4WNig x-window-is-menu", pinMenu: "X5A6roxN VuG4WNig x-window-is-menu", resizeBar: "PPmfTMRL", resizeTop: "v8UGXgKi PPmfTMRL", resizeBottom: "_74VJ9GNt PPmfTMRL", resizeRight: "gg9Mcwey PPmfTMRL", resizeLeft: "Tw7sCaLt PPmfTMRL", resizeTopLeft: "CPuApFyD PPmfTMRL", resizeBottomLeft: "VBRi4FWg PPmfTMRL", resizeTopRight: "gCRpuZdB PPmfTMRL", resizeBottomRight: "iRYpNoUT PPmfTMRL", mask: "xTcKGSVA" }, _t = G({ name: "WindowBody", props: { wid: String, body: { type: [Object, Function, String, Number], default: null }, abstractWindow: { type: Object, required: !0 } }, setup: (i) => function() {
...
} }), Ct = Math.floor(Number.MAX_SAFE_INTEGER / 10) - 1e4, Ht = [[p.resizeTop, x.TOP], [p.resizeBottom, x.BOTTOM], [p.resizeLeft, x.LEFT], [p.resizeRight, x.RIGHT], [p.resizeTopLeft, x.TOP_LEFT], [p.resizeTopRight, x.TOP_RIGHT], [p.resizeBottomLeft, x.BOTTOM_LEFT], [p.resizeBottomRight, x.BOTTOM_RIGHT]], C = G({ name: "BlankWindow", props: { abstractWindow: { type: Object, required: !0 } }, setup(i, { slots: e }) {
  const t = Lt(), n = nt({ visible: !1, offsetWidth: 0, offsetHeight: 0, offsetTop: 0, offsetLeft: 0, focused: !1, pinned: !1, zIndex: 0, splitMode: o.NONE }), s = it(W.INIT), a = P(() => {
    ...
    return P(() => {
      ...
      const y = m.mask ? null : L.value;
      return { top: f.offsetTop + "px", left: f.offsetLeft + "px", width: f.offsetWidth + "px", height: u.value == W.INIT ? void 0 : f.offsetHeight + "px", zIndex: y };
    });
  }(i.abstractWindow, s, n, d), E = P(() => {
    const c = [I.WINDOW, p.window], u = i.abstractWindow;
    var f;
    return u.type === rt.SIMPLE_WINDOW && c.push(I.SIMPLE_WINDOW), s.value == W.INIT && c.push(p.init), n.splitMode == o.MAXIMIZE && c.push(p.maximize, I.MAXIMIZE), n.focused && c.push(p.focused, I.FOCUSED), (f = u.options.className) != null && typeof f == "string" && f.length != 0 && c.push(u.options.className), c;
  }), g = P(() => {
  ...
  async function vt(c) {
    ...
    if (s.value == W.INIT) {
      ...
      $(f.left) && (y = Math.floor((window.innerWidth - m.width) / 2)), $(f.top) && (H = Math.floor((window.innerHeight - m.height) / 2)), n.offsetWidth = m.width, n.offsetHeight = m.height, n.offsetLeft = y, n.offsetTop = H, f.maximize && J(), s.value = W.MOUNTED, JSON.parse(JSON.stringify(n)), q(() => {
  ...
  return zt(ot, i.abstractWindow), function() {
    ...
    if (n.visible !== !0)
      return null;
    const f = typeof e.header == "function" ? e.header(O) : null, L = w("div", { class: p.main, onDblclick: Mt }, [f, w("div", { class: [p.body, I.BODY, u.bodyClassName] }, [w(_t, { body: c.body, abstractWindow: i.abstractWindow, key: c.wid }, null)])]), m = { ref: t, id: c.wid, onVnodeMounted: vt, onPointerdown: Ot, class: E.value, style: T.value }, y = (H = u.resizeMode, B = c.resizestart, H == N.DISABLED ? null : Ht.map((R) => D("div", { ["." + X.PROP]: R[1], className: R[0], onPointerdown: B })));
    var H, B;
    let z = D("div", m, [L, y]);
    if (u.mask === !0) {
...
} }), ht = Object.freeze({ SIMPLE_WINDOW: F.name, BLANK_WINDOW: C.name });
function pt(i) {
  return i == C.name ? C : F;
}
function ft(i) {
  if (i.key == "Escape")
    return Et({ pressEsc: !0, forced: !1 });
}
function gt() {
...
function Dt(i) {
  ...
  return l.isMounted ? (l.ids.value.push(e.id), l.stack.set(e.id, e), e) : (function(t) {
    const n = document.createDocumentFragment(), s = pt(t.type), a = D(s, { abstractWindow: t });
...
function Y(i) {
  if (l.topWindow = i, i != null) {
    ...
    i.state != null && i.state.zIndex < wt() && (i.state.zIndex = Tt());
  }
}
function At() {
  Y(function() {
...
function Gt() {
  l.appContext = null, gt(), window.removeEventListener("keydown", ft, !0);
}
function oe() {
  return { closeTopWindow: Et, getTopWindow: Bt, getTopZIndex: Tt, getWindowCount: Ft, getZIndex: wt, setFocusedWindow: Y, cleanup: Gt };
}
class kt {
  constructor(e, t) {
    r(this, "moved", !1);
...
const _ = class _ extends A {
  constructor(t) {
    ...
    r(this, "dragstart");
    r(this, "resizestart");
    this.type = t.type ?? rt.SIMPLE_WINDOW, this.options = this.createOptions(t), this.body = t.body, Reflect.defineProperty(this, "id", { enumerable: !0, configurable: !1, writable: !1, value: _.seed++ }), this.initDraggable(), this.initResizable(), this.initHooks();
  }
  static create(t) {
...
r(_, "seed", 1e3);
let V = _;
const tt = 1e3, b = {}, l = { appContext: null, isMounted: !1, zIndex: 1e3, stack: /* @__PURE__ */ new Map(), ids: it([]), topWindow: null, previewState: nt({ mode: o.NONE, width: 0, height: 0 }) };
function Vt(i) {
  var e;
  b.zIndex = (e = i == null ? void 0 : i.zIndex, typeof e != "number" ? tt : Number.isFinite(e) ? Math.floor(e) : tt), b.draggaleHeight = (i == null ? void 0 : i.draggaleHeight) ?? 32, b.size = (i == null ? void 0 : i.size) ?? {}, l.zIndex = b.zIndex;
}
function re(i, e) {
  ...
  switch (e) {
    case M.CLOSE:
      return w("button", { onClick: function() {
        i.cancel();
      }, type: "button", innerHTML: at, class: n.closeMenu, title: "关闭" }, null);
    case M.PIN:
    case M.UNPIN:
      const a = t.pinned ? "取消固定" : "固定", d = t.pinned ? n.pinMenu : n.menu;
      return w("button", { onClick: function() {
        i.togglePin();
      }, type: "button", innerHTML: dt, class: d, title: a }, null);
    case M.MAXIMIZE:
    case M.RESTORE:
      const T = t.splitMode == o.MAXIMIZE ? ut : ct, E = t.splitMode == o.MAXIMIZE ? "还原" : "最大化";
...
const Zt = "Ycke6mYQ", Yt = "esgrGyhH", jt = "UkryRM5g", Ut = "U5LZXLJZ", Kt = "_2rffDKab", Jt = "vcVMeNrL", qt = "koc15mYi", Qt = "_4VxfFKcG", $t = { [o.MAXIMIZE]: Yt, [o.LEFT]: jt, [o.RIGHT]: Ut, [o.TOP_LEFT]: Kt, [o.TOP_RIGHT]: Jt, [o.BOTTOM_LEFT]: qt, [o.BOTTOM_RIGHT]: Qt }, et = (o.BOTTOM_LEFT, o.LEFT, o.BOTTOM_RIGHT, o.RIGHT, o.LEFT, o.TOP_LEFT, o.RIGHT, o.TOP_RIGHT, o.MAXIMIZE, o.TOP_LEFT, o.LEFT, o.TOP_RIGHT, o.RIGHT, o.LEFT, o.BOTTOM_LEFT, o.RIGHT, o.BOTTOM_RIGHT, o.NONE, o.TOP_RIGHT, o.TOP_LEFT, o.TOP_LEFT, o.TOP_RIGHT, o.BOTTOM_RIGHT, o.BOTTOM_LEFT, o.BOTTOM_LEFT, o.BOTTOM_RIGHT, o.LEFT, o.TOP_LEFT, o.TOP_RIGHT, o.TOP_RIGHT, o.TOP_LEFT, o.BOTTOM_LEFT, o.BOTTOM_RIGHT, o.BOTTOM_RIGHT, o.BOTTOM_LEFT, o.RIGHT, G({ name: "WindowManager", setup() {
  ...
  l.isMounted = !0, window.addEventListener("keydown", t, !0), xt(() => {
    gt(), window.removeEventListener("keydown", t, !0);
  });
  const n = P(() => {
  ...
  function s() {
    ...
    return w(st, { to: "body" }, { default: () => {
      return [w(yt, { name: "fade" }, (d = a, typeof d == "function" || Object.prototype.toString.call(d) === "[object Object]" && !k(d) ? a : { default: () => [a] }))];
      var d;
    } });
  }
  return function() {
...
function le(...i) {
  const e = j(i) ?? {};
  return e.type = ht.BLANK_WINDOW, U(e);
}
function de(...i) {
  const e = j(i) ?? {};
  return e.type = ht.SIMPLE_WINDOW, U(e);
}
function U(i) {
  const e = Dt(i);
  return e.ready().then(() => {
...
const ue = Object.freeze({ renderMenu: mt });
function te(i, e) {
  i.component(F.name, F), i.component(C.name, C), i.component(et.name, et), Vt(e), window.addEventListener("keydown", ft, !0), function(t) {
    l.appContext = t._context;
  }(i);
}
const ee = "0.1.3", he = { install: te, version: ee };
export {
  V as AbstractWindow,
  C as BlankWindow,
  W as RENDER_STATES,
